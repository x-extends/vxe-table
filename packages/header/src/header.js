...
export default {
  ...
  methods: {
    ...
    resizeMousedown (evnt, params) {
      ...
      const extraElemWidth = DomTools.hasClass(cell, 'col--ellipsis') ? (column.type === 'checkbox' || column.type === 'selection' ? 18 : 0) + (dragBtnElem.previousElementSibling.children.length - 1) * 16 : 0

  ...
  methods: {
    ...
    loadTableData: function loadTableData(datas, notRefresh) {
      ...
      if (scrollYLoad && !showOverflow) {
        _tools.UtilTools.warn('vxe.error.scrollYReqProp', ['show-header-overflow & show-overflow']);
      }
    ...
    refreshColumn: function refreshColumn() {
      ...
      if (scrollXLoad) {
        ...
        if (!this.showHeaderOverflow) {
          _tools.UtilTools.warn('vxe.error.scrollXReqProp', ['show-header-overflow & show-overflow']);

  ...
  methods: {
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = _xeUtils.default.findTree(tableFullData, function (row, rowIndex) {
            return _tools.UtilTools.getRowPrimaryKey(_this5, row, rowIndex) === rowPrimaryKey;
          }, treeConfig);
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          ...
          if (mouseConfig.selected) {
            ...
            var rowPrimaryKey = _tools.UtilTools.getRowPrimaryKey(_this19, row, _this19.getRowMapIndex(row));
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this28, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this31, 'valid-error', [params]);
      });
    },

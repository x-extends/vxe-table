...
var _default2 = {
  ...
  mounted: function mounted() {
    if (this.autoResize) {
      _tools.ResizeEvent.on(this, this.getParentElem(), this.recalculate);
    }
  ...
  methods: {
    ...
    loadColumn: function loadColumn(columns) {
      ...
      this.collectColumn = _xeUtils.default.mapTree(columns, function (column) {
        return _cell.default.createColumn(_this6, column);
      }, headerProps);
      return this.$nextTick();
    },
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = _xeUtils.default.findTree(tableFullData, function (row) {
            return _tools.UtilTools.getRowid(_this8, row) === rowid;
          }, treeConfig);
    ...
    refreshColumn: function refreshColumn() {
      ...
      if (scrollXLoad) {
        ...
        if (this.resizable || visibleColumn.some(function (column) {
          ...
          _tools.UtilTools.warn('vxe.error.scrollXNotResizable');
        }
        ...
        this.preventEvent(evnt, 'event.keydown', {
          ...
          if (isEsc) {
            ...
            if (keyboardConfig.isDel && (selected.row || selected.column)) {
              ...
              // 如果树形表格回退键关闭当前行返回父节点
              var _XEUtils$findTree = _xeUtils.default.findTree(_this21.afterFullData, function (item) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          ...
          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this31, {
              row: row,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this40, params);
            ...
            _tools.DomTools.toView(_this40.$el);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this43, 'valid-error', [params]);
      });
    },
        ...
        if (getFileTypes(options).includes(type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              _tools.ExportTools.handleImport(_this44, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      this.readFile(options).then(function (evnt) {

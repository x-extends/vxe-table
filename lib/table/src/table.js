  ...
  methods: {
    ...
    setCurrentRow: function setCurrentRow(row) {
      ...
      if (this.highlightCurrentRow) {
        _tools.DomTools.addClass(this.$el.querySelectorAll("[data-rowid=\"".concat(_tools.UtilTools.getRowid(this, row), "\"]")), 'row--current');
      }
    ...
    triggerTreeExpandEvent: function triggerTreeExpandEvent(evnt, _ref7) {
      ...
      if (selectRow) {
        this.$nextTick(function () {
          return _this23.setCurrentRow(selectRow);
        });

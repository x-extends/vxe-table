  ...
  methods: {
    ...
    triggerHeaderCellClickEvent: function triggerHeaderCellClickEvent(evnt, params) {
      ...
      if (mouseConfig.checked && column.type !== 'index') {
        ...
        if (trList.length) {
          ...
          return this.handleChecked(_tools.DomTools.getRowNodes(trList, _tools.DomTools.getCellNodeIndex(startCell), _tools.DomTools.getCellNodeIndex(endCell)));
        }
      }
    ...
    triggerCellClickEvent: function triggerCellClickEvent(evnt, params) {
      ...
      if (mouseConfig.checked && column.type === 'index') {
        ...
        this.handleChecked(_tools.DomTools.getRowNodes(trList, _tools.DomTools.getCellNodeIndex(cell.nextElementSibling), _tools.DomTools.getCellNodeIndex(cell.parentNode.lastElementChild)));

        _tools.DomTools.addClass(cell, 'col--checked');
      }
    ...
    clearSelected: function clearSelected(evnt) {
      ...
      _xeUtils.default.arrayEach([listElem.querySelector('.col--selected')], function (elem) {
    ...
    clearChecked: function clearChecked(evnt) {
      ...
      _xeUtils.default.arrayEach(bodyElem.querySelectorAll('.col--checked'), function (elem) {
        _tools.DomTools.removeClass(elem, 'col--checked');
      });
    ...
    clearHeaderChecked: function clearHeaderChecked() {
      ...
      if (titles.cellNodes) {
        titles.cellNodes.forEach(function (elem) {
          _tools.DomTools.removeClass(elem, 'col--title-checked');
        });
      }

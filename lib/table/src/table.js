...
var _cell = _interopRequireDefault(require("../../table-column/src/cell"));
  ...
  methods: {
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && !_xeUtils.default.isEmpty(editRules)) {
          ...
          if (_this15.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this15, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
                ...
                return new Promise(function (resolve, reject) {
                  _this17.validCellRules('all', row, column).then(resolve).catch(function (rule) {
                    var rest = {
                      ...
                      columnIndex: columnIndex,
                      column: column,
                      cell: _tools.DomTools.getCell(_this17, {
                        row: row,
                        rowIndex: rowIndex,
                        column: column
                      })
    ...
    openValidTooltip: function openValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this20, 'valid-error', [params]);
      });
    },

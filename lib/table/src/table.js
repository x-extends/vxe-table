...
var _default2 = {
  ...
  created: function created() {
    ...
    if (!_conf.default._keyboard && (this.keyboardConfig || this.mouseConfig)) {
      throw new Error(_tools.UtilTools.error('vxe.error.reqKeyboard'));
    }

    if (!_conf.default._resize && this.autoResize) {
  ...
  mounted: function mounted() {
    if (this.autoResize && _conf.default._resize) {
  ...
  methods: {
      ...
      return this.scrollToRow(row, true).then(function () {
        if (row && field) {
          ...
          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this23, {
              row: row,
              column: column
            });
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this29.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this29, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this31, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this34, 'valid-error', [params]);
      });
    },

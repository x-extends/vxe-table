  ...
  methods: {
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          ...
          if (mouseConfig.selected) {
            ...
            var rowPrimaryKey = _tools.UtilTools.getRowPrimaryKey(_this17, row, _this17.getRowMapIndex(row));
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this26, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this29, 'valid-error', [params]);
      });
    },

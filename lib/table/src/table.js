  ...
  methods: {
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          ...
          if (mouseConfig.selected) {
            ...
            var rowId = _tools.UtilTools.getRowId(_this16, row, _this16.getRowMapIndex(row));
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this24, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this27, 'valid-error', [params]);
      });
    },

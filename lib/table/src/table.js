...
var _default2 = {
  ...
  props: {
    ...
    showFooterOverflow: {
      type: [Boolean, String],
      default: function _default() {
        return _conf.default.showFooterOverflow;
      }
    },
    // 是否所有服务端筛选
  ...
  computed: {
    ...
    emptyOpts: function emptyOpts() {
      return Object.assign({}, _conf.default.emptyRender, this.emptyRender);
    },
  ...
  created: function created() {
    ...
    if (editConfig && mouseConfig && (mouseOpts.range || mouseOpts.checked) && editOpts.trigger !== 'dblclick') {
      _tools.UtilTools.error('vxe.error.errProp', ['edit-config.trigger', 'dblclick']);
    }
  ...
  methods: {
    ...
    loadColumn: function loadColumn(columns) {
      ...
      this.collectColumn = _xeUtils.default.mapTree(columns, function (column) {
        return _cell.default.createColumn(_this12, column);
      }, headerProps);
      return this.$nextTick();
    },
    ...
    updateCache: function updateCache(source) {
      ...
      var handleCache = function handleCache(row, index) {
        var rowid = _tools.UtilTools.getRowid(_this13, row);
    ...
    appendTreeCache: function appendTreeCache(row, childs) {
      ...
      if (keepSource) {
        matchObj = _xeUtils.default.findTree(tableSourceData, function (item) {
          return rowid === _tools.UtilTools.getRowid(_this14, item);
        }, treeOpts);
      }

      _xeUtils.default.eachTree(childs, function (row, index) {
        var rowid = _tools.UtilTools.getRowid(_this14, row);
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = _xeUtils.default.findTree(tableFullData, function (row) {
            return _tools.UtilTools.getRowid(_this15, row) === rowid;
          }, treeOpts);
    ...
    */
      ...
      if (keepSource) {
        ...
        if (treeConfig) {
          ...
          var matchObj = _xeUtils.default.findTree(tableSourceData, function (item) {
            return rowid === _tools.UtilTools.getRowid(_this21, item);
          }, treeOpts);
        ...
        if (!(editOpts.autoClear === false)) {
          if (validTip && _tools.DomTools.getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clearActived', actived.args, function () {
              ...
              !_tools.DomTools.getEventTargetNode(evnt, _this27.$el).flag) {
        ...
        if (reserve) {
          if (value) {
            selectRows.forEach(function (row) {
              selectReserveRowMap[_tools.UtilTools.getRowid(_this35, row)] = row;
            });
          } else {
            afterFullData.forEach(function (row) {
              var rowid = _tools.UtilTools.getRowid(_this35, row);
    ...
    handleReserveByRowid: function handleReserveByRowid(list, rest) {
      ...
      list.forEach(function (row) {
        var rowid = _tools.UtilTools.getRowid(_this36, row);
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = _xeUtils.default.find(_this42.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this42, {
              row: row,
              column: column
            });
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this55.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this55, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = _tools.DomTools.getCell(_this57, params);
            ...
            _tools.DomTools.toView(_this57.$el);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this60, 'valid-error', [params]);
      });
    },
        ...
        if (types.indexOf(type) > -1) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              _tools.ExportTools.handleImport(_this61, e.target.result.trim(), options);
            };

  ...
  methods: {
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = _xeUtils.default.findTree(tableFullData, function (row) {
            return _tools.UtilTools.getRowid(_this11, row) === rowid;
          }, treeConfig);
    ...
    isUpdateByRow: function isUpdateByRow(row, field) {
      ...
      if (treeConfig) {
        ...
        var matchObj = _xeUtils.default.findTree(tableSourceData, function (item) {
          return rowid === _tools.UtilTools.getRowid(_this17, item);
        }, treeConfig);
        ...
        if (reserve) {
          if (value) {
            selectRows.forEach(function (row) {
              selectReserveRowMap[_tools.UtilTools.getRowid(_this31, row)] = row;
            });
          } else {
            tableFullData.forEach(function (row) {
              var rowid = _tools.UtilTools.getRowid(_this31, row);
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = _xeUtils.default.find(_this36.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this36, {
              row: row,
              column: column
            });
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this43.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this43, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = _tools.DomTools.getCell(_this45, params);
            ...
            _tools.DomTools.toView(_this45.$el);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this48, 'valid-error', [params]);
      });
    },
        ...
        if (_xeUtils.default.includes(types, type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              _tools.ExportTools.handleImport(_this49, e.target.result.trim(), options);
            };

  ...
  methods: {
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.column === column && filterStore.visible) {
        ...
        if (!filterStore.zIndex || filterStore.zIndex < _tools.UtilTools.getLastZIndex()) {
          filterStore.zIndex = _tools.UtilTools.getZIndex(this);
        }
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this37.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this37, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this39, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this42, 'valid-error', [params]);
      });
    },
    ...
    exportData: function exportData(options) {
      ...
      return _tools.ExportTools.downloadCsc(opts, _tools.ExportTools.getCsvContent(this, opts, columns, fullData));
    },
    updateZindex: function updateZindex() {
      if (this.tZindex < _tools.UtilTools.getLastZIndex()) {
        this.tZindex = _tools.UtilTools.getZIndex(this);
      }
    },

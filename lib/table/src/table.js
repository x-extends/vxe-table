  ...
  methods: {
    ...
    */
        ...
        tableData = tableData.filter(function (row) {
          return filterColumns.every(function (_ref2) {
            ...
            if (valueList.length && !(filterOpts.remote || remoteFilter)) {
              ...
              }) : valueList.includes(_xeUtils.default.get(row, property));
            }
    ...
    handleToggleCheckRowEvent: function handleToggleCheckRowEvent(params, evnt) {
      ...
      var property = checkboxOpts.checkField;
      var row = params.row;
      var value = property ? !_xeUtils.default.get(row, property) : !selection.includes(row);
      ...
      if (!checkStrictly) {
        if (property) {
          ...
          this.isIndeterminate = !this.isAllSelected && tableFullData.some(function (row) {
            return _xeUtils.default.get(row, property) || treeIndeterminates.includes(row);
          });
        } else {
          this.isAllSelected = tableFullData.length && tableFullData.every(checkMethod ? function (row, rowIndex) {
            return !checkMethod({
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = _xeUtils.default.find(_this39.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this39, {
              row: row,
              column: column
            });
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this53.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this53, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = _tools.DomTools.getCell(_this55, params);
            ...
            _tools.DomTools.toView(_this55.$el);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this58, 'valid-error', [params]);
      });
    },
    ...
    exportData: function exportData(options) {
      ...
      if (!opts.filename) {
        opts.filename = _conf.default.i18n('vxe.table.expFilename', [_xeUtils.default.toDateString(Date.now(), 'yyyyMMddHHmmss')]);
      }
      ...
      if (!_vXETable.default.exportTypes.includes(opts.type)) {
        ...
        if (types.includes(type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              _tools.ExportTools.handleImport(_this59, e.target.result.trim(), options);
            };

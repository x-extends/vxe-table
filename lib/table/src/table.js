...
var _default2 = {
  ...
  computed: {
    ...
    checkboxOpts: function checkboxOpts() {
      return Object.assign({}, _conf.default.checkboxConfig, this.checkboxConfig);
    },
  ...
  created: function created() {
    ...
    } else if (!_vXETable.default._edit && this.editConfig) {
  ...
  render: function render(h) {
     ...
     * 加载中
     */
    _vXETable.default._loading && isLoading ? h('vxe-loading', {
      props: {
        visible: loading
      }
    }) : _e(),

  ...
  methods: {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          ...
          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this28, {
              row: row,
              column: column
            });
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.column === column && filterStore.visible) {
        ...
        if (!filterStore.zIndex || filterStore.zIndex < _tools.UtilTools.getLastZIndex()) {
          filterStore.zIndex = _tools.UtilTools.getZIndex();
        }
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this35.hasCellRules(type, row, column)) {
            ...
            var cell = _tools.DomTools.getCell(_this35, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this37, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this40, 'valid-error', [params]);
      });
    },
    ...
    updateZindex: function updateZindex() {
      if (this.tZindex < _tools.UtilTools.getLastZIndex()) {
        this.tZindex = _tools.UtilTools.getZIndex();
      }
    },

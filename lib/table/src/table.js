  ...
  methods: {
    ...
    cacheDataMap: function cacheDataMap() {
      ...
      var handleData = function handleData(row, index) {
        var rowPrimaryKey = _tools.UtilTools.getRowPrimaryKey(_this4, row);
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = _xeUtils.default.findTree(tableFullData, function (row) {
            return _tools.UtilTools.getRowPrimaryKey(_this5, row) === rowPrimaryKey;
          }, treeConfig);
    ...
    hasRowChange: function hasRowChange(row, field) {
      ...
      if (rowKey) {
        var rowPrimaryKey = _tools.UtilTools.getRowPrimaryKey(this, row);
        ...
        if (treeConfig) {
          ...
          var matchObj = _xeUtils.default.findTree(tableSourceData, function (item) {
            return rowPrimaryKey === _tools.UtilTools.getRowPrimaryKey(_this9, item);
          }, treeConfig);
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          ...
          if (mouseConfig.selected) {
            ...
            var rowPrimaryKey = _tools.UtilTools.getRowPrimaryKey(_this20, row);
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var finish = function finish() {
              params.cell = _tools.DomTools.getCell(_this29, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this32, 'valid-error', [params]);
      });
    },

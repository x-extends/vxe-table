...
function renderFixed(h, $table, fixedType) {
  ...
  if (height) {
    customHeight = height === 'auto' ? containerHeight : _tools.DomTools.isScale(height) ? Math.floor(parseInt(height) / 100 * containerHeight) : _xeUtils.default.toNumber(height);
  ...
  methods: {
        ...
        if (reserve) {
          if (value) {
            selectRows.forEach(function (row) {
              selectReserveRowMap[_tools.UtilTools.getRowid(_this28, row)] = row;
            });
          } else {
            tableFullData.forEach(function (row) {
              var rowid = _tools.UtilTools.getRowid(_this28, row);
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = _xeUtils.default.find(_this33.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = _tools.DomTools.getCell(_this33, {
              row: row,
              column: column
            });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = _tools.DomTools.getCell(_this42, params);
            ...
            _tools.DomTools.toView(_this42.$el);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        _tools.UtilTools.emitEvent(_this45, 'valid-error', [params]);
      });
    },
        ...
        if (_xeUtils.default.includes(types, type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              _tools.ExportTools.handleImport(_this46, e.target.result.trim(), options);
            };

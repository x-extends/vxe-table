...
var _default2 = {
  ...
  methods: {
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (isEsc) {
        ...
        if (keyboardConfig.isDel && (selected.row || selected.column)) {
          ...
          // 如果树形表格回退键关闭当前行返回父节点
          var _XEUtils$findTree = _xeUtils.default.findTree(this.getTableData().visibleData, function (item) {
    ...
    moveCurrentRow: function moveCurrentRow(isUpArrow, isDwArrow, evnt) {
      ...
      if (treeConfig) {
        var _XEUtils$findTree2 = _xeUtils.default.findTree(visibleData, function (item) {
          return item === currentRow;
        }, treeConfig),
    ...
    triggerHeaderTooltipEvent: function triggerHeaderTooltipEvent(evnt, _ref2) {
      ...
      if (tooltipStore.column !== column || !tooltipStore.visible) {
        this.showTooltip(evnt, _tools.UtilTools.getFuncText(own.title || own.label), column);
      }
    },

...
var _default2 = {
  ...
  computed: {
    ...
    customOpts: function customOpts() {
      ...
      }, _conf.default.toolbar.customs || _conf.default.toolbar.setting, this.customs || this.setting);
    }
  },
  created: function created() {
    ...
    if (setting) {
      _tools.UtilTools.warn('vxe.error.delProp', ['setting', 'customs']);
    }
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: 'vxe-tools--operate-btn',
      attrs: {
        title: _conf.default.i18n('vxe.toolbar.customs')
      },
      on: customBtnOns
    }, [h('i', {

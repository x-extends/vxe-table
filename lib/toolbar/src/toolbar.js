...
var _default2 = {
  ...
  methods: {
    ...
    exportEvent: function exportEvent() {
      ...
      this.$XModal({
        title: _conf.default.i18n('vxe.toolbar.exportTitle'),
        width: 520,
        mask: true,
        lockView: true,
        showFooter: false,
        ...
        slots: {
          default: function _default(params, h) {
            ...
            return [h('div', {
            ...
            }, [h('table', [h('tr', [h('td', _conf.default.i18n('vxe.toolbar.exportName')), h('td', [h('input', {
              attrs: {
                type: 'text',
                placeholder: _conf.default.i18n('vxe.toolbar.exportNamePlaceholder')
              },
              domProps: {
            ...
            })])]), h('tr', [h('td', _conf.default.i18n('vxe.toolbar.exportType')), h('td', [h('select', {
              on: {
            ...
            }))])]), h('tr', [h('td', _conf.default.i18n('vxe.toolbar.exportSuffix')), h('td', [h('select', {
              on: {
                change: function change(evnt) {
                  exportStore.type = evnt.target.value;
                }
            ...
            }))])]), h('tr', [h('td', _conf.default.i18n('vxe.toolbar.exportOpts')), h('td', [h('vxe-checkbox', {
              model: {
            ...
            }, _conf.default.i18n('vxe.toolbar.exportOptHeader')), h('vxe-checkbox', {
              model: {
            ...
            }, _conf.default.i18n('vxe.toolbar.exportOptIndex'))])])]), h('div', {
              ...
              on: {
                click: function click() {
                  var options = {
                    filename: exportStore.name || _conf.default.i18n('vxe.toolbar.exportTitle'),
            ...
            }, _conf.default.i18n('vxe.toolbar.exportConfirm'))])])];
          }
        }
      });
    }

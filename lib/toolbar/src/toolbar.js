      ...
      this.$XModal({
        ...
        slots: {
          default: function _default(params, h) {
            ...
            }, [h('table', [h('tr', [h('td', _conf.default.i18n('vxe.toolbar.expName')), h('td', [h('input', {
              attrs: {
                type: 'text',
            ...
            }))])]), h('tr', [h('td', _conf.default.i18n('vxe.toolbar.expSuffix')), h('td', [h('select', {
              on: {
                change: function change(evnt) {
                  exportStore.type = evnt.target.value;
                }
            ...
            }, _conf.default.i18n('vxe.toolbar.expOptIndex')), h('vxe-checkbox', {
              props: {
                size: vSize
              },
              model: {

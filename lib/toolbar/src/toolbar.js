...
var _default2 = {
  ...
  props: {
    ...
    zoom: {
      type: [Boolean, Object],
      default: function _default() {
        return _conf.default.toolbar.zoom;
      }
    },
    setting: {
      type: [Boolean, Object],
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: _conf.default.icon.import
      ...
      class: _conf.default.icon.export
    })]) : null, refresh ? h('div', {
      class: 'vxe-tools--operate-btn',
      attrs: {
      ...
      class: _conf.default.icon["refresh".concat(this.isRefresh ? 'Loading' : '')]
    })]) : null, zoom && this.$grid ? h('div', {
      class: 'vxe-tools--operate-btn',
      attrs: {
        title: _conf.default.i18n("vxe.toolbar.zoom".concat(this.$grid.maximize ? 'Out' : 'In'))
      },
      on: {
      ...
      class: _conf.default.icon["zoom".concat(this.$grid.maximize ? 'Out' : 'In')]
    })]) : null, setting ? h('div', {
      ...
      attrs: {
        title: _conf.default.i18n('vxe.toolbar.setting')
      },
      on: customBtnOns
    }, [h('i', {

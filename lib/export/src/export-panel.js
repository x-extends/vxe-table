...
var _default = {
  ...
  render: function render(h) {
    ...
    return h('vxe-modal', {
      ...
      }, _tools.UtilTools.getFuncText(own.title || own.label || (type === 'seq' || type === 'index' ? _conf.default.i18n('vxe.column.seqTitle') : '')));
    ...
    }, _conf.default.i18n(isNotImport ? 'vxe.toolbar.expOptOriginNotImp' : 'vxe.toolbar.expOptOriginal'))])])]), h('div', {

...
var _virtualTree = _interopRequireWildcard(require("./virtual-tree"));

Object.keys(_virtualTree).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _virtualTree[key];
    }
  });
});

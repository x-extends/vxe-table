                ...
                this.remove(selectRecords).then(function () {
                  ...
                  if (removeRecords.length) {
                    ...
                    if (isMsg && !selectRecords.length) {
                      _this3.$XMsg.message(_conf.default.i18n('vxe.grid.selectOneRecord'));
                    }
                  }
                });
              }
                    ...
                    if (vaild) {
                      if (body.insertRecords.length || removeRecords.length || updateRecords.length || body.pendingRecords.length) {
                        ...
                        resolve(ajax.save({
                          ...
                          _this3.$XMsg.message(_conf.default.i18n('vxe.grid.saveSuccess'));
                        ...
                        if (isMsg) {
                          ...
                          if (pendingRecords.length) {
                            ...
                            _this3.$XMsg.message(_conf.default.i18n('vxe.grid.dataUnchanged'));
                          }
                        }

...
var CellMethods = {
  ...
  renderHeader: function renderHeader(h, params) {
    ...
    return [_tools.UtilTools.formatText(params.column.origin.label)];
  },
  renderCell: function renderCell(h, params) {
    ...
    return [_tools.UtilTools.formatText(cellValue)];
  },
  ...
  renderIndexCell: function renderIndexCell(h, params) {
    ...
    var seq = params.seq,
        level = params.level;
    return [_tools.UtilTools.formatText(indexMethod ? indexMethod(params) : level ? "".concat(level, ".").concat(seq) : startIndex + seq)];
  },
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    return [h('label', {
      ...
      class: 'radio--label'
    }, _xeUtils.default.get(row, labelProp)) : null])];
  },

...
function outLog(type) {
  return function (message) {
    console[type]("[vxe-table] ".concat(_conf.default.i18n(message)));
  };
}
...
var UtilTools = {
  ...
  getRowkey: function getRowkey($table) {
    ...
    if (!rowKey || !_xeUtils.default.isString(rowKey)) {
      // 在 v2.0 中废弃 key
      rowKey = rowId || selectConfig.key || treeConfig.key || expandConfig.key || editConfig.key || _conf.default.rowId;
    }

...
/* harmony default export */ var table = ({
  ...
  mounted: function mounted() {
    if (this.autoResize && conf._resize) {
...
/* harmony default export */ var modal = ({
  ...
  props: {
    ...
    marginSize: {
      type: [Number, String],
      default: conf.message.marginSize
    },
    animat: {
      type: Boolean,
      default: function _default() {
  ...
  render: function render(h) {
    ...
    }, this.$slots.default || (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(message) ? message.call(this, h) : message))]), showFooter ? h('div', {
      class: 'vxe-modal--footer'
    }, this.$slots.footer || [type === 'confirm' ? h('vxe-button', {
      on: {
...
/* harmony default export */ var resize_src_methods = ({
  bindResize: function bindResize() {
    src_resize.on(this, this.$el.parentNode, this.recalculate);
  },
  unbindResize: function unbindResize() {
    src_resize.off(this, this.$el.parentNode);
  }
});

...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    checkboxAllEvent: function checkboxAllEvent(evnt) {
      ...
      handle.emitEvent(this, 'select-all', [this.selection]);
    },
     ...
     * 行 hover 事件
     */
    rowHoverEvent: function rowHoverEvent(evnt, _ref3) {
      var row = _ref3.row;
      this.hoverRow = row;
    },
     ...
     * 列点击事件
     */
    colClickEvent: function colClickEvent(evnt, params) {
      handle.emitEvent(this, 'cell-click', [params, evnt]);
    },

    /**
     * 列双击点击事件
     */
    colDblclickEvent: function colDblclickEvent(evnt, params) {
      handle.emitEvent(this, 'cell-dblclick', [params, evnt]);
    },

    /**
     * 排序事件
     */
    rowSortEvent: function rowSortEvent(evnt, _ref4, order) {
      ...
      handle.emitEvent(this, 'sort-change', [{
        column: column,
        prop: prop,
        order: order
      }]);
      ...
      if (!params.isHidden) {
        ...
        options.on = {
          change: function change(evnt) {
            ...
            handle.emitEvent(_this, 'change', [row]);
          }
        };
      }
      ...
      if (!isHidden) {
        ...
        options.on = {
          change: function change(evnt) {
            ...
            handle.emitEvent(_this, 'change', [$table.selection, row]);
          }
        };
      }

...
var Cell = {
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    var labelProp = radioOpts.labelField || radioOpts.labelProp;
  ...
  renderSelectionCell: function renderSelectionCell(h, params) {
    ...
    var labelProp = checkboxOpts.labelField || checkboxOpts.labelProp;
...
function renderFixed(h, $table, fixedType) {
  ...
  var style = {
    ...
    }, isRightFixed ? scrollbarWidth : 0) - (border ? 1 : 0), "px")
  };
  return h('div', {
...
/* harmony default export */ var table = ({
  ...
  watch: {
    data: function data(value) {
      ...
      this.loadTableData(value, true).then(function () {
        if (!_this.inited) {
          _this.inited = true;
  ...
  methods: {
    ...
    loadTableData: function loadTableData(datas, notRefresh) {
      ...
      return rest.then(function () {
        ...
        _this8.handleTableData(true);

        _this8.handleReserveStatus();

        _this8.checkSelectionStatus();

        rest = _this8.$nextTick();

        if (!notRefresh) {
          rest = rest.then(_this8.recalculate);
        }

        return rest.then(_this8.refreshScroll);
      });
    },
    ...
    */
        ...
        tableData = tableData.filter(function (row) {
          return filterColumns.every(function (_ref2) {
            ...
            if (valueList.length && !(filterOpts.remote || remoteFilter)) {
              ...
              }) : valueList.includes(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, property));
            }
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this31.handleSelectRow(null, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
    ...
    handleToggleCheckRowEvent: function handleToggleCheckRowEvent(params, evnt) {
      ...
      var property = checkboxOpts.checkField;
      var row = params.row;
      var value = property ? !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, property) : !selection.includes(row);
        ...
        if (property) {
          ...
          var clearValFn = function clearValFn(row, rowIndex) {
            ...
            if (!checkMethod || (checkMethod((_checkMethod2 = {
              row: row
            }, _defineProperty(_checkMethod2, indexKey, rowIndex), _defineProperty(_checkMethod2, "$rowIndex", rowIndex), _checkMethod2)) ? 0 : selection.includes(row))) {
              external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(row, property, value);
            }
          };
            ...
            if (value) {
              if (checkMethod) {
                selectRows = tableFullData.filter(function (row, rowIndex) {
                  return selection.includes(row) || checkMethod({
                    row: row,
                    rowIndex: rowIndex,
                    $rowIndex: rowIndex
                  });
      ...
      if (!checkStrictly) {
        if (property) {
          ...
          this.isIndeterminate = !this.isAllSelected && tableFullData.some(function (row) {
            return external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, property) || treeIndeterminates.includes(row);
          });
        } else {
          this.isAllSelected = tableFullData.length && tableFullData.every(checkMethod ? function (row, rowIndex) {
            return !checkMethod({
          ...
          this.isIndeterminate = !this.isAllSelected && tableFullData.some(function (row) {
            return treeIndeterminates.includes(row) || selection.includes(row);
          });
        }
      }
    },
      ...
      if (editRender && cell) {
        if (editConfig.mode === 'row' ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this37.handleFocus(params, evnt);
            });
          }
      ...
      var selectMethod = function selectMethod() {
        if ((mouseConfig.selected || mouseConfig.checked) && (selected.row !== row || selected.column !== column)) {
          if (actived.row !== row || (editConfig.mode === 'cell' ? actived.column !== column : false)) {
            _this38.clearChecked(evnt);

            _this38.clearActived(evnt);
            ...
            if (mouseConfig.checked) {
              ...
              _this38.handleChecked(select, select, evnt);
            }
          }
        }
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find(_this39.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = DomTools.getCell(_this39, {
              row: row,
              column: column
            });

            if (cell) {
              _this39.handleActived({
                row: row,
                rowIndex: _this39.getRowIndex(row),
                column: column,
                columnIndex: _this39.getColumnIndex(column),
                cell: cell,
                $table: _this39
              });

              _this39.lastCallTime = Date.now();
            }
          }
        }
        ...
        if (expanded) {
          rows.forEach(function (row) {
            if (!rowExpandeds.includes(row)) {
              var rest = fullAllDataRowMap.get(row);
              var isLoad = lazy && !rest.expandLoaded && !expandLazyLoadeds.includes(row);

              if (isLoad) {
                result.push(_this42.handleAsyncRowExpand(row));
              } else {
                rowExpandeds.push(row);
              }
            }
    ...
    clearRowExpand: function clearRowExpand() {
      ...
      this.rowExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this43.recalculate() : 0;
      });
    },
      ...
      return new Promise(function (resolve) {
        ...
        loadMethod({
          ...
          if (childs) {
            ...
            _this45.appendTreeCache(row, childs);
            ...
            if (_this45.isCheckedByRow(row)) {
              _this45.setSelection(childs, true);
            }
          }

          resolve(_this45.$nextTick().then(_this45.recalculate));
        });
      });
    },
      ...
      if (expanded) {
        if (lazy) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, function (row) {
            _this46.setTreeExpansion(row, true);
          }, treeOpts);
        } else {
          var treeExpandeds = [];
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, function (row) {
      ...
      if (rows) {
        ...
        if (rows.length) {
          if (accordion) {
            ...
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.remove(treeExpandeds, function (item) {
              return matchObj.items.includes(item);
            });
          }
          ...
          if (expanded) {
            rows.forEach(function (row) {
              if (!treeExpandeds.includes(row)) {
                var rest = fullAllDataRowMap.get(row);
                var isLoad = lazy && row[hasChild] && !rest.treeLoaded && !treeLazyLoadeds.includes(row); // 是否使用懒加载

                if (isLoad) {
                  result.push(_this47.handleAsyncTreeExpandChilds(row));
                } else {
    ...
    clearTreeExpand: function clearTreeExpand() {
      ...
      this.treeExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this48.recalculate() : 0;
      });
    },
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var vSize = _this49.vSize,
            scrollXLoad = _this49.scrollXLoad,
            scrollYLoad = _this49.scrollYLoad,
            scrollYStore = _this49.scrollYStore,
            scrollXStore = _this49.scrollXStore,
            visibleColumn = _this49.visibleColumn,
            optimizeOpts = _this49.optimizeOpts,
            rowHeightMaps = _this49.rowHeightMaps;
        var scrollX = optimizeOpts.scrollX,
            scrollY = optimizeOpts.scrollY;
        var tableBody = _this49.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableHeader = _this49.$refs.tableHeader;
      ...
      if (treeConfig) {
        ...
        if (matchObj) {
          ...
          nodes.forEach(function (row, index) {
            if (index < nodes.length - 1 && !_this51.hasTreeExpand(row)) {
              _this51.setTreeExpansion(row, true);
            }
          });
        }
      }
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this53.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = DomTools.getCell(_this53, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this55.validCellRules('all', row, column).then(resolve).catch(function (_ref7) {
                  var rule = _ref7.rule,
                      rules = _ref7.rules;
                  var rest = {
                    rule: rule,
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = DomTools.getCell(_this55, params);

              _this55.handleValidError(params);
            ...
            DomTools.toView(_this55.$el);

            if (_this55.validOpts.autoPos === false) {
              finish();
            } else {
              if (treeConfig) {
                _this55.scrollToTreeRow(locatRow).then(posAndFinish);
              } else {
                _this55.scrollToRow(locatRow).then(posAndFinish);
              }
            }
          });
        });
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    columnIndex: _this56.getColumnMapIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
    ...
    handleValidError: function handleValidError(params) {
      ...
      if (this.validOpts.autoPos === false) {
        ...
        this.handleActived(params, {
          ...
          return _this57.showValidTooltip(params);
        });
      }
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this58.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this58, 'valid-error', [params]);
      });
    },
    ...
    exportData: function exportData(options) {
      ...
      var opts = Object.assign({
        ...
        columnFilterMethod: options.columns ? null : function (column) {
          return ['seq', 'index'].includes(column.type) || column.property;
        },
      ...
      if (!opts.filename) {
        opts.filename = conf.i18n('vxe.table.expFilename', [external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toDateString(Date.now(), 'yyyyMMddHHmmss')]);
      }
      ...
      if (!v_x_e_table.exportTypes.includes(opts.type)) {
        ...
        if (types.includes(type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this59, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      var rest = new Promise(function (resolve, reject) {
        _this60._importResolve = resolve;
        _this60._importReject = reject;
      });
      this.readFile(opts).then(function (evnt) {
        return _this60.importByFile(evnt.target.files[0], opts);
      }).catch(function (evnt) {
        _this60._importReject(evnt);

        _this60._importReject = null;
      });
      return rest;
    },
    readFile: function readFile() {
      ...
      fileInput.onchange = function (evnt) {
        ...
        if (types.includes(type)) {
          _this61._fileResolve(evnt);
        } else {
          if (options.message !== false) {
            _this61.$XModal.message({
          ...
          _this61._fileReject(evnt);
        }

        _this61._fileResolve = null;
      };

      fileForm.reset();
      fileInput.click();
      return new Promise(function (resolve, reject) {
        _this61._fileResolve = resolve;
        _this61._fileReject = reject;
      });
    },
            ...
            if (ajax.save) {
              ...
              if (insertRecords.length) {
                body.pendingRecords = pendingRecords.filter(function (row) {
                  return !insertRecords.includes(row);
                });
              } // 排除已标记为删除的数据
              ...
              if (pendingRecords.length) {
                body.insertRecords = insertRecords.filter(function (row) {
                  return !pendingRecords.includes(row);
                });
              } // 只校验新增和修改的数据
  ...
  methods: {
    ...
    saveColumnHide: function saveColumnHide() {
      ...
      if (customOpts.storage) {
        ...
        localStorage.setItem(customOpts.storageKey, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toJSONString(columnHideStorageMap));
      }
    ...
    openExport: function openExport(options) {
      ...
      var selectRecords = comp.getSelectRecords(); // v3.0 废弃 type=index
...
function getLabelData($table, columns, datas) {
  ...
  if (treeConfig) {
    ...
    external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(datas, function (row, rowIndex, items, path, parent, nodes) {
      ...
      columns.forEach(function (column, columnIndex) {
        // v3.0 废弃 type=index
        item[column.id] = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toString(['seq', 'index'].includes(column.type) ? getSeq($table, row, rowIndex, column, columnIndex) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, column.property));
      });
  ...
  return datas.map(function (row, rowIndex) {
    ...
    columns.forEach(function (column, columnIndex) {
      ...
      if (scrollXLoad || scrollYLoad) {
        // v3.0 废弃 type=index
        item[column.id] = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toString(['seq', 'index'].includes(column.type) ? getSeq($table, row, rowIndex, column, columnIndex) : row[column.property]);
      } else {
...
function getExportData($table, opts, fullData, oColumns) {
  ...
  return {
    columns: columns,
    datas: opts.data ? datas : getLabelData($table, columns, datas)
  };
}
      ...
      if (storeData.mode === 'selected') {
        if (['html', 'pdf'].includes(defaultOptions.type) && comp.treeConfig) {
          opts.data = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.searchTree(comp.getTableData().fullData, function (item) {
            return selectRecords.includes(item);

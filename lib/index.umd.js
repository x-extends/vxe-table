  ...
  methods: {
    ...
    importData: function importData(options) {
      ...
      this.readFile().then(function (evnt) {
        return _this44.importByFile(evnt.target.files[0], options);
      });
      return new Promise(function (resolve) {
        _this44._importCallback = resolve;
      });
    },
...
function toCsv($table, opts, columns, datas) {
  ...
  if (opts.isFooter) {
    ...
    footers.forEach(function (rows) {
      content += rows.map(function (val, colIndex) {
...
function toHtml($table, opts, columns, datas) {
  ...
  if (opts.isFooter) {
    ...
    if (footers.length) {
      html += '<tfoot>';
      footers.forEach(function (rows) {
        html += "<tr>".concat(rows.map(function (val, colIndex) {
...
function toXML($table, opts, columns, datas) {
  ...
  if (opts.isFooter) {
    ...
    if (footers.length) {
      footers.forEach(function (rows) {
        xml += "<Row>".concat(rows.map(function (val, colIndex) {
...
/* harmony default export */ var import_panel = ({
  ...
  render: function render(h) {
    ...
    }, [h('tr', [h('td', conf.i18n('vxe.toolbar.impFile')), h('td', [hasFile ? h('span', "".concat(storeData.filename, ".").concat(storeData.type)) : h('vxe-button', {
      props: {
        type: 'text'
      },
      on: {

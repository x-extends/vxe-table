...
// CONCATENATED MODULE: ./packages/column/src/cell.js
...
var Cell = {
  ...
  renderIndexCell: function renderIndexCell(h, params) {
    ...
    var seq = params.seq,
        level = params.level;
    return [UtilTools.formatText(indexMethod ? indexMethod(params) : level ? "".concat(level, ".").concat(seq) : startIndex + seq, 1)];
  },
  ...
  methods: {
    ...
    cacheDataMap: function cacheDataMap() {
      ...
      if (treeConfig) {
        ...
        tableFullData.forEach(function (row, index) {
          fullDataRowIdMap.set('' + external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, rowKey), {
            rowKey: rowKey,
            row: row,
            index: index
    ...
    preventEvent: function preventEvent(evnt, type, args, callback) {
      ...
      if (!evntList.some(function (func) {
        return func(args, evnt, _this8) === false;
      })) {
        callback();
      }
    },
        ...
        if (!(editConfig.autoClear === false)) {
          ...
          if (!this.lastCallTime || this.lastCallTime + 50 < Date.now()) {
            this.preventEvent(evnt, 'event.clear_actived', actived.args, function () {
              var isClear;
              var isReadonlyCol = !_this9.getEventTargetNode(evnt, _this9.$el, 'col--edit').flag; // row 方式

              if (editConfig.mode === 'row') {
                var rowNode = _this9.getEventTargetNode(evnt, _this9.$el, 'vxe-body--row');
              ...
              !_this9.getEventTargetNode(evnt, _this9.$el).flag) {
                // this.triggerValidate('blur').then(a => {
                _this9.clearValidate();

                _this9.clearActived(evnt); // }).catch(e => e)
    ...
    setActiveCell: function setActiveCell(row, prop) {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          var tableData = _this15.tableData,
              visibleColumn = _this15.visibleColumn,
              handleActived = _this15.handleActived;
          ...
          if (row && prop) {
            ...
            if (rowIndex > -1) {
              ...
              _this15.lastCallTime = Date.now();
            }
          }

          resolve(_this15.$nextTick());
        });
      });
    },
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        var tableBody = _this16.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this16.$refs.tableFooter;
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this17.$refs,
            tableData = _this17.tableData,
            editRules = _this17.editRules;
        ...
        if (scope && $refs.tableBody && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
          ...
          if (_this17.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            ...
            if (cell) {
              return _this17.validCellRules(type, row, column).then(function () {
                return _this17.clearValidate();
              }).catch(function (_ref9) {
                var rule = _ref9.rule;
                return _this17.showValidTooltip({
                  rule: rule,
                  row: row,
                  column: column,
                  cell: cell
    ...
    beginValidate: function beginValidate(rows, cb, isAll) {
      ...
      if (!external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
            ...
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              validPromise = validPromise.then(function () {
                return new Promise(function (resolve, reject) {
                  _this19.validCellRules('all', row, column).then(resolve).catch(function (_ref11) {
        ...
        return validPromise.then(function () {
          ...
          params.cell = DomTools.getCell(_this19, params);

          _this19.handleValidError(params);
                  ...
                  if (type === 'all' || !rule.trigger || type === rule.trigger) {
                    if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                      rule.validator(rule, value, function (e) {
                        ...
                        row: row,
                        column: column,
                        rowIndex: _this20.getRowMapIndex(row),
                        columnIndex: _this20.getColumnMapIndex(column)
                      });
                    } else {
                      var len;
                      var restVal = value;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this21.showValidTooltip(params);
      });
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      var rule = params.rule,
          ...
          cell = params.cell;
      this.$nextTick(function () {
        Object.assign(_this22.validStore, {
          row: row,
          column: column,
          rule: rule,
        ...
        UtilTools.emitEvent(_this22, 'valid-error', [params]);
      });
    },
  ...
  render: function render(h) {
    ...
    h('thead', headerColumn.map(function (cols, rowIndex) {
      return h('tr', {
        ...
        return h('th', {
          class: ['vxe-header--column', column.id, (_ref = {}, _defineProperty(_ref, "col--".concat(headerAlign), headerAlign), _defineProperty(_ref, 'col--current', selectColumn === column), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref, 'filter--active', column.filters.some(function (item) {
            return item.checked;
  ...
  methods: _objectSpread({}, methods, {
                ...
                this.remove(selectRecords).then(function () {
                  ...
                  if (removeRecords.length) {
                    ...
                    if (isMsg && !selectRecords.length) {
                      _this3.$XMsg.message(conf.i18n('vxe.grid.selectOneRecord'));
                    }
                  }
                });
              }
                    ...
                    if (vaild) {
                      if (body.insertRecords.length || removeRecords.length || updateRecords.length || body.pendingRecords.length) {
                        ...
                        resolve(ajax.save({
                          ...
                          _this3.$XMsg.message(conf.i18n('vxe.grid.saveSuccess'));
                        ...
                        if (isMsg) {
                          ...
                          if (pendingRecords.length) {
                            ...
                            _this3.$XMsg.message(conf.i18n('vxe.grid.dataUnchanged'));
                          }
                        }
    ...
    triggerPendingEvent: function triggerPendingEvent(evnt) {
      ...
      if (selectRecords.length) {
        ...
        if (isMsg) {
          this.$XMsg.message(conf.i18n('vxe.grid.selectOneRecord'));
        }
      }
    },
...
/* harmony default export */ var src_message = ({
  ...
  render: function render(h) {
    ...
    var vSize = this.vSize,
        ...
        isMsg = this.isMsg;
    return h('div', {
      class: ['vxe-msg--wrapper', "type--".concat(type), (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, 'is--animat', animat), _defineProperty(_ref, 'lock--view', lockView), _defineProperty(_ref, 'is--mask', mask), _defineProperty(_ref, 'is--visible', contentVisible), _defineProperty(_ref, "active", visible), _ref)],
      style: {
        zIndex: zIndex,
  ...
  methods: {
    ...
    removeMsgQueue: function removeMsgQueue() {
      ...
      if (msgQueueList.indexOf(this) > -1) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.remove(msgQueueList, function (comp) {
          return comp === _this2;
        });
      }
    ...
    updateStyle: function updateStyle() {
      this.$nextTick(function () {
        var offsetTop = 0;
        msgQueueList.forEach(function (comp, index) {
          offsetTop += comp.top;

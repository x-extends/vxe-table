...
function renderer_renderOptions(h, options, renderOpts, params) {
  ...
  var disabledProp = optionProps.value || 'disabled';
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    reserveCheckSelection: function reserveCheckSelection() {
      var _this$selectConfig10 = this.selectConfig,
    ...
    triggerCellClickEvent: function triggerCellClickEvent(evnt, params) {
      ...
      var $el = this.$el,
          ...
          _this$selectConfig12 = this.selectConfig,
          selectConfig = _this$selectConfig12 === void 0 ? {} : _this$selectConfig12,

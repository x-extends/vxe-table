...
var Cell = {
  ...
  renderSelectionCell: function renderSelectionCell(h, params) {
    ...
    var row = params.row,
        isHidden = params.isHidden; // 在 v2.0 中废弃 labelProp
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var scrollXLoad = _this18.scrollXLoad,
            scrollYLoad = _this18.scrollYLoad,
            scrollYStore = _this18.scrollYStore,
            scrollXStore = _this18.scrollXStore,
            visibleColumn = _this18.visibleColumn,
            optimizeOpts = _this18.optimizeOpts;
        var scrollX = optimizeOpts.scrollX,
            scrollY = optimizeOpts.scrollY;
        var tableBody = _this18.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableHeader = _this18.$refs.tableHeader;
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this22.validCellRules('all', row, column).then(resolve).catch(function (_ref10) {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = DomTools.getCell(_this22, params);
            ...
            if (scrollYLoad) {
              ...
              var rowIndex = _this22.getRowMapIndex(params.row);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        UtilTools.emitEvent(_this25, 'valid-error', [params]);
      });
    },
  ...
  render: function render(h) {
    ...
    h('thead', headerColumn.map(function (cols, $rowIndex) {
      return h('tr', {
        ...
        return h('th', {
          class: ['vxe-header--column', column.id, (_ref = {}, _defineProperty(_ref, "col--".concat(headAlign), headAlign), _defineProperty(_ref, 'col--current', selectColumn === column), _defineProperty(_ref, 'col--ellipsis', hasEllipsis), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref, 'filter--active', column.filters.some(function (item) {
            return item.checked;

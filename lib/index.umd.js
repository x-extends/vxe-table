...
function defaultFormRender(h, renderOpts, params, context) {
  ...
  var name = renderOpts.name;
  var attrs = renderer_getAttrs(renderOpts);
  var cellValue = xe_utils_amd_xe_utils_default.a.get(data, field);
  return [h(name, {
    class: "vxe-default-".concat(name),
    attrs: attrs,
...
function getFormEvents(renderOpts, params, context) {
  ...
  var on = _defineProperty({}, type, function (evnt) {
    xe_utils_amd_xe_utils_default.a.set(data, field, evnt.target.value);
    ...
    resetEvent: function resetEvent(evnt) {
      ...
      if (data) {
        this.$children.forEach(function (_ref2) {
          ...
          if (field) {
            xe_utils_amd_xe_utils_default.a.set(data, field, null);
          }
        });
      }
...
var components = [// 模块
packages_column, packages_header, packages_body, packages_footer, filter, packages_loading, packages_grid, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_button, packages_modal, packages_tooltip, packages_form, edit, packages_export, keyboard, validator, packages_resize, // 核心
packages_table]; // 默认安装

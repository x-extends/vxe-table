...
/* harmony default export */ var src_form = ({
  ...
  methods: {
    loadForm: function loadForm() {
      if (this.data) {
        this.sourceData = xe_utils_amd_xe_utils_default.a.clone(this.data, true);
      }
    },
    ...
    resetEvent: function resetEvent(evnt) {
      ...
      if (data) {
        this.$children.forEach(function (_ref2) {
          ...
          if (field) {
            xe_utils_amd_xe_utils_default.a.set(data, field, xe_utils_amd_xe_utils_default.a.get(sourceData, field, null));
          }
        });
      }

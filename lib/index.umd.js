...
function defaultFormRender(h, renderOpts, params, context) {
  ...
  var name = renderOpts.name;
  var attrs = renderer_getAttrs(renderOpts);
  var cellValue = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(data, field);
  return [h(name, {
...
function getFormEvents(renderOpts, params, context) {
  var _params2 = params,
      data = _params2.data,
      field = _params2.field;
  var events = renderOpts.events;
  var type = name === 'select' ? 'change' : 'input';

  var on = _defineProperty({}, type, function (evnt) {
    external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(data, field, evnt.target.value);
...
var Cell = {
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    return [h('span', {
      ...
      on: on
    }, labelField ? slots && slots.default ? slots.default(params, h) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, labelField) : null)];
  },
...
/* harmony default export */ var grid = ({
  ...
  methods: _objectSpread({}, methods, {
    ...
    submitEvent: function submitEvent() {
      ...
      UtilTools.emitEvent(this, 'form-submit', [{
        $grid: this
      }]);
    },
    resetEvent: function resetEvent() {
      UtilTools.emitEvent(this, 'form-reset', [{
        $grid: this
      }]);
    },
    zoom: function zoom() {
...
function renderBtn(h, _vm, compConf) {
  ...
  if (compConf && compConf.renderButtons) {
    return compConf.renderButtons.call(_vm, h, rConfig, comp ? comp.params : null, {
      $grid: $grid,
      $table: $table
    });
  }
    ...
    resetEvent: function resetEvent(evnt) {
      ...
      if (data) {
        this.$children.forEach(function (_ref2) {
          ...
          if (field) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(data, field, null);
          }
        });
      }

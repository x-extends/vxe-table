...
var interceptorStore = {
  mixin: function mixin(map) {
    external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.each(map, function (evntFn, type) {
...
function () {
  ...
  function ColumnConfig($table, _vm) {
    ...
    } else if (_vm.type === 'selection') {// UtilTools.warn('vxe.error.delProp', ['selection', 'checkbox'])
    ...
    if (formatter) {
      if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(formatter)) {
        if (!external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a[formatter])) {
        ...
        if (!external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a[formatter[0]])) {
...
var UtilTools = {
  ...
  getRowkey: function getRowkey($table) {
    ...
    if (!rowKey || !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(rowKey)) {
      // 在 v2.0 中废弃 key
      rowKey = rowId || checkboxOpts.key || treeOpts.key || expandOpts.key || editConfig.key || conf.rowId;
    }
  ...
  emitEvent: function emitEvent(_vm, type, args) {
    if (_vm.$listeners[type]) {
      _vm.$emit.apply(_vm, _toConsumableArray([type].concat(args)));
    }
  },
  // 获取所有的列，排除分组
  ...
  getCellLabel: function getCellLabel(row, column, params) {
    ...
    if (params && formatter) {
      ...
      if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(formatter)) {
        cellLabel = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a[formatter] ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a[formatter](cellValue) : '';
      } else if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isArray(formatter)) {
        cellLabel = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a[formatter[0]] ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a[formatter[0]].apply(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a, _toConsumableArray([cellValue].concat(formatter.slice(1)))) : '';
      } else {
  ...
  isColumn: function isColumn(column) {
    return column instanceof utils_ColumnConfig;
  },
  getColumnConfig: function getColumnConfig($table, _vm, options) {
    return UtilTools.isColumn(_vm) ? _vm : new utils_ColumnConfig($table, _vm, options);
  },
  // 组装列配置
...
function getEvents(renderOpts, params) {
  ...
  if (events) {
    return external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.assign({}, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.objectMap(events, function (evntFn) {
      return function () {
...
function renderColumn(h, _vm, $table, $seq, seq, rowid, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex, columns, items) {
  ...
  return h('td', {
    ...
    on: tdOns
  }, allColumnOverflow && fixedHiddenColumn && !spanMethod ? [h('div', {
    class: ['vxe-cell', {
      'c--title': showTitle,
  ...
  tableData.forEach(function (row, $rowIndex) {
    ...
    if (treeConfig && treeExpandeds.length) {
      ...
      if (rowChildren && rowChildren.length && treeExpandeds.indexOf(row) > -1) {
        rows.push.apply(rows, _toConsumableArray(renderRows(h, _vm, $table, $seq ? "".concat($seq, ".").concat(seq) : "".concat(seq), rowLevel + 1, fixedType, rowChildren, tableColumn)));
      }
    }
  });
  return rows;
...
/* harmony default export */ var src_body = ({
  ...
  render: function render(h) {
    ...
    var $scopedSlots = $table.$scopedSlots,
        ...
        scrollYLoad = $table.scrollYLoad,
        scrollYStore = $table.scrollYStore,
        emptyRender = $table.emptyRender,
        emptyOpts = $table.emptyOpts; // v2.0 废弃属性，保留兼容
    ...
    if (height) {
      customHeight = height === 'auto' ? parentHeight : (DomTools.isScale(height) ? Math.floor(parseInt(height) / 100 * parentHeight) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toNumber(height)) - $table.getExcludeHeight();
...
var Cell = {
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    var row = params.row; // 在 v2.0 中废弃 labelProp

    var labelField = radioOpts.labelField || radioOpts.labelProp;
    ...
    })].concat(labelField ? slots && slots.default ? slots.default.call($table, params, h) : [external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, labelField)] : []))];
  },
  ...
  renderSelectionCell: function renderSelectionCell(h, params) {
    ...
    var labelField = checkboxOpts.labelField || checkboxOpts.labelProp;
  ...
  renderExpandCell: function renderExpandCell(h, params) {
    ...
    })]), slots.content && slots.default ? slots.default.call($table, params, h) : labelField ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, labelField) : null];
  },
...
/* harmony default export */ var table = ({
  ...
  props: {
    ...
    showFooterOverflow: {
      type: [Boolean, String],
      default: function _default() {
        return conf.showFooterOverflow;
      }
    },
    // 是否所有服务端筛选
  ...
  data: function data() {
    return {
      id: "".concat(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.uniqueId()),
      tZindex: 0,
      // 列分组配置
      collectColumn: [],
      // 完整所有列
  ...
  created: function created() {
    ...
    if (this.selectConfig) {// UtilTools.warn('vxe.error.delProp', ['select-config', 'checkbox-config'])
    }
    ...
    if (this.customs) {// UtilTools.warn('vxe.error.removeProp', ['customs'])
    }

    if (this.sortMethod) {// UtilTools.warn('vxe.error.delProp', ['sort-method', 'sort-config.sortMethod'])
    }

    if (this.remoteSort) {// UtilTools.warn('vxe.error.delProp', ['remote-sort', 'sort-config.remote'])
    }

    if (this.remoteFilter) {// UtilTools.warn('vxe.error.delProp', ['remote-filter', 'filter-config.remote'])
    }
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-table', "tid_".concat(id), vSize ? "size--".concat(vSize) : '', border && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(border) ? "b--style-".concat(border) : '', {
  ...
  methods: {
    ...
    refreshData: function refreshData() {
      ...
      return this.$nextTick().then(function () {
        ...
        return _this9.$nextTick().then(function () {
          return _this9.loadTableData(_this9.tableFullData);
        });
      });
    },
    ...
    loadTableData: function loadTableData(datas) {
      ...
      return this.computeScrollLoad().then(function () {
        // 是否加载了数据
        _this10.isLoadData = true;

        _this10.computeRowHeight();

        _this10.handleReserveStatus();

        _this10.checkSelectionStatus();

        return _this10.$nextTick().then(_this10.recalculate).then(_this10.refreshScroll);
      });
    },
    ...
    reloadData: function reloadData(datas) {
      ...
      return this.clearAll().then(function () {
        _this11.inited = true;
        return _this11.loadTableData(datas);
    ...
    loadColumn: function loadColumn(columns) {
      ...
      this.collectColumn = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.mapTree(columns, function (column) {
        return packages_cell.createColumn(_this12, column);
      }, headerProps);
      return this.$nextTick();
    },
    ...
    updateCache: function updateCache(source) {
      ...
      var handleCache = function handleCache(row, index) {
        var rowid = UtilTools.getRowid(_this13, row);
    ...
    appendTreeCache: function appendTreeCache(row, childs) {
      ...
      if (keepSource) {
        matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableSourceData, function (item) {
          return rowid === UtilTools.getRowid(_this14, item);
        }, treeOpts);
      }

      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(childs, function (row, index) {
        var rowid = UtilTools.getRowid(_this14, row);
        ...
        if (row[hasChild] && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isUndefined(row[children])) {
          row[children] = null;
        }
      ...
      if (matchObj) {
        matchObj.item[children] = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.clone(childs, true);
      }
    },
    // 更新列的 Map
    cacheColumnMap: function cacheColumnMap() {
      ...
      if (isGroup) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(collectColumn, function (column, index) {
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableFullData, function (row) {
            return UtilTools.getRowid(_this15, row) === rowid;
          }, treeOpts);
    ...
    */
    ...
    insertAt: function insertAt(records, row) {
      ...
      var newRecords = records.map(function (record) {
        return _this16.defineField(Object.assign({}, record));
      });
    ...
    defineField: function defineField(row) {
      ...
      if (treeConfig && treeOpts.lazy && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isUndefined(row[treeOpts.children])) {
        row[treeOpts.children] = null;
    ...
    createData: function createData(records) {
      ...
      return this.$nextTick().then(function () {
        return records.map(_this17.defineField);
      });
    },
    createRow: function createRow(records) {
      ...
      return this.$nextTick().then(function () {
        var rows = records.map(function (record) {
          return _this18.defineField(Object.assign({}, record));
        });
      ...
      if (keepSource) {
        ...
        if (treeConfig) {
          ...
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableSourceData, function (item) {
            return rowid === UtilTools.getRowid(_this21, item);
          }, treeOpts);
    ...
    getColumnByField: function getColumnByField(field) {
      return external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find(this.tableFullColumn, function (column) {
    ...
    updateAfterFullData: function updateAfterFullData() {
      ...
      if (column && column.order) {
        ...
        var isRemote = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(column.remoteSort) ? column.remoteSort : sortOpts.remote || remoteSort;
    ...
    reloadCustoms: function reloadCustoms(customColumns) {
      ...
      return this.$nextTick().then(function () {
        _this22.mergeCustomColumn(customColumns);

        return _this22.refreshColumn().then(function () {
          return _this22.tableFullColumn;
        });
      });
    },
    ...
    refreshColumn: function refreshColumn() {
      ...
      return this.$nextTick().then(function () {
        _this23.updateFooter();

        _this23.recalculate(true);
      });
    },
    ...
    refreshScroll: function refreshScroll() {
      ...
      return this.$nextTick().then(function () {
        if (lastScrollLeft || lastScrollTop) {
          // 重置最后滚动状态
          _this24.lastScrollLeft = 0;
          _this24.lastScrollTop = 0; // 还原滚动状态

          return _this24.scrollTo(lastScrollLeft, lastScrollTop);
        }
      });
    },
      ...
      if (bodyElem) {
        ...
        if (refull === true) {
          ...
          return this.computeScrollLoad().then(function () {
            ...
            _this25.autoCellWidth(headerElem, bodyElem, footerElem, bodyWidth);

            _this25.computeScrollLoad();
          });
        }
      }
        ...
        if (!(editOpts.autoClear === false)) {
          if (validTip && DomTools.getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clearActived', actived.args, function () {
              ...
              !DomTools.getEventTargetNode(evnt, _this27.$el).flag) {
                // this.triggerValidate('blur').then(a => {
                // 保证 input 的 change 事件能先触发之后再清除
                setTimeout(function () {
                  return _this27.clearActived(evnt);
                }); // }).catch(e => e)
              }
            });
          }
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (this.isActivated) {
        this.preventEvent(evnt, 'event.keydown', {
          ...
          var params;
          var isCtxMenu = _this28.isCtxMenu,
              ctxMenuStore = _this28.ctxMenuStore,
              editStore = _this28.editStore,
              _this28$mouseConfig = _this28.mouseConfig,
              mouseConfig = _this28$mouseConfig === void 0 ? {} : _this28$mouseConfig,
              _this28$keyboardConfi = _this28.keyboardConfig,
              keyboardConfig = _this28$keyboardConfi === void 0 ? {} : _this28$keyboardConfi,
          ...
          if (isEsc) {
            ...
            _this28.closeFilter(); // 如果是激活编辑状态，则取消编辑
            ...
            if (actived.row) {
              ...
              if (mouseConfig.selected) {
                _this28.handleSelected(params, evnt);
              }
            }
            ...
            if (selected.column.type === 'checkbox' || selected.column.type === 'selection') {
              _this28.handleToggleCheckRowEvent(selected.args, evnt);
            } else {
            ...
            if (selected.row || actived.row) {
              _this28.moveSelected(selected.row ? selected.args : actived.args, isLeftArrow, isUpArrow, isRightArrow, true, evnt);
              ...
              if (childrens && childrens.length) {
                ...
                _this28.setTreeExpansion(currentRow, true).then(function () {
            ...
            // 如果按下了 Tab 键切换
            if (selected.row || selected.column) {
              _this28.moveTabSelected(selected.args, isShiftKey, evnt);
            } else if (actived.row || actived.column) {
              _this28.moveTabSelected(actived.args, isShiftKey, evnt);
            }
            ...
            if (keyboardConfig.isDel && (selected.row || selected.column)) {
              ...
              // 如果树形表格回退键关闭当前行返回父节点
              var _XEUtils$findTree = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(_this28.afterFullData, function (item) {
              ...
              if (parentRow) {
                ...
                _this28.setTreeExpansion(parentRow, false).then(function () {
            ...
            // 如果开启复制功能
            if (isX || isC) {
              _this28.handleCopyed(isX, evnt);
            } else {
              _this28.handlePaste(evnt);
            }
          ...
          this.preventEvent(evnt, 'event.showMenu', params, null, function () {
            if (!visibleMethod || visibleMethod(params, evnt)) {
              ...
              _this30.$nextTick(function () {
                var ctxElem = _this30.$refs.ctxWrapper.$el;
    ...
    handleTooltipLeaveEvent: function handleTooltipLeaveEvent() {
      ...
      setTimeout(function () {
        if (!_this31.tooltipActive) {
          _this31.clostTooltip();
        }
    ...
    handleTargetLeaveEvent: function handleTargetLeaveEvent() {
      ...
      if (tooltipOpts.enterable) {
        this.tooltipTimeout = setTimeout(function () {
          if (!_this32.$refs.tooltip.isHover) {
            _this32.clostTooltip();
          }
        }, tooltipOpts.leaveDelay);
      } else {
        this.clostTooltip();
          ...
          if (value === -1) {
            ...
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree([row], function (item, $rowIndex) {
              if (row === item || !checkMethod || checkMethod({
                ...
                _this34.handleSelectReserveRow(row, value);
              }
            }, treeOpts);
    ...
    setAllCheckboxRow: function setAllCheckboxRow(value) {
      ...
      if (!checkStrictly) {
        if (property) {
          ...
          if (treeConfig) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(afterFullData, value ? setValFn : clearValFn, treeOpts);
          } else {
          ...
          if (treeConfig) {
            if (value) {
              external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(afterFullData, function (row, $rowIndex) {
                if (!checkMethod || checkMethod({
                  row: row,
                  $rowIndex: $rowIndex
                })) {
        ...
        if (reserve) {
          if (value) {
            selectRows.forEach(function (row) {
              selectReserveRowMap[UtilTools.getRowid(_this35, row)] = row;
            });
          } else {
            afterFullData.forEach(function (row) {
              var rowid = UtilTools.getRowid(_this35, row);
    ...
    handleReserveByRowid: function handleReserveByRowid(list, rest) {
      ...
      list.forEach(function (row) {
        var rowid = UtilTools.getRowid(_this36, row);
    ...
    triggerCellMousedownEvent: function triggerCellMousedownEvent(evnt, params) {
      ...
      var isRightBtn = button === 2; // 在 v3.0 中废弃 mouse-config.checked
      ...
      if (isLeftBtn || isRightBtn) {
        if (isMouseChecked) {
          if (editConfig && editOpts.trigger === 'dblclick') {
            if (editOpts.mode === 'row' && actived.row === row || actived.row === row && actived.column === column) {// 如果已经是激活状态
            } else {
              if (isLeftBtn) {
                this.handleSelected(params, evnt);
    ...
    handleCheckboxRangeEvent: function handleCheckboxRangeEvent(evnt, params) {
      ...
      if (['checkbox', 'selection'].indexOf(column.type) > -1) {
        ...
        document.onmousemove = function (evnt) {
          ...
          var rangeRows = _this37.getCheckboxRangeResult(trEleme, evnt.clientY - absPos.top);
          ...
          checkboxRangeElem.style.zIndex = "".concat(_this37.tZindex); // 至少滑动 10px 才能有效匹配
          ...
          if (rangeHeight > 10 && rangeRows.length !== lastRangeRows.length) {
            ...
            if (evnt.ctrlKey) {
              rangeRows.forEach(function (row) {
                _this37.handleSelectRow({
                  row: row
                }, selectRecords.indexOf(row) === -1);
              });
            } else {
              _this37.clearCheckboxRow();

              _this37.setCheckboxRow(rangeRows, true);
            }
          }
        };
      ...
      if (editRender && cell) {
        if (mode === 'row' ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this40.handleFocus(params, evnt);
            });
          }
      ...
      var selectMethod = function selectMethod() {
        if ((isMouseSelected || isMouseChecked) && (selected.row !== row || selected.column !== column)) {
          if (actived.row !== row || (editOpts.mode === 'cell' ? actived.column !== column : false)) {
            _this41.clearChecked(evnt);

            _this41.clearActived(evnt);
            ...
            if (isMouseChecked) {
              ...
              _this41.handleChecked(select, select, evnt);
            }
          }
        }
     ...
     * 处理所有选中
     */
    handleChecked: function handleChecked(start, end) {
     ...
     * 处理所有选中的临时选中
     */
    handleTempChecked: function handleTempChecked(start, end) {
      var tableData = this.tableData,
          visibleColumn = this.visibleColumn,
          editStore = this.editStore;
      var checked = editStore.checked;
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find(_this42.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = DomTools.getCell(_this42, {
              row: row,
              column: column
            });

            if (cell) {
              _this42.handleActived({
                row: row,
                rowIndex: _this42.getRowIndex(row),
                column: column,
                columnIndex: _this42.getColumnIndex(column),
                cell: cell,
                $table: _this42
              });

              _this42.lastCallTime = Date.now();
            }
          }
        }
    ...
    handleDefaultSort: function handleDefaultSort() {
      ...
      if (defaultSort) {
        ...
        if (field && order) {
          var column = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find(this.visibleColumn, function (item) {
    ...
    handleAsyncRowExpand: function handleAsyncRowExpand(row) {
      ...
      return new Promise(function (resolve) {
        ...
        _this44.expandOpts.loadMethod({
          ...
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.remove(_this44.expandLazyLoadeds, function (item) {
            return item === row;
          });
        ...
        if (expanded) {
          rows.forEach(function (row) {
            if (rowExpandeds.indexOf(row) === -1) {
              ...
              if (isLoad) {
                result.push(_this45.handleAsyncRowExpand(row));
              } else {
    ...
    clearRowExpand: function clearRowExpand() {
      ...
      this.rowExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this46.recalculate() : 0;
      });
    },
    ...
    handleAsyncTreeExpandChilds: function handleAsyncTreeExpandChilds(row) {
      ...
      return new Promise(function (resolve) {
        ...
        loadMethod({
          ...
          if (!external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isArray(childs)) {
            childs = [];
          }
          ...
          if (childs) {
            ...
            _this48.appendTreeCache(row, childs);
            ...
            if (_this48.isCheckedByCheckboxRow(row)) {
              _this48.setCheckboxRow(childs, true);
            }
          }

          resolve(_this48.$nextTick().then(_this48.recalculate));
        });
      });
    },
    ...
    clearTreeExpand: function clearTreeExpand() {
      ...
      this.treeExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this50.recalculate() : 0;
      });
    },
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var vSize = _this51.vSize,
            scrollXLoad = _this51.scrollXLoad,
            scrollYLoad = _this51.scrollYLoad,
            scrollYStore = _this51.scrollYStore,
            scrollXStore = _this51.scrollXStore,
            visibleColumn = _this51.visibleColumn,
            optimizeOpts = _this51.optimizeOpts,
            rowHeightMaps = _this51.rowHeightMaps;
        var scrollX = optimizeOpts.scrollX,
            scrollY = optimizeOpts.scrollY;
        var tableBody = _this51.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableHeader = _this51.$refs.tableHeader;
        ...
        if (tableBodyElem) {
          ...
          if (scrollXLoad) {
            ...
            _this51.updateScrollXData();
          } else {
            _this51.updateScrollXSpace();
          } // 计算 Y 逻辑
          ...
          if (scrollYLoad) {
            ...
            _this51.updateScrollYData();
          } else {
            _this51.updateScrollYSpace();
          }
        }

        return _this51.$nextTick();
      });
    },
      ...
      if (this.scrollXLoad || this.scrollYLoad) {
        return new Promise(function (resolve) {
          return setTimeout(function () {
            return resolve(_this52.$nextTick());
          }, 50);
        });
      }
      ...
      if (treeConfig) {
        ...
        if (matchObj) {
          ...
          nodes.forEach(function (row, index) {
            if (index < nodes.length - 1 && !_this53.hasTreeExpand(row)) {
              _this53.setTreeExpansion(row, true);
            }
          });
        }
      }
    ...
    clearScroll: function clearScroll() {
      ...
      return this.$nextTick().then(function () {
        ...
        return new Promise(function (resolve) {
          return setTimeout(function () {
            return resolve(_this54.$nextTick());
          });
        });
      });
    },
    ...
    updateStatus: function updateStatus(scope, cellValue) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this55.$refs,
            tableData = _this55.tableData,
            editRules = _this55.editRules,
            validStore = _this55.validStore;
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this55.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = DomTools.getCell(_this55, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
            ...
            if (cell) {
              return _this55.validCellRules(type, row, column, cellValue).then(function () {
                if (customVal && validStore.visible) {
                  UtilTools.setCellValue(row, column, cellValue);
                }

                _this55.clearValidate();
    ...
    triggerValidate: function triggerValidate(type) {
      ...
      var actived = editStore.actived; // const type = validStore.visible ? 'all' : 'blur'
      // this.clearValidate()
      ...
      if (actived.row && editRules) {
        var _actived$args = actived.args,
            ...
            cell = _actived$args.cell; // if (editOpts.mode === 'row') {
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this57.validCellRules('all', row, column).then(resolve).catch(function (_ref7) {
                  var rule = _ref7.rule,
                      rules = _ref7.rules;
                  var rest = {
                    rule: rule,
                    rules: rules,
                    rowIndex: _this57.getRowIndex(row),
                    row: row,
                    columnIndex: columnIndex,
                    column: column,
                    $table: _this57
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = DomTools.getCell(_this57, params);

              _this57.handleValidError(params);
            ...
            DomTools.toView(_this57.$el);

            if (_this57.validOpts.autoPos === false) {
              finish();
            } else {
              if (treeConfig) {
                _this57.scrollToTreeRow(locatRow).then(posAndFinish);
              } else {
                _this57.scrollToRow(locatRow).then(posAndFinish);
              }
            }
          });
        });
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  ...
                  rule.validator(rule, cellValue, function (e) {
                    ...
                    row: row,
                    column: column
                  }, _defineProperty(_rule$validator, "".concat(treeConfig ? '$' : '', "rowIndex"), _this58.getRowIndex(row)), _defineProperty(_rule$validator, "columnIndex", _this58.getColumnIndex(column)), _rule$validator));
                } else {
                  var isNumber = rule.type === 'number';
                  var numVal = isNumber ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toNumber(cellValue) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.getSize(cellValue);
    ...
    handleValidError: function handleValidError(params) {
      ...
      if (this.validOpts.autoPos === false) {
        ...
        this.handleActived(params, {
          ...
          return _this59.showValidTooltip(params);
        });
      }
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this60.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this60, 'valid-error', [params]);
      });
    },
    ...
    exportData: function exportData(options) {
      ...
      if (!opts.filename) {
        opts.filename = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.template(conf.i18n(opts.original ? 'vxe.table.expOriginFilename' : 'vxe.table.expFilename'), [external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toDateString(Date.now(), 'yyyyMMddHHmmss')]);
      }
        ...
        if (types.indexOf(type) > -1) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this61, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      var rest = new Promise(function (resolve, reject) {
        _this62._importResolve = resolve;
        _this62._importReject = reject;
      });
      this.readFile(opts).then(function (evnt) {
        return _this62.importByFile(evnt.target.files[0], opts);
      }).catch(function (evnt) {
        _this62._importReject(evnt);

        _this62._importReject = null;
      });
      return rest;
    },
    readFile: function readFile() {
      ...
      fileInput.onchange = function (evnt) {
        ...
        if (types.indexOf(type) > -1) {
          ...
          _this63._fileReject(evnt);
        }

        _this63._fileResolve = null;
      };

      fileForm.reset();
      fileInput.click();
      return new Promise(function (resolve, reject) {
        _this63._fileResolve = resolve;
        _this63._fileReject = reject;
      });
    },
    print: function print(options) {
      ...
      this.exportData(opts).then(function (_ref9) {
...
var header_getAllColumns = function getAllColumns(columns) {
  var result = [];
  columns.forEach(function (column) {
    if (column.visible) {
...
var convertToRows = function convertToRows(originColumns) {
  ...
  var allColumns = header_getAllColumns(originColumns);
...
/* harmony default export */ var footer = ({
  ...
  render: function render(h) {
    ...
    var tableListeners = $table.$listeners,
        ...
        scrollXStore = $table.scrollXStore,
        cellOffsetWidth = $table.cellOffsetWidth,
        allColumnFooterOverflow = $table.showFooterOverflow,
        currentColumn = $table.currentColumn,
        overflowX = $table.overflowX,
    ...
    return h('div', {
      ...
      style: {
        'margin-top': "".concat(-scrollbarHeight, "px")
      },
      on: {
    ...
    h('tfoot', footerData.map(function (list, $rowIndex) {
      return h('tr', {
        ...
        var columnIndex = getColumnIndex(column);
        var itemIndex = $table.tableColumn.indexOf(column);
        var params = {
          $table: $table,
          $rowIndex: $rowIndex,
          column: column,
        ...
        return h('td', {
          class: ['vxe-footer--column', column.id, (_ref2 = {}, _defineProperty(_ref2, "col--".concat(footAlign), footAlign), _defineProperty(_ref2, "col--".concat(type), type), _defineProperty(_ref2, 'col--last', $columnIndex === tableColumn.length - 1), _defineProperty(_ref2, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref2, 'col--ellipsis', hasEllipsis), _defineProperty(_ref2, 'filter--active', column.filters && column.filters.some(function (item) {
            return item.checked;
          })), _defineProperty(_ref2, 'col--current', currentColumn === column), _ref2), UtilTools.getClass(footerClassName, params), UtilTools.getClass(footerCellClassName, params)],
          attrs: attrs,
...
/* harmony default export */ var grid = ({
  ...
  computed: {
    ...
    renderClass: function renderClass() {
      ...
      return ['vxe-grid', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, 't--animat', tableProps.optimization.animat), _defineProperty(_ref, 'is--maximize', maximize), _defineProperty(_ref, 'is--loading', this.loading || this.tableLoading), _ref)];
    },
  ...
  methods: _objectSpread2({}, methods, {
    getParentHeight: function getParentHeight() {
    ...
    getExcludeHeight: function getExcludeHeight() {
      ...
      if ($el) {
        ...
        paddingTop = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toNumber(computedStyle.paddingTop);
        paddingBottom = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toNumber(computedStyle.paddingBottom);
      }
    ...
    loadColumn: function loadColumn(columns) {
      ...
      columns.forEach(function (column) {
        if (column.slots) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.each(column.slots, function (func, name, slots) {
      ...
      if (proxyConfig) {
        ...
        if (formConfig && proxyOpts.form && formOpts.items) {
          ...
          formOpts.items.forEach(function (_ref2) {
            ...
            if (field) {
              formData[field] = itemRender && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isUndefined(itemRender.defaultValue) ? itemRender.defaultValue : null;
            }
          });
      ...
      switch (code) {
        ...
        case 'delete_selection':
          this.handleDeleteRow(code, 'vxe.grid.deleteSelectRecord', function () {
            return _this4.commitProxy.apply(_this4, _toConsumableArray(['delete'].concat(args)));
          });
          break;
                ...
                return qRest.then(function (rest) {
                  if (rest) {
                    if (pagerConfig) {
                      ...
                      _this4.tableData = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(rest, props.result || props.data || 'result') || [];
                    } else {
                      _this4.tableData = (props.list ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(rest, props.list) : rest) || [];
                    }
                  } else {
                    _this4.tableData = [];
                  }
    ...
    sortChangeEvent: function sortChangeEvent(params) {
      ...
      var $table = params.$table,
          column = params.column;
      var isRemote = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(column.remoteSort) ? column.remoteSort : $table.sortOpts.remote || remoteSort; // 如果是服务端排序
    ...
    submitInvalidEvent: function submitInvalidEvent(params, evnt) {
      UtilTools.emitEvent(this, 'form-submit-invalid', [Object.assign({
        $grid: this
      }, params), evnt]);
    },
    togglCollapseEvent: function togglCollapseEvent(params, evnt) {
      this.recalculate(true);
      UtilTools.emitEvent(this, 'form-toggle-collapse', [Object.assign({
        $grid: this
      }, params), evnt]);
    },
    zoom: function zoom() {
...
/* harmony default export */ var excel = ({
  ...
  methods: _objectSpread2({}, excel_methods, {
...
/* harmony default export */ var src_toolbar = ({
  ...
  render: function render(h) {
    ...
    }, conf.i18n('vxe.toolbar.customRestore'))])])]) : null])]);
  },
  methods: {
    updateConf: function updateConf() {
      var $children = this.$parent.$children;
      var selfIndex = $children.indexOf(this);
      this.$xetable = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find($children, function (comp, index) {
    ...
    restoreCustomStorage: function restoreCustomStorage() {
      ...
      if (resizable || custom || setting) {
        ...
        if (customOpts.storage) {
          var columnVisibleStorage = this.getStorageMap(customOpts.storageKey)[id];
        ...
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.each(customMap, function (_ref2, field) {
    ...
    saveColumnVisible: function saveColumnVisible() {
      var id = this.id,
          tableFullColumn = this.tableFullColumn,
          customOpts = this.customOpts;
      ...
      if (storage) {
        var columnVisibleStorageMap = this.getStorageMap(storageKey);
        var colHides = [];
        var colShows = [];
        tableFullColumn.forEach(function (column) {
          if (!checkMethod || checkMethod({
        ...
        localStorage.setItem(storageKey, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toJSONString(columnVisibleStorageMap));
      }
...
/* harmony default export */ var src_pager = ({
  name: 'VxePager',
  props: {
    size: String,
    // 自定义布局
  ...
  methods: {
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if ((isUpArrow || isDwArrow) && this.showSizes) {
        ...
        var sizeIndex = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findIndexOf(pageSizes, function (num) {
          return num === pageSize;
        });
...
src_pager.install = function (Vue) {
  Vue.component(src_pager.name, src_pager);
};

var Pager = src_pager;
/* harmony default export */ var packages_pager = (src_pager);
    ...
    render: function render(h) {
      ...
      return h('div', {
        ...
        class: ["vxe-".concat(compName, "--suffix"), {
          'is--active': !(value === '' || external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eqNull(value))
        }],
        on: {
...
/* harmony default export */ var modal = ({
  ...
  created: function created() {
    ...
    if (!v_x_e_table._loading && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(this.loading)) {
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      $modal: this
    }, h) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(message) ? message.call(this, h) : message), v_x_e_table._loading && isLoading && !isMsg ? h('vxe-loading', {
      props: {
        visible: loading
      }
...
function getResetValue(value, resetValue) {
  if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(value)) {
    resetValue = '';
  } else if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isArray(value)) {
    resetValue = [];
  } else if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(value)) {
    resetValue = false;
  }
...
/* harmony default export */ var src_form = ({
  ...
  render: function render(h) {
    ...
    if (v_x_e_table._loading && isLoading) {
  ...
  methods: {
    ...
    resetEvent: function resetEvent(evnt) {
      ...
      if (data) {
        this.$children.forEach(function (_ref2) {
          ...
          if (field) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(data, field, resetValue === null ? getResetValue(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(data, field), resetValue) : resetValue);
          }
        });
      }
    ...
    clearValidate: function clearValidate(field) {
      if (field) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.remove(this.invalids, function (_ref3) {
...
function renderSuffixIcon(h, titleSuffix) {
  return h('span', {
    ...
    class: titleSuffix.icon || conf.icon.formSuffix
  })]);
}
...
function getLabelData($xetable, opts, columns, datas) {
  ...
  if (treeConfig) {
    // 如果是树表格只允许导出数据源
    var rest = [];
    external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(datas, function (row, rowIndex, items, path, parent, nodes) {
      var item = {
      ...
      columns.forEach(function (column, columnIndex) {
        ...
        item[column.id] = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toString(cellValue);
      });
...
function getFooterCellValue($xetable, opts, items, column) {
  ...
  var cellValue = exportMethod ? exportMethod({
    ...
    itemIndex: itemIndex,
    column: column
  }) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toString(items[itemIndex]);
  return cellValue;
}
...
function export_hasEllipsis($xetable, column, property, allColumnOverflow) {
...
function toHtml($xetable, opts, columns, datas) {
  ...
  if (opts.isHeader) {
    html += "<thead><tr>".concat(columns.map(function (column) {
      ...
      var classNames = export_hasEllipsis($xetable, column, 'showHeaderOverflow', allColumnHeaderOverflow) ? ['col--ellipsis'] : [];
    ...
    if (treeConfig) {
      datas.forEach(function (row) {
        html += '<tr>' + columns.map(function (column) {
          ...
          var classNames = export_hasEllipsis($xetable, column, 'showOverflow', allColumnOverflow) ? ['col--ellipsis'] : [];
...
/* harmony default export */ var export_panel = ({
  ...
  render: function render(h) {
    ...
    }, h('tbody', [[h('tr', [h('td', conf.i18n('vxe.toolbar.expName')), h('td', [h('input', {
      ref: 'filename',
      attrs: {
        type: 'text',
    ...
    getExportOption: function getExportOption() {
      ...
      if (storeData.mode === 'selected') {
        if (['html', 'pdf'].indexOf(defaultOptions.type) > -1 && comp.treeConfig) {
          opts.data = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.searchTree(comp.getTableData().fullData, function (item) {
...
/* harmony default export */ var import_panel = ({
  ...
  render: function render(h) {
    ...
    }, [h('tbody', [[h('tr', [h('td', conf.i18n('vxe.toolbar.impFile')), h('td', [hasFile ? h('div', {
    ...
    }, conf.i18n('vxe.toolbar.impSelect'))])]), h('tr', [h('td', conf.i18n('vxe.toolbar.impType')), h('td', parseTypeLabel)]), h('tr', [h('td', conf.i18n('vxe.toolbar.impOpts')), h('td', [h('vxe-radio-group', {
      model: {
...
var components = [packages_table, packages_column, packages_header, packages_footer, packages_filter, packages_loading, packages_grid, packages_excel, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_button, packages_modal, packages_tooltip, packages_form, packages_export, packages_resize]; // 默认安装

...
var UtilTools = {
  ...
  getLog: function getLog(message, params) {
    return "[vxe-table] ".concat(ctor_amd_xe_utils_default.a.template(conf.i18n(message), params));
  },
...
Object.defineProperty(VXETable, 'importTypes', {
  get: function get() {
    var rest = [];
    ctor_amd_xe_utils_default.a.each(VXETable.types, function (flag, type) {
      if (flag) {
        rest.push(type);
      }
    });
              ...
              return Promise.resolve((beforeQuery || ajaxMethods).apply(this, applyArgs)).catch(function (e) {
                ...
                if (rest) {
                  if (pagerConfig) {
                    ...
                    _this6.tableData = ctor_amd_xe_utils_default.a.get(rest, props.result || props.data || 'result') || [];
                  } else {
...
/* harmony default export */ var pager = ({
    ...
    sizeList: function sizeList() {
      return this.pageSizes.map(function (item) {
        if (ctor_amd_xe_utils_default.a.isNumber(item)) {
          return {
            value: item,
            label: "".concat(ctor_amd_xe_utils_default.a.template(conf.i18n('vxe.pager.pagesize'), [item]))
          };
        }
  ...
  methods: {
    ...
    renderTotal: function renderTotal(h) {
      ...
      }, ctor_amd_xe_utils_default.a.template(conf.i18n('vxe.pager.total'), [this.total]));
    },
    // number
    ...
    selectDatePanelLabel: function selectDatePanelLabel() {
      if (this.isDatePicker) {
        ...
        if (datePanelType === 'month') {
          return ctor_amd_xe_utils_default.a.template(conf.i18n('vxe.input.date.monthLabel'), [year]);
        } else if (datePanelType === 'year') {
          return yearList.length ? "".concat(yearList[0].year, " - ").concat(yearList[yearList.length - 1].year) : '';
        }

        return ctor_amd_xe_utils_default.a.template(conf.i18n('vxe.input.date.dayLabel'), [year, month ? conf.i18n("vxe.input.date.m".concat(month)) : '-']);
      }
...
function destroyItem(_vm) {
  ...
  var matchObj = ctor_amd_xe_utils_default.a.findTree($xeform.collectItem, function (option) {
...
function handleImport($xetable, content, opts) {
  ...
  if (status) {
    ...
    if (opts.message !== false) {
      v_x_e_table.modal.message({
        message: ctor_amd_xe_utils_default.a.template(conf.i18n('vxe.table.impSuccess'), [rows.length]),
        status: 'success'
      });
    }
...
/* harmony default export */ var export_src_mixin = ({
  methods: {
    ...
    _exportData: function _exportData(options) {
      ...
      if (!opts.filename) {
        opts.filename = ctor_amd_xe_utils_default.a.template(conf.i18n(opts.original ? 'vxe.table.expOriginFilename' : 'vxe.table.expFilename'), [ctor_amd_xe_utils_default.a.toDateString(Date.now(), 'yyyyMMddHHmmss')]);
      }
      ...
      fileInput.onchange = function (evnt) {
        ...
        if (types.indexOf(type) > -1) {
          ...
          if (options.message !== false) {
            v_x_e_table.modal.message({
              message: ctor_amd_xe_utils_default.a.template(conf.i18n('vxe.error.notType'), [type]),
              status: 'error'
            });
          }
...
v_x_e_table.setup({
  i18n: function i18n(key) {
    return ctor_amd_xe_utils_default.a.get(zh_CN, key);
  }
});

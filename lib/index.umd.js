...
var renderer_renderMap = {
  ...
  cell: {
    ...
    renderCell: function renderCell(h, editRender, params) {
      ...
      return [h('span', {
        domProps: {
          innerHTML: utils.formatText(utils.getCellValue(row, column.property)).replace(/\n/g, '<br>')
        }
      })];
    }
  }
      ...
      if (config) {
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            var _this$getEventTargetN = this.getEventTargetNode(evnt, this.$el, 'vxe-body--column'),

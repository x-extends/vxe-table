    ...
    cacheDataMap: function cacheDataMap() {
      ...
      if (treeConfig) {
        ...
        tableFullData.forEach(function (row, rowIndex) {
          fullDataRowIdMap.set(UtilTools.getRowPrimaryKey(_this4, row, rowIndex), {
            row: row,
            index: rowIndex
          });
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (scrollYLoad) {
              ...
              var rowIndex = _this25.getRowMapIndex(row);
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    row: row,
                    column: column,
                    rowIndex: _this26.getRowMapIndex(row),
  ...
  render: function render(h) {
    ...
    h('thead', {
      ...
      return h('tr', {
         ...
         */
        !fixedType && !isColGroup && (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(column.resizable) ? column.resizable : resizable) ? h('div', {
          class: ['vxe-resizable', {
            'is--line': !border
          }],
          on: {

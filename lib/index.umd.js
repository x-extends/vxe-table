...
function () {
  ...
  _createClass(ColumnConfig, [{
    ...
    value: function getTitle() {
      ...
      return UtilTools.getFuncText(this.own.title || this.own.label || (this.type === 'seq' || this.type === 'index' ? conf.i18n('vxe.column.seqTitle') : ''));
    }
  }, {
    key: "update",
...
/* harmony default export */ var export_panel = ({
  ...
  render: function render(h) {
    ...
    return h('vxe-modal', {
      ...
      }, UtilTools.getFuncText(own.title || own.label || (type === 'seq' || type === 'index' ? conf.i18n('vxe.column.seqTitle') : '')));

...
/* harmony default export */ var table = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-table', vSize ? "size--".concat(vSize) : '', border && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(border) ? "b--style-".concat(border) : '', {
...
function export_hasEllipsis($table, column, property, allColumnOverflow) {
  ...
  var showTitle = headOverflow === 'title';
  var showTooltip = headOverflow === true || headOverflow === 'tooltip';
  var hasEllipsis = showTitle || showTooltip || showEllipsis; // 虚拟滚动不支持动态高度

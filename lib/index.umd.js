...
/* harmony default export */ var pagination = ({
  ...
  methods: {
    ...
    sizeChangeEvent: function sizeChangeEvent(evnt) {
      var pageSize = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toNumber(evnt.target.value);
...
var components = [components_table, table_column, components_grid, components_excel, components_pagination, components_checkbox, components_radio];

...
function renderColumn(h, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  var tdClss = ['vxe-body--column'];
  var cellClss = ['vxe-cell'];
  var tdOns = {};
...
function renderFixed(h, $table, fixedType) {
  ...
  console.log(111);
  return h('div', {
    class: ["vxe-table--fixed-".concat(fixedType, "-wrapper"), 'scrolling--none'],
    style: style,
    ref: "fixedTable"
  }, [h('table-header', {
    props: {
...
/* harmony default export */ var tablevue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-table', size ? "t--size-".concat(size) : '', {
        't--stripe': stripe,
        't--border': border,

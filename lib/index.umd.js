  ...
  methods: {
    ...
    setActiveCell: function setActiveCell(row, prop) {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          var tableData = _this14.tableData,
              visibleColumn = _this14.visibleColumn,
              handleActived = _this14.handleActived;
          ...
          if (row && prop) {
            ...
            if (rowIndex > -1) {
              ...
              var cell = DomTools.getCell(_this14, {
                row: row,
                rowIndex: rowIndex,
                column: column
              });
              ...
              _this14.lastCallTime = Date.now();
            }
          }

          resolve(_this14.$nextTick());
        });
      });
    },
    ...
    openValidTooltip: function openValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        UtilTools.emitEvent(_this21, 'valid-error', [params]);
      });
    },

...
// CONCATENATED MODULE: ./src/components/pager/src/pager.js
...
/* harmony default export */ var pager = ({
  ...
  methods: {
    ...
    handleGlobalMousedownEvent: function handleGlobalMousedownEvent(evnt) {
      if (this.showSizes && !(dom.getEventTargetNode(evnt, this.$refs.sizeBtn).flag || dom.getEventTargetNode(evnt, this.$refs.sizePanel).flag)) {
        this.hideSizePanel();
      }
    },
...
var components = [components_table, table_column, table_toolbar, components_grid, components_excel, components_pager, components_checkbox, components_radio, components_input, components_button, components_alert, components_tooltip];

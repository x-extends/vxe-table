...
function renderRows(h, _vm, $table, rowLevel, fixedType, tableData, tableColumn) {
  ...
  tableData.forEach(function (row, rowIndex) {
    ...
    rows.push(h('tr', {
      ...
      attrs: {
        'data-rowkey': utils.getRowId($table, row, rowIndex)
      },
  ...
  methods: {
    ...
    triggerRowExpandEvent: function triggerRowExpandEvent(evnt, _ref7) {
      ...
      utils.emitEvent(this, 'toggle-expand-change', [{
        row: row,
        rowIndex: this.fullDataKeyMap.get(row),
        $table: this
      }, evnt]);
      return rest;
    },
...
/* harmony default export */ var src_toolbar = ({
  ...
  computed: {
    ...
    btnConfig: function btnConfig() {
      ...
      return buttons.map(function (code) {
        return assign_default()({}, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(code) ? btnList.find(function (item) {
...
/* harmony default export */ var grid = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      props: assign_default()({}, tableProps, proxyConfig ? {
          ...
          case 'delete':
            if (ajax.delete) {
              return this.validate().then(function () {
                var body = {
                  removeRecords: _this2.getSelectRecords()
                };

...
/* harmony default export */ var table = ({
  ...
  methods: {
     ...
     * 多选，行选中事件
     */
    checkRowEvent: function checkRowEvent(evnt, _ref) {
      var row = _ref.row,
          column = _ref.column;
     ...
     * 多选，选中所有事件
     */
    checkAllEvent: function checkAllEvent(evnt) {
      var value = event.target.checked;
...
// CONCATENATED MODULE: ./src/table/column.js
...
/* harmony default export */ var table_column = ({
  ...
  created: function created() {
    ...
    this.columnConfig = handle.getColumnConfig(this, opts);
  },
  mounted: function mounted() {
  ...
  methods: {
      ...
      if (!isHidden) {
        ...
        options.on = {
          change: function change(evnt) {
            ...
            handle.emitEvent(_this2, 'change', [$table.selection, row]);
          }
        };
      }
      ...
      return [h('span', column.label), h('span', {
        ...
        on: {
          click: function click(evnt) {
            _this3.handleSortEvent(evnt, column, params, 'asc');
          }
        }
      }), h('i', {
        ...
        on: {
          click: function click(evnt) {
            _this3.handleSortEvent(evnt, column, params, 'desc');
          }
        }
      })])];
    },
    handleSortEvent: function handleSortEvent(evnt, column, params, order) {
    ...
    renderFilterHeader: function renderFilterHeader(h, params) {
      ...
      return [h('span', column.label), h('span', {
        ...
        on: {
          click: function click(evnt) {
            _this4.handleFilterEvent(evnt, column, params);
          }
        }
      })])];
    },
    handleFilterEvent: function handleFilterEvent(evnt, column, params) {}
  }
});
...
var components = [table, table_column];

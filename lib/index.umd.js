...
function renderFixed(h, $table, fixedType) {
  ...
  if (height) {
    customHeight = height === 'auto' ? containerHeight : DomTools.isScale(height) ? Math.floor(parseInt(height) / 100 * containerHeight) : external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toNumber(height);
  ...
  methods: {
          ...
          if (value === -1) {
            ...
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree([row], function (item, $rowIndex) {
              if (row === item || !checkMethod || checkMethod({
                ...
                _this27.handleSelectReserveRow(row, value);
              }
            }, treeConfig);
        ...
        if (reserve) {
          if (value) {
            selectRows.forEach(function (row) {
              selectReserveRowMap[UtilTools.getRowid(_this28, row)] = row;
            });
          } else {
            tableFullData.forEach(function (row) {
              var rowid = UtilTools.getRowid(_this28, row);
              ...
              if (editConfig.mode === 'row') {
                this.triggerValidate('blur').catch(function (e) {
                  ...
                  _this29.handleActived(params, evnt).then(function () {
                    return _this29.triggerValidate('change');
                  }).catch(function (e) {
                    return e;
                  });
                });
            ...
            if (editConfig.mode === 'row') {
              this.triggerValidate('blur').catch(function (e) {
                ...
                _this30.handleActived(params, evnt).then(function () {
                  return _this30.triggerValidate('change');
                }).catch(function (e) {
                  return e;
                });
              });
        ...
        if (editConfig.mode === 'row' ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this31.handleFocus(params, evnt);
            });
          }
      ...
      var selectMethod = function selectMethod() {
        if ((mouseConfig.selected || mouseConfig.checked) && (selected.row !== row || selected.column !== column)) {
          if (actived.row !== row || (editConfig.mode === 'cell' ? actived.column !== column : false)) {
            _this32.clearChecked(evnt);

            _this32.clearActived(evnt);
            ...
            if (mouseConfig.checked) {
              ...
              _this32.handleChecked(select, select, evnt);
            }
          }
        }
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find(_this33.visibleColumn, function (column) {
            return column.property === field;
          });

          if (column && column.editRender) {
            var cell = DomTools.getCell(_this33, {
              row: row,
              column: column
            });

            if (cell) {
              _this33.handleActived({
                row: row,
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var vSize = _this36.vSize,
            ...
            optimizeOpts = _this36.optimizeOpts,
      ...
      if (treeConfig) {
        ...
        if (matchObj) {
          ...
          nodes.forEach(function (row, index) {
            if (index < nodes.length - 1 && !_this38.hasTreeExpand(row)) {
              _this38.setTreeExpansion(row, true);
            }
          });
        }
      }
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this42.validCellRules('all', row, column).then(resolve).catch(function (_ref9) {
                  var rule = _ref9.rule,
                      rules = _ref9.rules;
                  var rest = {
                    rule: rule,
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = DomTools.getCell(_this42, params);

              _this42.handleValidError(params);
            ...
            DomTools.toView(_this42.$el);

            if (_this42.validOpts.autoPos === false) {
              finish();
            } else {
              if (treeConfig) {
                _this42.scrollToTreeRow(locatRow).then(posAndFinish);
              } else {
                _this42.scrollToRow(locatRow).then(posAndFinish);
              }
            }
          });
        });
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    row: row,
                    column: column,
                    rowIndex: _this43.getRowIndex(row),
                    columnIndex: _this43.getColumnMapIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
    ...
    handleValidError: function handleValidError(params) {
      ...
      if (this.validOpts.autoPos === false) {
        ...
        this.handleActived(params, {
          ...
          return _this44.showValidTooltip(params);
        });
      }
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this45.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this45, 'valid-error', [params]);
      });
    },
        ...
        if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.includes(types, type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this46, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      var rest = new Promise(function (resolve, reject) {
        _this47._importResolve = resolve;
        _this47._importReject = reject;
      });
      this.readFile(opts).then(function (evnt) {
        return _this47.importByFile(evnt.target.files[0], opts);
      }).catch(function (evnt) {
        _this47._importReject(evnt);

        _this47._importReject = null;
      });
      return rest;
    },
    readFile: function readFile() {
      ...
      fileInput.onchange = function (evnt) {
        ...
        if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.includes(types, type)) {
          _this48._fileResolve(evnt);
        } else {
          if (options.message !== false) {
            _this48.$XModal.message({
          ...
          _this48._fileReject(evnt);
        }

        _this48._fileResolve = null;
      };

      fileForm.reset();
      fileInput.click();
      return new Promise(function (resolve, reject) {
        _this48._fileResolve = resolve;
        _this48._fileReject = reject;
      });
    },
...
/* harmony default export */ var src_toolbar = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: conf.icon["refresh".concat(this.isRefresh ? 'Loading' : '')]
      ...
      class: conf.icon["zoom".concat(this.$grid.isMaximized() ? 'Out' : 'In')]
    })]) : null, setting ? h('div', {

...
function renderColumn(h, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  return h('td', {
    class: ['vxe-body--column', column.id, (_ref = {}, _defineProperty(_ref, "col--".concat(align), align), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _ref), cellClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(cellClassName) ? cellClassName({
      row: row,
      rowIndex: rowIndex,
      column: column,
      columnIndex: columnIndex
...
/* harmony default export */ var header = ({
  ...
  methods: {
    resizeMousedown: function resizeMousedown(evnt, column) {
      ...
      var pos = tools.getOffsetPos(targetElem, $el);
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    triggerCheckRowEvent: function triggerCheckRowEvent(evnt, value, _ref) {
      ...
      tools.emitEvent(this, 'select-change', [{
        row: row,
        column: column,
        selection: selection,
        checked: value
    ...
    triggerCheckAllEvent: function triggerCheckAllEvent(evnt, value) {
      ...
      this.isIndeterminate = false;
      tools.emitEvent(this, 'select-all', [{
        selection: this.selection,
        checked: value
      }, evnt]);
    },
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.column === column && filterStore.visible) {
        ...
        var _Tools$getOffsetPos = tools.getOffsetPos(evnt.target),
            top = _Tools$getOffsetPos.top,
            left = _Tools$getOffsetPos.left;

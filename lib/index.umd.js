...
var preClss = ['c--resize', 'c--checked', 'row--new', 'row--hover', 'row--current', 'col--group', 'col--current', 'col--checked', 'col--copyed', 'col--selected', 'col--index-checked', 'col--title-checked', 'fixed--hidden', 'scrolling--middle'];

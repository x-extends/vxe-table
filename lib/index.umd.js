...
/* harmony default export */ var src_alert = ({
  ...
  render: function render(h) {
    ...
    var vSize = this.vSize,
        ...
        mask = this.mask;
    return h('div', {
      class: ['vxe-alert--wrapper', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, 'lock--view', lockView), _defineProperty(_ref, 'is--mask', mask), _defineProperty(_ref, "active", visible), _ref)],
      on: {

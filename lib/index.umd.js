...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      var selectMethod = function selectMethod() {
        ...
        if (mouseConfig.checked) {
          ...
          _this16.handleChecked(select, select, evnt);
        }
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        var tableBody = _this18.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this18.$refs.tableFooter;
    ...
    updateStatus: function updateStatus(scope, cellValue) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this19.$refs,
            tableData = _this19.tableData,
            editRules = _this19.editRules,
            validStore = _this19.validStore;
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this19.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = DomTools.getCell(_this19, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
            ...
            if (cell) {
              return _this19.validCellRules(type, row, column, cellValue).then(function () {
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this21.validCellRules('all', row, column).then(resolve).catch(function (_ref10) {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = DomTools.getCell(_this21, params);

              _this21.handleValidError(params);
            ...
            if (scrollYLoad) {
              ...
              var rowIndex = _this21.getRowMapIndex(params.row);

              if (rowIndex < startIndex || rowIndex > startIndex + renderSize) {
                var bodyElem = _this21.$refs.tableBody.$el;
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    row: row,
                    column: column,
                    rowIndex: _this22.getRowMapIndex(row),
                    columnIndex: _this22.getColumnMapIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this23.showValidTooltip(params);
      });
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      var rule = params.rule,
          ...
          cell = params.cell;
      this.$nextTick(function () {
        Object.assign(_this24.validStore, {
          row: row,
          column: column,
          rule: rule,
        ...
        UtilTools.emitEvent(_this24, 'valid-error', [params]);
      });
    },

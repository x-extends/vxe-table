    ...
    setAllCheckboxRow: function setAllCheckboxRow(value) {
      ...
      if (!checkStrictly) {
        if (property) {
          ...
          if (treeConfig) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, value ? setValFn : clearValFn, treeOpts);
          } else {

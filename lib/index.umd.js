...
/* harmony default export */ var table = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-table', this.vSize ? "size--".concat(this.vSize) : '', border && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(border) ? "b--style-".concat(border) : '', {
  ...
  methods: {
    ...
    appendTreeCache: function appendTreeCache(childs) {
      var _this11 = this;
      ...
      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(childs, function (row, index) {
        ...
        if (row[treeOpts.hasChild] && external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isUndefined(row[treeOpts.children])) {
          row[treeOpts.children] = null;
        }
    ...
    */
    ...
    triggerCellClickEvent: function triggerCellClickEvent(evnt, params) {
      ...
      var $el = this.$el,
          ...
          checkboxOpts = this.checkboxOpts;
      var actived = editStore.actived;
      var column = params.column; // 解决 checkbox 重复触发两次问题
     ...
     * @param {Row} row 行对象
     */
    isExpandLoadedByRow: function isExpandLoadedByRow(row) {
    ...
    setRowExpansion: function setRowExpansion(rows, expanded) {
      ...
      var fullAllDataRowMap = this.fullAllDataRowMap,
          ...
          expandOpts = this.expandOpts;
      var lazy = expandOpts.lazy,
          loadMethod = expandOpts.loadMethod,
    ...
    clearRowExpand: function clearRowExpand() {
      ...
      this.rowExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this40.recalculate() : 0;
      });
    },
     ...
     * @param {Row} row 行对象
     */
    isTreeLoadedByRow: function isTreeLoadedByRow(row) {
      var rest = this.fullAllDataRowMap.get(row);
      ...
      if (expanded) {
        if (lazy) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, function (row) {
            _this41.setTreeExpansion(row, true);
          }, treeOpts);
        } else {
          var treeExpandeds = [];
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, function (row) {
                  ...
                  result.push(new Promise(function (resolve) {
                    ...
                    loadMethod({
                      ...
                      if (childs) {
                        ...
                        _this42.appendTreeCache(childs);
                        ...
                        if (_this42.isCheckedByRow(row)) {
                          _this42.setSelection(childs, true);
                        }
                      }
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var vSize = _this44.vSize,
            scrollXLoad = _this44.scrollXLoad,
            scrollYLoad = _this44.scrollYLoad,
            scrollYStore = _this44.scrollYStore,
            scrollXStore = _this44.scrollXStore,
            visibleColumn = _this44.visibleColumn,
            optimizeOpts = _this44.optimizeOpts,
            rowHeightMaps = _this44.rowHeightMaps;
        var scrollX = optimizeOpts.scrollX,
            scrollY = optimizeOpts.scrollY;
        var tableBody = _this44.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableHeader = _this44.$refs.tableHeader;
        ...
        if (tableBodyElem) {
          ...
          if (scrollXLoad) {
            ...
            _this44.updateScrollXData();
          } else {
            _this44.updateScrollXSpace();
          } // 计算 Y 逻辑
          ...
          if (scrollYLoad) {
            ...
            _this44.updateScrollYData();
          } else {
            _this44.updateScrollYSpace();
          }
        }

        return _this44.$nextTick();
      });
    },
      ...
      if (this.scrollXLoad || this.scrollYLoad) {
        return new Promise(function (resolve) {
          return setTimeout(function () {
            return resolve(_this45.$nextTick());
          }, 50);
        });
      }
      ...
      if (treeConfig) {
        ...
        if (matchObj) {
          ...
          nodes.forEach(function (row, index) {
            if (index < nodes.length - 1 && !_this46.hasTreeExpand(row)) {
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this48.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = DomTools.getCell(_this48, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this50.validCellRules('all', row, column).then(resolve).catch(function (_ref7) {
                  var rule = _ref7.rule,
                      rules = _ref7.rules;
                  var rest = {
                    rule: rule,
                    rules: rules,
                    rowIndex: _this50.getRowIndex(row),
                    row: row,
                    columnIndex: columnIndex,
                    column: column,
                    $table: _this50
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = DomTools.getCell(_this50, params);

              _this50.handleValidError(params);
            ...
            DomTools.toView(_this50.$el);

            if (_this50.validOpts.autoPos === false) {
              finish();
            } else {
              if (treeConfig) {
                _this50.scrollToTreeRow(locatRow).then(posAndFinish);
              } else {
                _this50.scrollToRow(locatRow).then(posAndFinish);
              }
            }
          });
        });
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    row: row,
                    column: column,
                    rowIndex: _this51.getRowIndex(row),
                    columnIndex: _this51.getColumnMapIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
    ...
    handleValidError: function handleValidError(params) {
      ...
      if (this.validOpts.autoPos === false) {
        ...
        this.handleActived(params, {
          ...
          return _this52.showValidTooltip(params);
        });
      }
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this53.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this53, 'valid-error', [params]);
      });
    },
        ...
        if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.includes(types, type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this54, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      var rest = new Promise(function (resolve, reject) {
        _this55._importResolve = resolve;
        _this55._importReject = reject;
      });
      this.readFile(opts).then(function (evnt) {
        return _this55.importByFile(evnt.target.files[0], opts);
      }).catch(function (evnt) {
        _this55._importReject(evnt);

        _this55._importReject = null;
      });
      return rest;
    },
    readFile: function readFile() {
      ...
      fileInput.onchange = function (evnt) {
        ...
        if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.includes(types, type)) {
          _this56._fileResolve(evnt);
        } else {
          if (options.message !== false) {
            _this56.$XModal.message({
          ...
          _this56._fileReject(evnt);
        }

        _this56._fileResolve = null;
      };

      fileForm.reset();
      fileInput.click();
      return new Promise(function (resolve, reject) {
        _this56._fileResolve = resolve;
        _this56._fileReject = reject;
      });
    },
    ...
    h('thead', headerColumn.map(function (cols, $rowIndex) {
      return h('tr', {
        ...
        return h('th', {
          ...
          style: {
            width: hasEllipsis ? "".concat(border ? renderWidth - 2 : renderWidth, "px") : null
          }
  ...
  methods: {
    renderOptions: function renderOptions(h) {
      ...
      var filterRens = [h('li', {
        ...
        attrs: {
          title: conf.i18n('vxe.table.allFilter')
        }
      }, [h('input', {
        attrs: {
          type: 'checkbox'
  ...
  methods: _objectSpread({}, methods, {
    ...
    sortChangeEvent: function sortChangeEvent(params) {
      var proxyConfig = this.proxyConfig,
          ...
          sortOpts = this.sortOpts;
      var column = params.column;
      var isRemote = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(column.remoteSort) ? column.remoteSort : sortOpts.remote || remoteSort; // 如果是服务端排序

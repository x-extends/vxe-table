...
function () {
  function ColumnConfig($table, _vm) {
    ...
    Object.assign(this, {
      // 基本属性
      id: "xecol_".concat(++columnUniqueId),
      type: _vm.type,
      // 在 v3.0 中废弃 prop
      prop: _vm.prop,
...
function getRowUniqueId() {
  return "xerow_".concat(++rowUniqueId);
}
  ...
  methods: {
    ...
    saveColumnHide: function saveColumnHide() {
      ...
      if (storage) {
        ...
        localStorage.setItem(storageKey, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toJSONString(columnHideStorageMap));
      }

...
/* harmony default export */ var table = ({
  ...
  methods: {
     ...
     */
    handleSelectRow: function handleSelectRow(evnt, _ref5, value) {
      var row = _ref5.row;
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (scrollYLoad) {
              ...
              var rowIndex = _this23.getRowIndex(params.row);
  ...
  methods: {
    ...
    saveColumnWidth: function saveColumnWidth() {
      ...
      if (resizableOpts.storage) {
        ...
        var columnWidthStorage = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isPlainObject(columnWidthStorageMap[id]) ? columnWidthStorageMap[id] : {};

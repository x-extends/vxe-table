...
var Cell = {
  createColumn: function createColumn($table, _vm) {
    ...
    var isTreeNode = treeConfig && treeNode; // 在 v3.0 中废弃 selectConfig
  ...
  renderSelectionHeader: function renderSelectionHeader(h, params) {
    ...
    var $table = params.$table,
        ...
        isAllCheckboxDisabled = params.isAllCheckboxDisabled;
    var vSize = $table.vSize;
    var slots = column.slots,
        own = column.own;
...
function getFileTypes(options) {
  return options.types || Object.keys(v_x_e_table.types);
}
  ...
  methods: {
    ...
    refreshData: function refreshData() {
      ...
      return this.$nextTick().then(function () {
        ...
        return _this3.$nextTick().then(function () {
          return _this3.loadTableData(_this3.tableFullData);
        });
      });
    },
    ...
    loadTableData: function loadTableData(datas, notRefresh) {
      ...
      return rest.then(function () {
        // 是否加载了数据
        _this4.isLoadData = true;

        _this4.handleTableData(true);

        _this4.reserveCheckSelection();

        _this4.checkSelectionStatus();

        rest = _this4.$nextTick();

        if (!notRefresh) {
          rest = rest.then(_this4.recalculate);
        }

        return rest.then(_this4.refreshScroll);
      });
    },
    ...
    reloadData: function reloadData(datas) {
      ...
      return this.clearAll().then(function () {
        return _this5.loadTableData(datas);
    ...
    loadColumn: function loadColumn(columns) {
      ...
      this.collectColumn = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.mapTree(columns, function (column) {
        return packages_cell.createColumn(_this6, column);
      }, headerProps);
      return this.$nextTick();
    },
    ...
    updateCache: function updateCache(source) {
      ...
      var handleCache = function handleCache(row, index) {
        var rowid = UtilTools.getRowid(_this7, row);
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableFullData, function (row) {
            return UtilTools.getRowid(_this8, row) === rowid;
          }, treeConfig);
    ...
    createData: function createData(records) {
      ...
      return this.$nextTick().then(function () {
        return records.map(_this10.defineField);
      });
    },
    ...
    reloadCustoms: function reloadCustoms(customColumns) {
      ...
      return this.$nextTick().then(function () {
        _this15.mergeCustomColumn(customColumns);

        return _this15.refreshColumn().then(function () {
          return _this15.tableFullColumn;
        });
      });
    },
    ...
    refreshScroll: function refreshScroll() {
      ...
      return this.$nextTick().then(function () {
        if (lastScrollLeft || lastScrollTop) {
          // 重置最后滚动状态
          _this17.lastScrollLeft = 0;
          _this17.lastScrollTop = 0; // 还原滚动状态

          return _this17.scrollTo(lastScrollLeft, lastScrollTop);
        }
      });
    },
      ...
      if (bodyElem) {
        ...
        if (refull === true) {
          ...
          return this.computeScrollLoad().then(function () {
            ...
            _this18.autoCellWidth(headerElem, bodyElem, footerElem, bodyWidth); // }


            _this18.computeScrollLoad();
          });
        }
      }
    ...
    preventEvent: function preventEvent(evnt, type, args, next, end) {
      ...
      if (!evntList.some(function (func) {
        return func(args, evnt, _this19) === false;
      })) {
        if (next) {
          rest = next();
        }
        ...
        if (!(editConfig.autoClear === false)) {
          if (validTip && getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clearActived', actived.args, function () {
              ...
              !getEventTargetNode(evnt, _this20.$el).flag) {
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (this.isActivated) {
        this.preventEvent(evnt, 'event.keydown', {
          ...
          var params;
          var isCtxMenu = _this21.isCtxMenu,
              ctxMenuStore = _this21.ctxMenuStore,
              editStore = _this21.editStore,
              _this21$mouseConfig = _this21.mouseConfig,
              mouseConfig = _this21$mouseConfig === void 0 ? {} : _this21$mouseConfig,
              _this21$keyboardConfi = _this21.keyboardConfig,
              keyboardConfig = _this21$keyboardConfi === void 0 ? {} : _this21$keyboardConfi,
          ...
          if (isEsc) {
            ...
            if (actived.row) {
              ...
              if (mouseConfig.selected) {
                _this21.handleSelected(params, evnt);
              }
            }
            ...
            if (selected.column.type === 'checkbox' || selected.column.type === 'selection') {
              _this21.handleToggleCheckRowEvent(selected.args, evnt);
            } else {
            ...
            if (selected.row || actived.row) {
              _this21.moveSelected(selected.row ? selected.args : actived.args, isLeftArrow, isUpArrow, isRightArrow, true, evnt);
              ...
              if (childrens && childrens.length) {
                ...
                _this21.setTreeExpansion(currentRow, true).then(function () {
            ...
            // 如果按下了 Tab 键切换
            if (selected.row || selected.column) {
              _this21.moveTabSelected(selected.args, isShiftKey, evnt);
            } else if (actived.row || actived.column) {
              _this21.moveTabSelected(actived.args, isShiftKey, evnt);
            }
            ...
            if (keyboardConfig.isDel && (selected.row || selected.column)) {
              ...
              // 如果树形表格回退键关闭当前行返回父节点
              var _XEUtils$findTree = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(_this21.afterFullData, function (item) {
              ...
              if (parentRow) {
                ...
                _this21.setTreeExpansion(parentRow, false).then(function () {
            ...
            // 如果开启复制功能
            if (isX || isC) {
              _this21.handleCopyed(isX, evnt);
            } else {
              _this21.handlePaste(evnt);
            }
          ...
          this.preventEvent(evnt, 'event.showMenu', params, null, function () {
            if (!visibleMethod || visibleMethod(params, evnt)) {
              ...
              _this23.$nextTick(function () {
                var ctxElem = _this23.$refs.ctxWrapper.$el;
    ...
    handleTooltipLeaveEvent: function handleTooltipLeaveEvent(evnt) {
      ...
      setTimeout(function () {
        if (!_this24.tooltipActive) {
          _this24.clostTooltip();
        }
    ...
    handleTargetLeaveEvent: function handleTargetLeaveEvent(evnt) {
      ...
      if (tooltipConfig.enterable) {
        this.tooltipTimeout = setTimeout(function () {
          if (!_this25.$refs.tooltip.isHover) {
            _this25.clostTooltip();
          }
        }, tooltipConfig.leaveDelay || conf.tooltip.leaveDelay);
      } else {
        this.clostTooltip();
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this26.handleSelectRow(null, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
              ...
              if (editConfig.mode === 'row') {
                this.triggerValidate('blur').catch(function (e) {
                  ...
                  _this27.handleActived(params, evnt).then(function () {
                    return _this27.triggerValidate('change');
                  }).catch(function (e) {
                    return e;
                  });
                });
            ...
            if (editConfig.mode === 'row') {
              this.triggerValidate('blur').catch(function (e) {
                ...
                _this28.handleActived(params, evnt).then(function () {
                  return _this28.triggerValidate('change');
                }).catch(function (e) {
                  return e;
                });
              });
        ...
        if (editConfig.mode === 'row' ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this29.handleFocus(params, evnt);
            });
          }
      ...
      var selectMethod = function selectMethod() {
        if ((mouseConfig.selected || mouseConfig.checked) && (selected.row !== row || selected.column !== column)) {
          if (actived.row !== row || (editConfig.mode === 'cell' ? actived.column !== column : false)) {
            _this30.clearChecked(evnt);

            _this30.clearActived(evnt);
            ...
            if (mouseConfig.checked) {
              ...
              _this30.handleChecked(select, select, evnt);
            }
          }
        }
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = _this31.visibleColumn.find(function (column) {
            return column.property === field;
          });
    ...
    clearTreeExpand: function clearTreeExpand() {
      ...
      this.treeExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this33.recalculate() : 0;
      });
    },
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var vSize = _this34.vSize,
            scrollXLoad = _this34.scrollXLoad,
            scrollYLoad = _this34.scrollYLoad,
            scrollYStore = _this34.scrollYStore,
            scrollXStore = _this34.scrollXStore,
            visibleColumn = _this34.visibleColumn,
            optimizeOpts = _this34.optimizeOpts,
            rowHeightMaps = _this34.rowHeightMaps;
        var scrollX = optimizeOpts.scrollX,
            scrollY = optimizeOpts.scrollY;
        var tableBody = _this34.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableHeader = _this34.$refs.tableHeader;
        ...
        if (tableBodyElem) {
          ...
          if (scrollXLoad) {
            ...
            _this34.updateScrollXData();
          } else {
            _this34.updateScrollXSpace();
          } // 计算 Y 逻辑
          ...
          if (scrollYLoad) {
            ...
            _this34.updateScrollYData();
          } else {
            _this34.updateScrollYSpace();
          }
        }

        return _this34.$nextTick();
      });
    },
      ...
      if (this.scrollXLoad || this.scrollYLoad) {
        return new Promise(function (resolve) {
          return setTimeout(function () {
            return resolve(_this35.$nextTick());
          }, 50);
        });
      }
      ...
      if (treeConfig) {
        ...
        if (matchObj) {
          ...
          nodes.forEach(function (row, index) {
            if (index < nodes.length - 1 && !_this36.hasTreeExpand(row)) {
              _this36.setTreeExpansion(row, true);
            }
          });
        }
      }
    ...
    updateStatus: function updateStatus(scope, cellValue) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this38.$refs,
            tableData = _this38.tableData,
            editRules = _this38.editRules,
            validStore = _this38.validStore;
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this38.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            ...
            if (cell) {
              return _this38.validCellRules(type, row, column, cellValue).then(function () {
                if (customVal && validStore.visible) {
                  UtilTools.setCellValue(row, column, cellValue);
                }

                _this38.clearValidate();
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this40.validCellRules('all', row, column).then(resolve).catch(function (_ref9) {
                  var rule = _ref9.rule,
                      rules = _ref9.rules;
                  var rest = {
                    rule: rule,
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = DomTools.getCell(_this40, params);

              _this40.handleValidError(params);
            ...
            DomTools.toView(_this40.$el);

            if (treeConfig) {
              _this40.scrollToTreeRow(locatRow).then(finish);
            } else {
              _this40.scrollToRow(locatRow).then(finish);
            }
          });
        });
      } else {
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    columnIndex: _this41.getColumnMapIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this42.showValidTooltip(params);
      });
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this43.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this43, 'valid-error', [params]);
      });
    },
        ...
        if (getFileTypes(options).includes(type)) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this44, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      var rest = new Promise(function (resolve, reject) {
        _this45._importResolve = resolve;
        _this45._importReject = reject;
      });
      this.readFile(opts).then(function (evnt) {
        return _this45.importByFile(evnt.target.files[0], opts);
      }).catch(function (evnt) {
        _this45._importReject(evnt);

        _this45._importReject = null;
      });
      return rest;
    },
    readFile: function readFile() {
      ...
      var types = getFileTypes(options);
      ...
      impInput.onchange = function (evnt) {
        ...
        if (types.includes(type)) {
          _this46._fileResolve(evnt);
        } else {
          if (options.message !== false) {
            _this46.$XModal.message({
          ...
          _this46._fileReject(evnt);
        }

        _this46._fileResolve = null;
      };

      impForm.reset();
      impInput.click();
      return new Promise(function (resolve, reject) {
        _this46._fileResolve = resolve;
        _this46._fileReject = reject;
      });
    },
    ...
    h('thead', headerColumn.map(function (cols, $rowIndex) {
      return h('tr', {
        ...
        return h('th', {
          ...
          style: headerCellStyle ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(headerCellStyle) ? headerCellStyle({
            $table: $table,
            $rowIndex: $rowIndex,
            column: column,
            columnIndex: columnIndex,
  ...
  methods: _objectSpread({}, methods, {
    ...
    commitProxy: function commitProxy(code) {
      ...
      if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(code)) {
        var matchObj = toolbar ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(toolbar.buttons, function (item) {
  ...
  methods: {
    ...
    openExport: function openExport(options) {
      ...
      var defOpts = Object.assign({
        original: true,
        message: true
      }, exportOpts, options); // 处理类型

      defOpts.types = defOpts.types.map(function (value) {
        return {
          value: value,
...
var defaultHtmlStyle = 'body{margin:0;font-size:14px}table{text-align:center;border-width:1px 0 0 1px}table,th,td{border-style:solid;border-color:#e8eaec}thead,tfoot{background-color:#f8f8f9}th,td{padding:6px 0;border-width:0 1px 1px 0}';
...
/* harmony default export */ var import_panel = ({
  ...
  computed: {
    ...
    parseTypeLabel: function parseTypeLabel() {
      ...
      return "*.".concat((this.defaultOptions.types || Object.keys(v_x_e_table.types)).join(', *.'));
    }
  },
  render: function render(h) {

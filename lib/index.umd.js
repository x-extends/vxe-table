...
/* harmony default export */ var table = ({
  ...
  methods: {
      ...
      if (actived.row) {
        if (!(editConfig.autoClear === false)) {
          ...
          if (!this.lastCallTime || this.lastCallTime + 50 < now_default()()) {
            if ( // 如果点击了非编辑列
            !this.getEventTargetNode(evnt, this.$el, 'col--edit').flag || // 如果点击了当前表格之外
            !this.getEventTargetNode(evnt, this.$el).flag) {
              this.triggerValidate().then(function () {
                _this4.clearActived(evnt);
              }).catch(function (e) {
                return e;
              });
            }
      ...
      if (config) {
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            this.$nextTick(function () {
              var ctxElem = _this5.$refs.ctxWrapper.$el;
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this7.triggerCheckRowEvent(null, {
          row: row,
          column: column
        }, !!value);
      });
     ...
     * 多选，行选中事件
     */
    triggerCheckRowEvent: function triggerCheckRowEvent(evnt, _ref2, value) {
      var row = _ref2.row,
          column = _ref2.column;
      ...
      if (editConfig) {
        if (editConfig.trigger === 'click') {
          if (!actived.args || evnt.currentTarget !== actived.args.cell) {
            this.triggerValidate().then(function () {
              _this8.handleActived(params, evnt);
            }).catch(function (e) {
              return e;
            });
          }
    ...
    handleActived: function handleActived(params, evnt) {
      ...
      if (actived.row !== row || actived.column !== column) {
        ...
        if (!activeMethod || activeMethod(params)) {
          ...
          this.$nextTick(function () {
            _this10.handleFocus(params, evnt);
          });
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      return this.triggerValidate().then(function () {
        if (selected.row !== row || selected.column !== column) {
          _this11.clearChecked(evnt);

          _this11.clearActived(evnt);
        ...
        if (mouseConfig.checked) {
          ...
          _this11.handleChecked(select, select, evnt);
        }
    ...
    validateRow: function validateRow(row, cb) {
      ...
      return new promise_default.a(function (resolve, reject) {
        _this13.validRowRules('all', row).then(function () {
          var valid = true;
          ...
          _this13.handleValidError(params);
      ...
      if (actived.row && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
        ...
        if (editConfig.mode === 'row') {
          return this.validRowRules(type, row).catch(function (params) {
            _this14.handleValidError(params);
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              validPromise = validPromise.then(function () {
                return new promise_default.a(function (resolve, reject) {
                  _this15.validCellRules('all', row, column).then(resolve).catch(function (rule) {
                    var rest = {
                      rule: rule,
                      rowIndex: rowIndex,
                      row: row,
      ...
      if (!external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
        this.getColumns().forEach(function (column, columnIndex) {
          if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
            validPromise = validPromise.then(function () {
              return new promise_default.a(function (resolve, reject) {
                _this16.validCellRules('all', row, column).then(resolve).catch(function (rule) {
                  var rest = {
                    rule: rule,
                    row: row,
                    column: column,
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        _this17.$nextTick().then(function () {
          ...
          if (validWrapperElem) {
            ...
            if (validWrapperElem.offsetWidth < cell.offsetWidth) {
              validStore.style.left = "".concat(left + Math.floor((cell.offsetWidth - validWrapperElem.offsetWidth) / 2) - 6, "px");
            }
        ...
        utils.emitEvent(_this17, 'valid-error', [params]);
      });
    },

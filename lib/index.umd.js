...
function renderColumn(h, _vm, $table, $seq, seq, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex) {
  ...
  }, column.renderCell(h, params)), // highlightCurrentColumn ? h('span', {
                ...
                return ajax.query(params).then(function (result) {
                  if (result) {
                    if (pagerConfig) {
                      ...
                      _this3.tableData = props.data ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(result, props.data) : result;
                    }
                  } else {
                    _this3.tableData = [];
                  }

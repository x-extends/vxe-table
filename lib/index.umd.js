...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          ...
          _this23.clearIndexChecked();

          _this23.clearHeaderChecked();

          _this23.clearSelected(evnt);
        ...
        if (mouseConfig.checked) {
          ...
          _this23.handleChecked([[cell]]);

          _this23.handleHeaderChecked([[headerElem.querySelector(".".concat(column.id))]]);

          _this23.handleIndexChecked([[cell.parentNode.querySelector('.col--index')]]);
        }
    ...
    triggerTreeExpandEvent: function triggerTreeExpandEvent(evnt, _ref7) {
      ...
      if (currentRow) {
        this.$nextTick(function () {
          return _this25.setCurrentRow(currentRow);
        });
      } else if (currentColumn) {
        this.$nextTick(function () {
          return _this25.setCurrentColumn(currentColumn);
        });
      }
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var scrollXLoad = _this28.scrollXLoad,
    ...
    updateScrollYSpace: function updateScrollYSpace() {
      ...
      var _this$getTableData2 = this.getTableData(),
          visibleData = _this$getTableData2.visibleData;

      var bodyHeight = visibleData.length * scrollYStore.rowHeight;
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this32.validCellRules('all', row, column).then(resolve).catch(function (_ref10) {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var finish = function finish() {
              params.cell = DomTools.getCell(_this32, params);
            ...
            if (scrollYLoad) {
              ...
              if (rowIndex < startIndex || rowIndex > startIndex + renderSize) {
                var bodyElem = _this32.$refs.tableBody.$el;
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        UtilTools.emitEvent(_this35, 'valid-error', [params]);
      });
    },
...
function renderColumn(h, _vm, $table, $seq, seq, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex) {
  ...
  }, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(validStore.content) ? validStore.content.call($table, h) : UtilTools.getFuncText(validStore.content))]) : _e() : null]);
}

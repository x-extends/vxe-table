...
var rClsMap = {};
var preClss = ['c--resize', 'c--checked', 'row--hover', 'row--current', 'col--current', 'col--selected', 'col--index-checked', 'col--title-checked', 'scrolling--middle'];
var preClsMap = {
...
/* harmony default export */ var src_body = ({
  ...
  render: function render(h) {
    ...
    var tableData = $table.tableData,
        tableColumn = $table.tableColumn,
        allColumnOverflow = $table.showOverflow,
        scrollXLoad = $table.scrollXLoad; // 如果是固定列与设置了超出隐藏

...
var browse = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.browse(); // const htmlElem = document.querySelector('html')
...
var DomTools = {
  ...
  getOffsetPos: function getOffsetPos(elem, container) {
    ...
    return {
      ...
      left: scrollLeft + bounding.left // return getNodeOffset(elem, container, { left: 0, top: 0 })
            ...
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              validPromise = validPromise.then(function () {
                return new Promise(function (resolve, reject) {
                  _this19.validCellRules('all', row, column).then(resolve).catch(function (_ref10) {
...
/* harmony default export */ var src_message = ({
  ...
  render: function render(h) {
    ...
    }, this.$slots.default || (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(message) ? message.call(this, h) : message))]), h('div', {
  ...
  methods: {
    ...
    toVisible: function toVisible(target) {
      ...
      if (target) {
        ...
        var _DomTools$getOffsetPo = DomTools.getOffsetPos(target),
            top = _DomTools$getOffsetPo.top,
            left = _DomTools$getOffsetPo.left;

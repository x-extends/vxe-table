...
/* harmony default export */ var grid = ({
  ...
  created: function created() {
    ...
    if (proxyOpts.index) {} // UtilTools.warn('vxe.error.delProp', ['proxy-config.index', 'proxy-config.seq'])
...
/* harmony default export */ var src_toolbar = ({
  ...
  created: function created() {
    ...
    if (setting) {// UtilTools.warn('vxe.error.delProp', ['setting', 'custom'])
    }
  ...
  render: function render(h) {
    ...
    var compConf = extraSlots ? v_x_e_table.renderer.get(extraSlots.name) : null;
    ...
    saveColumnHide: function saveColumnHide() {
      ...
      if (storage) {
        ...
        var colHides = tableFullColumn.filter(function (column) {
          return column.property && !column.visible && (!checkMethod || checkMethod({
            column: column
          }));
        });
...
/* concated harmony reexport commands */__webpack_require__.d(__webpack_exports__, "commands", function() { return commands; });
...
/* concated harmony reexport interceptorStore */__webpack_require__.d(__webpack_exports__, "interceptorStore", function() { return interceptorStore; });
/* concated harmony reexport renderStore */__webpack_require__.d(__webpack_exports__, "renderStore", function() { return renderStore; });

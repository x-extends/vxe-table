...
var DomTools = {
  ...
  getCell: function getCell($table, _ref) {
    var row = _ref.row,
        column = _ref.column;
    var rowPrimaryKey = utils.getRowPrimaryKey($table, row);
...
var Cell = {
  ...
  renderRadioHeader: function renderRadioHeader(h, params) {
    var own = params.column.own; // 在 v3.0 中废弃 label
  ...
  methods: {
    ...
    cacheDataMap: function cacheDataMap() {
      ...
      var handleData = function handleData(row, index) {
        var rowPrimaryKey = UtilTools.getRowPrimaryKey(_this4, row);
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableFullData, function (row) {
            return UtilTools.getRowPrimaryKey(_this5, row) === rowPrimaryKey;
          }, treeConfig);
    ...
    getColumnNode: function getColumnNode(th) {
      if (th) {
        ...
        if (isGroup) {
          ...
          var _fullColumnIdMap$get = fullColumnIdMap.get(colid),
              column = _fullColumnIdMap$get.column,
              index = _fullColumnIdMap$get.index;
    ...
    hasRowChange: function hasRowChange(row, field) {
      ...
      if (rowKey) {
        var rowPrimaryKey = UtilTools.getRowPrimaryKey(this, row);
        var treeConfig = this.treeConfig;
        ...
        if (treeConfig) {
          ...
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableSourceData, function (item) {
            return rowPrimaryKey === UtilTools.getRowPrimaryKey(_this9, item);
          }, treeConfig);
          ...
          var oRowIndex = this.fullDataRowIdMap.get(rowPrimaryKey).index;
    ...
    getColumnById: function getColumnById(colid) {
      var fullColumnIdMap = this.fullColumnIdMap;
    ...
    getRowById: function getRowById(rowid) {
      var fullDataRowIdMap = this.fullDataRowIdMap;
    ...
    refreshColumn: function refreshColumn() {
      ...
      return this.$nextTick().then(function () {
        return _this11.recalculate(true);
      });
    },
          ...
          if (colgroupElem) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(colgroupElem.children, function (colElem) {
              ...
              if (fullColumnIdMap.has(colid)) {
                var column = fullColumnIdMap.get(colid).column;
          ...
          if (validTip && this.getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clear_actived', actived.args, function () {
              ...
              !_this14.getEventTargetNode(evnt, $el).flag) {
                setTimeout(_this14.clearActived);
              }
            });
          }
        }
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            this.$nextTick(function () {
              var ctxElem = _this15.$refs.ctxWrapper.$el;
     ...
     * 触发表尾 tooltip 事件
     */
    triggerFooterTooltipEvent: function triggerFooterTooltipEvent(evnt, _ref4) {
    ...
    handleSelectionDefChecked: function handleSelectionDefChecked() {
      ...
      if (checkAll) {
        ...
        var defSelection = [];
        checkRowKeys.forEach(function (checkKey) {
          if (fullDataRowIdMap.has(checkKey)) {
            defSelection.push(fullDataRowIdMap.get(checkKey).row);
          }
        });
    ...
    handleRadioDefChecked: function handleRadioDefChecked() {
      ...
      if (checkRowKey && fullDataRowIdMap.has(checkRowKey)) {
    ...
    setCurrentRow: function setCurrentRow(row) {
      ...
      if (this.highlightCurrentRow) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(this.$el.querySelectorAll("[data-rowid=\"".concat(rowPrimaryKey, "\"]")), function (elem) {
    ...
    triggerHoverEvent: function triggerHoverEvent(evnt, _ref6) {
      ...
      var rowPrimaryKey = UtilTools.getRowPrimaryKey(this, row);
      this.clearHoverRow();
      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach($el.querySelectorAll("[data-rowid=\"".concat(rowPrimaryKey, "\"]")), function (elem) {
      ...
      if (editRender) {
        ...
        if (isRowMode ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this19.handleFocus(params, evnt);
            });
          }
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          _this20.clearChecked(evnt);

          _this20.clearIndexChecked();

          _this20.clearHeaderChecked();

          _this20.clearSelected();

          _this20.clearActived(evnt);
          ...
          if (mouseConfig.selected) {
            ...
            var rowPrimaryKey = UtilTools.getRowPrimaryKey(_this20, row);
        ...
        if (mouseConfig.checked) {
          ...
          _this20.handleChecked([[cell]]);

          _this20.handleHeaderChecked([[headerElem.querySelector(".".concat(column.id))]]);

          _this20.handleIndexChecked([[cell.parentNode.querySelector('.col--index')]]);
        }
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          var tableData = _this21.tableData,
              visibleColumn = _this21.visibleColumn,
              handleActived = _this21.handleActived;
          ...
          if (row && field) {
            ...
            if (rowIndex > -1) {
              ...
              _this21.lastCallTime = Date.now();
            }
          }

          resolve(_this21.$nextTick());
        });
      });
    },
    ...
    handleDefaultRowExpand: function handleDefaultRowExpand() {
      ...
      if (expandAll) {
        ...
        var defExpandeds = [];
        expandRowKeys.forEach(function (expandKey) {
          if (fullDataRowIdMap.has(expandKey)) {
            defExpandeds.push(fullDataRowIdMap.get(expandKey).row);
          }
        });
    ...
    triggerTreeExpandEvent: function triggerTreeExpandEvent(evnt, _ref8) {
      ...
      if (selectColumn) {
        this.$nextTick(function () {
          return _this22.setCurrentColumn(selectColumn);
        });
      }
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var scrollXLoad = _this25.scrollXLoad,
    ...
    scrollToRow: function scrollToRow(row) {
      ...
      if (scrollYLoad) {
        ...
        var bodyElem = elemStore['main-body-list'];
        DomTools.scrollIntoElem(bodyElem.querySelector("[data-rowid=\"".concat(rowPrimaryKey, "\"]")));
      }
    },
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        ...
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this26.$refs.tableFooter;
    ...
    updateStatus: function updateStatus(scope, cellValue) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this27.$refs,
            tableData = _this27.tableData,
            editRules = _this27.editRules,
            validStore = _this27.validStore;
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this27.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = DomTools.getCell(_this27, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
            ...
            if (cell) {
              return _this27.validCellRules(type, row, column, cellValue).then(function () {
                if (customVal && validStore.visible) {
                  UtilTools.setCellValue(row, column, cellValue);
                }

                _this27.clearValidate();
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this29.validCellRules('all', row, column).then(resolve).catch(function (_ref11) {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var finish = function finish() {
              params.cell = DomTools.getCell(_this29, params);

              _this29.handleValidError(params);
            ...
            if (scrollYLoad) {
              ...
              if (rowIndex < startIndex || rowIndex > startIndex + renderSize) {
                var bodyElem = _this29.$refs.tableBody.$el;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this31.showValidTooltip(params);
      });
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this32.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this32, 'valid-error', [params]);
      });
    },
     ...
     *************************/
    // 与工具栏对接
    connect: function connect(_ref13) {
      var toolbar = _ref13.toolbar;
  ...
  render: function render(h) {
    ...
    h('thead', {
      ...
      return h('tr', {
        ...
        return h('th', {
          class: ['vxe-header--column', column.id, (_ref = {}, _defineProperty(_ref, "col--".concat(headAlign), headAlign), _defineProperty(_ref, 'col--index', column.type === 'index'), _defineProperty(_ref, 'col--group', isColGroup), _defineProperty(_ref, 'col--ellipsis', hasEllipsis), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref, 'filter--active', column.filters.some(function (item) {
            return item.checked;
...
function renderRows(h, _vm, $table, $seq, rowLevel, fixedType, tableData, tableColumn) {
  ...
  tableData.forEach(function (row, $rowIndex) {
    ...
    var rowPrimaryKey = UtilTools.getRowPrimaryKey($table, row);
    rows.push(h('tr', {
...
/* harmony default export */ var src_toolbar = ({
  ...
  methods: {
    ...
    updateResizable: function updateResizable() {

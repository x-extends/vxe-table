...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    insertAt: function insertAt(records, row) {
      ...
      var nowData = scrollYLoad ? afterFullData : tableData;
    ...
    clearSort: function clearSort(field) {
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this35.validCellRules('all', row, column).then(resolve).catch(function (_ref8) {
                  var rule = _ref8.rule,
                      rules = _ref8.rules;
                  var rest = {
                    rule: rule,
...
var components = [packages_table, packages_column, packages_header, packages_body, packages_footer, packages_filter, packages_loading, packages_grid, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_button, packages_message, packages_tooltip, packages_export, packages_resize]; // 默认安装

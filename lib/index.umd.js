...
/* harmony default export */ var src_toolbar = ({
  ...
  methods: {
    ...
    exportEvent: function exportEvent() {
      ...
      var virtualScroller = comp.getVirtualScroller(); // 重置条件
      ...
      this.$XModal({
        ...
        slots: {
          default: function _default(params, h) {
            ...
            return [h('div', {
            ...
            }, [h('table', [h('tr', [h('td', conf.i18n('vxe.toolbar.expName')), h('td', [h('input', {
              attrs: {
                type: 'text',
            ...
            }))])]), h('tr', [h('td', conf.i18n('vxe.toolbar.expSuffix')), h('td', [h('select', {
              on: {
                change: function change(evnt) {
                  exportStore.type = evnt.target.value;
                }
            ...
            }, conf.i18n('vxe.toolbar.expOptIndex')), h('vxe-checkbox', {
              props: {
                size: vSize
              },
              model: {
              ...
              on: {
                click: function click() {
                  var options = Object.assign({}, exportOpts);

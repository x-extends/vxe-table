...
function getFileTypes() {
  return Object.keys(v_x_e_table.types);
}
  ...
  methods: {
    ...
    importData: function importData(options) {
      ...
      this.readFile().then(function (evnt) {
        return _this45.importByFile(evnt.target.files[0], options);
      });
      return new Promise(function (resolve) {
        _this45._importCallback = resolve;
      });
    },
    readFile: function readFile() {
      ...
      impInput.onchange = function (evnt) {
        _this46._fileCallback(evnt);

        _this46._fileCallback = null;
      };

      impForm.reset();
      impInput.click();
      return new Promise(function (resolve) {
        _this46._fileCallback = resolve;
      });
    },

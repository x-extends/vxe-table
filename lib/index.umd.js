...
/* harmony default export */ var virtual_tree = ({
  ...
  methods: {
    ...
    getTreeExpandRecords: function getTreeExpandRecords() {
      ...
      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(this.fullTreeData, function (row) {
    ...
    insertAt: function insertAt(records, row) {
      ...
      if (!row) {
        ...
        if (row === -1) {
          ...
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(fullTreeData, function (item) {
            return item === row;
          });
    ...
    toVirtualTree: function toVirtualTree(treeData) {
      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(treeData, function (item, index, obj, paths, parent, nodes) {
      ...
      if (row._X_EXPAND !== expanded) {
        if (this.hasChilds(row)) {
          ...
          if (row._X_EXPAND) {
            // 展开节点
            var nodeChildList = [];
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(childRows, function (item) {
            ...
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(childRows, function (item, index, obj, paths, parent, nodes) {
...
var components = [packages_table, packages_column, packages_header, packages_body, packages_footer, packages_filter, packages_loading, packages_grid, packages_virtual_tree, packages_excel, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_button, packages_modal, packages_tooltip, packages_export, packages_resize]; // 默认安装

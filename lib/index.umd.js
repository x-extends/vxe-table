...
/* harmony default export */ var table = ({
  ...
  methods: {
            ...
            if (!interceptor.clearActiveds.some(function (func) {
              ...
              !dom.getEventTargetNode(evnt, this.$el).flag) {
                this.triggerValidate().then(function () {
                  setTimeout(function () {
                    return _this4.clearActived(evnt);
                  }, 100);
                }).catch(function (e) {
                  return e;
                });
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this13.$refs,
            tableData = _this13.tableData,
            editRules = _this13.editRules;
        ...
        if (scope && $refs.tableBody && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
          ...
          if (cell) {
            return _this13.validCellRules('change', row, column).then(function () {
              return _this13.clearValidate();
            }).catch(function (rule) {
              return _this13.handleValidError({
                rule: rule,
                row: row,
                column: column,
                cell: cell
    ...
    validateRow: function validateRow(row, cb) {
      ...
      return new promise_default.a(function (resolve, reject) {
        _this14.validRowRules('all', row).then(function () {
          var valid = true;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        _this18.$nextTick().then(function () {
        ...
        utils.emitEvent(_this18, 'valid-error', [params]);
      });
    },

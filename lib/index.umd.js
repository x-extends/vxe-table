...
module.exports = {
  vxe: {
    ...
    grid: {
      ...
      removeSelectRecord: '您确定要删除所选记录吗？',
      dataUnchanged: '数据未改动！ '
    },
    pagination: {
      goto: '前往',
...
var UtilTools = {
  ...
  getRowKey: function getRowKey($table) {
    var rowKey = $table.rowKey,
        ...
        _$table$expandeds = $table.expandeds,
        expandeds = _$table$expandeds === void 0 ? {} : _$table$expandeds,
  ...
  getCellLabel: function getCellLabel(row, column, params) {
    ...
    return params && column.formatter ? column.formatter(assign_default()({
      cellValue: cellValue
    }, params)) : cellValue;
  },
...
var DomTools = {
  ...
  getCell: function getCell($table, _ref) {
    ...
    return $table.$refs.tableBody.$el.querySelector(".vxe-body--row[data-rowkey=\"".concat(rowId, "\"] .").concat(column.id));
  },
      ...
      return h('tr', {
        ...
        if (tableListeners['header-cell-dblclick']) {
          thOns.dblclick = function (evnt) {
            utils.emitEvent($table, 'header-cell-dblclick', [{
              $table: $table,
              headIndex: rowIndex,
              column: column,
              columnIndex: columnIndex,
...
function renderColumn(h, _vm, $table, seq, fixedType, rowLevel, row, rowIndex, nowIndex, column, columnIndex) {
  ...
  if (showTooltip || tableListeners['cell-mouseenter']) {
    tdOns.mouseenter = function (evnt) {
      ...
      utils.emitEvent($table, 'cell-mouseenter', [evntParams, evnt]);
    };
  } // hover 退出事件
  ...
  if (showTooltip || tableListeners['cell-mouseleave']) {
    tdOns.mouseleave = function (evnt) {
      $table.clostTooltip();
      utils.emitEvent($table, 'cell-mouseleave', [{
        $table: $table,
        seq: seq,
        row: row,
        rowIndex: rowIndex,
  ...
  return h('td', {
    ...
    attrs: {
      title: showTitle ? utils.getCellLabel(row, column, params) : null
    },
    style: {
...
function renderRows(h, _vm, $table, rowLevel, fixedType, tableData, tableColumn) {
  ...
  var rows = [];
  tableData.forEach(function (row, nowIndex) {
    var _ref3;

    var trOn = {};
    var rowIndex = nowIndex;
    var seq = rowIndex + 1;
    ...
    datas.forEach(function (record, rowIndex) {
      if (isOriginal) {
        content += columns.map(function (column) {
          ...
          return "\"".concat(utils.getCellValue(record, column) || '', "\"");
        }).join(',') + '\n';
      } else {
        content += columns.map(function (column) {
...
function defaultRenderer(h, attrs, editRender, params) {
  ...
  return [h('div', {
    ...
    attrs: attrs,
    domProps: {
      value: utils.getCellValue(row, column)
    },
    on: {
      input: function input(evnt) {
        utils.setCellValue(row, column, evnt.target.value);
...
var renderer_storeMap = {
  ...
  cell: {
        ...
        on: {
          ...
          keydown: function keydown(evnt) {
            ...
            if (evnt.altKey && evnt.keyCode === 13) {
              ...
              utils.setCellValue(row, column, "".concat(value.slice(0, pos), "\n").concat(value.slice(pos, value.length)));
    ...
    renderCell: function renderCell(h, editRender, params) {
      ...
      return [h('span', {
        domProps: {
          innerHTML: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.escape(utils.getCellValue(row, column)).replace(/\n/g, '<br>')
        }
      })];
    }
  }
...
var Renderer = {
  mixin: function mixin(map) {
    assign_default()(renderer_storeMap, map);
...
var CellMethods = {
  ...
  renderCell: function renderCell(h, params) {
    ...
    cellValue = utils.getCellValue(row, column);
...
/* harmony default export */ var table = ({
  ...
  created: function created() {
    ...
    this.loadData(this.data, true).then(function () {
      var rowKey = utils.getRowKey(_this);
  ...
  methods: {
    ...
    defineProperty: function defineProperty(record) {
      ...
      var rowKey = utils.getRowKey(this);
      this.visibleColumn.forEach(function (column) {
        ...
        if (rowKey && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(recordItem, rowKey)) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(recordItem, rowKey, ++rowUniqueId + now_default()());
        }
      });
      return recordItem;
    },
      ...
      if (prop) {
        ...
        rows.forEach(function (row) {
          visibleColumn.forEach(function (column) {
            if (column.property) {
              utils.setCellValue(row, column, null);
            }
          });
        });
      }
    ...
    hasRowChange: function hasRowChange(row, prop) {
      ...
      if (rowKey || treeConfig) {
        ...
        if (treeConfig) {
          ...
          row = assign_default()({}, row, _defineProperty({}, children, null));

          if (matchObj) {
            oRow = assign_default()({}, matchObj.item, _defineProperty({}, children, null));
          }
        } else {
      ...
      tableData = tableData.filter(function (row) {
        return filterColumn.every(function (column) {
          var property = column.property,
              ...
              remoteFilter = column.remoteFilter;
        ...
        if (refull === true) {
          ...
          return this.$nextTick().then(function () {
            ...
            if (bodyWidth !== tableWidth) {
              _this7.autoCellWidth(headerElem, bodyElem, footerElem, bodyWidth);
            }

            _this7.computeScrollLoad();
          });
        }
      }
      ...
      if (actived.row) {
        if (!(editConfig.autoClear === false)) {
          ...
          if (!this.lastCallTime || this.lastCallTime + 50 < now_default()()) {
            var evntList = interceptor.get('event.clear_actived');
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (isEsc) {
        ...
        // 如果是删除键
        if (selected.row || selected.column) {
          utils.setCellValue(selected.row, selected.column, null);
    ...
    moveTabSelected: function moveTabSelected(params, evnt) {
      ...
      if (nextColumn) {
        ...
        params.cell = dom.getCell(this, params);
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            this.$nextTick(function () {
              var ctxElem = _this8.$refs.ctxWrapper.$el;
    ...
    ctxMenuLinkEvent: function ctxMenuLinkEvent(evnt, menu) {
      if (!menu.disabled && (!menu.children || !menu.children.length)) {
        utils.emitEvent(this, 'context-menu-click', [assign_default()({
          menu: menu
    ...
    triggerTooltipEvent: function triggerTooltipEvent(evnt, params) {
      ...
      if (tooltipStore.column !== column || tooltipStore.row !== row || !tooltipStore.visible) {
        this.showTooltip(evnt, utils.getCellLabel(row, column, params), column, row);
      }
    },
    // 显示 tooltip
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this10.triggerCheckRowEvent({}, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
     ...
     */
    triggerCheckRowEvent: function triggerCheckRowEvent(evnt, _ref3, value) {
      var row = _ref3.row;
     ...
     * 单选，行选中事件
     */
    triggerRowEvent: function triggerRowEvent(evnt, _ref4) {
      var row = _ref4.row;
      this.selectRow = row;
      utils.emitEvent(this, 'select-change', [{
        row: row
          ...
          if (!actived.args || evnt.currentTarget !== actived.args.cell) {
            ...
            if (editConfig.mode === 'row') {
              ...
              this.triggerValidate('blur').then(function () {}).catch(function (e) {
                ...
                _this11.handleActived(params, evnt).then(function () {
                  return _this11.triggerValidate('change');
                }).catch(function (e) {
                  return e;
                });
              }); // }
    ...
    clearActived: function clearActived(evnt) {
      ...
      if (actived.row || actived.column) {
        utils.emitEvent(this, 'edit-closed', [actived.args, evnt]);
      }
        ...
        rows.forEach(function (row, rIndex) {
          ...
          if (offsetRow) {
            columns.forEach(function (column, cIndex) {
              ...
              if (offsetColumn) {
                utils.setCellValue(offsetRow, offsetColumn, utils.getCellValue(row, column));
              }
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
          ...
          if (_this15.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = dom.getCell(_this15, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
            ...
            if (cell) {
              return _this15.validCellRules(type, row, column).then(function () {
                return _this15.clearValidate();
              }).catch(function (rule) {
                return _this15.openValidTooltip({
                  rule: rule,
                  row: row,
                  column: column,
                  cell: cell
                  ...
                  if ((type === 'all' || !rule.trigger || type === rule.trigger) && (isRequired || value || rule.validator)) {
                    if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                      rule.validator(rule, value, function (e) {
                        ...
                        row: row,
                        column: column,
                        rowIndex: _this18.getRowMapIndex(row),
                        columnIndex: _this18.getColumnMapIndex(column)
                      });
                    } else {
                      var restVal;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this19.openValidTooltip(params);
      });
    },
     ...
     * 弹出校验错误提示
     */
    openValidTooltip: function openValidTooltip(params) {
      var _this20 = this;
      ...
      this.$nextTick(function () {
        ...
        _this20.$nextTick().then(function () {
        ...
        utils.emitEvent(_this20, 'valid-error', [params]);
      });
    },
...
// CONCATENATED MODULE: ./src/components/table-toolbar/src/toolbar.js
...
/* harmony default export */ var src_toolbar = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-table-toolbar', _defineProperty({}, "size--".concat(vSize), vSize)]
    }, [h('div', {
      ...
      return h('vxe-button', {
        on: {
          click: function click(evnt) {
            return _this.btnEvent(item, evnt);
          }
        }
      }, item.name);
    })), setting ? h('div', {
  ...
  methods: {
    ...
    updateSetting: function updateSetting() {
      ...
      if ($grid) {
        ...
        var $table = $children.find(function (comp, index) {
          return comp.refreshColumn && index > selfIndex && comp.customs === customs;
        });
    ...
    btnEvent: function btnEvent(item, evnt) {
      var $grid = this.$grid; // 只对 gird 环境中有效
      ...
      if ($grid) {
          ...
          case 'delete_rows':
            ...
            if ($grid.isAlert) {
              if (selectRecords.length) {
                this.$XTool.confirm(conf.i18n('vxe.grid.removeSelectRecord')).then(function () {
                  return $grid.removeSelecteds();
                }).catch(function (e) {
                  return e;
                });
              } else {
                this.$XTool.alert(conf.i18n('vxe.grid.selectOneRecord')).catch(function (e) {
                  return e;
                });
              }
            } else {
        ...
        utils.emitEvent($grid, 'toolbar-button-click', [{
          button: item,
          $grid: $grid
        }, evnt]);
      }
...
// CONCATENATED MODULE: ./src/components/table-toolbar/index.js
...
/* harmony default export */ var table_toolbar = (src_toolbar);
...
/* harmony default export */ var func = (['loadData', 'reloadData', 'loadColumn', 'reloadColumn', 'reload', 'insert', 'insertAt', 'revert', 'remove', 'removeSelecteds', 'getRecords', 'getRowIndex', 'getColumns', 'getColumnIndex', 'getAllRecords', 'getInsertRecords', 'getRemoveRecords', 'getUpdateRecords', 'getSelectRecords', 'hasRowChange', 'setActiveRow', 'setActiveCell', 'setSelectCell', 'setRowExpansion', 'setAllRowExpansion', 'setTreeExpansion', 'setAllTreeExpansion', 'setCurrentRow', 'setSelection', 'setAllSelection', 'toggleRowSelection', 'toggleAllSelection', 'toggleRowExpansion', 'toggleTreeExpansion', 'clearCurrentRow', 'clearSelection', 'clearRowExpand', 'clearTreeExpand', 'clearSort', 'clearFilter', 'clearChecked', 'clearSelected', 'clearActivedd', 'clearCopyed', 'clearData', 'clearScroll', 'clearAll', 'closeFilter', 'clostTooltip', 'closeContextMenu', 'recalculate', 'refreshColumn', 'updateStatus', 'isScrollXLoad', 'isScrollYLoad', 'sort', 'validateRow', 'validate', 'exportCsv']);
// CONCATENATED MODULE: ./src/components/grid/src/grid.js
...
var propKeys = keys_default()(src_props);
...
/* harmony default export */ var grid = ({
  ...
  render: function render(h) {
    ...
    var props = assign_default()({}, tableProps);

    var tableOns = assign_default()({}, $listeners);

    var toolbarProps = assign_default()({
      customs: tableCustoms,
      optimization: assign_default()({}, conf.optimization, optimization)
    }, toolbar);

    if (proxyConfig) {
      assign_default()(props, {
    ...
    if (editConfig) {
      props.editConfig = assign_default()({}, editConfig, {
        activeMethod: this.handleActiveMethod
      });
    }

    return h('div', {
      class: ['vxe-grid', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, 't--animat', toolbarProps.optimization.animat), _ref)]
  ...
  methods: _objectSpread({}, methods, {
              ...
              if (ajax.delete) {
                ...
                return this.validate().then(function () {
                  ...
                  if (removeRecords.length) {
                    ...
                    if (isAlert) {
                      _this3.$XTool.alert(conf.i18n('vxe.grid.selectOneRecord')).catch(function (e) {
                        return e;
                      });
                    }
                  }
          ...
          case 'save':
            {
              if (ajax.save) {
                return this.validate().then(function () {
                  var body = assign_default()({
                    pendingRecords: _this3.pendingRecords
                  }, _this3.getAllRecords());
                  ...
                  if (insertRecords.length || removeRecords.length || updateRecords.length || pendingRecords.length) {
                    ...
                    if (isAlert) {
                      _this3.$XTool.alert(conf.i18n('vxe.grid.dataUnchanged')).catch(function (e) {
                        return e;
                      });
                    }
                  }
      ...
      if (selectRecords.length) {
        ...
        if (minus.length) {
          this.pendingRecords = pendingRecords.filter(function (item) {
            return minus.some(function (data) {
              return data !== item;
            });
          }).concat(plus);
        } else if (plus) {
    ...
    sortChangeEvent: function sortChangeEvent(_ref4) {
      ...
      if (column.remoteSort) {
        ...
        utils.emitEvent(this, 'sort-change', [column, prop, order]);
      }
    },
    filterChangeEvent: function filterChangeEvent(_ref5) {
      ...
      if (column.remoteFilter) {
        ...
        utils.emitEvent(this, 'filter-change', [column, prop, values]);
      }
    }
  })
});
...
// CONCATENATED MODULE: ./src/components/excel/src/excel.js
...
/* harmony default export */ var pagination = ({
  ...
  props: {
    ...
    layouts: {
      type: Array,
      default: function _default() {
        return conf.pagination.layouts || ['PrevJump', 'PrevPage', 'Jump', 'PageCount', 'NextPage', 'NextJump', 'Sizes', 'Total'];
      }
    },
    // 当前页
    currentPage: {
    ...
    pageSize: {
      type: Number,
      default: function _default() {
        return conf.pagination.pageSize || 10;
      }
    },
    // 总条数
    total: {
    ...
    pagerCount: {
      type: Number,
      default: function _default() {
        return conf.pagination.pagerCount || 7;
      }
    },
    // 每页大小选项列表
    pageSizes: {
      type: Array,
      default: function _default() {
        return conf.pagination.pageSizes || [10, 15, 20, 50, 100];
      }
    },
    // 带背景颜色
    background: Boolean
  ...
  methods: {
    ...
    renderSizes: function renderSizes(h) {
      ...
      }, "".concat(pageSize).concat(conf.i18n('vxe.pagination.pagesize')))]);
    },
    // 分页面板
...
/* harmony default export */ var src_alert = ({
  ...
  props: {
    ...
    title: {
      type: String,
      default: function _default() {
        return conf.i18n('vxe.alert.title');
      }
    },
    message: String,
    lockView: {
    ...
    close: function close(type) {
      ...
      if (visible) {
        ...
        setTimeout(function () {
          ...
          if (lockScroll) {
            assign_default()(document.body.style, beforeLockStyle);
          }
...
var components = [components_table, table_column, table_toolbar, components_grid, components_excel, components_pagination, components_checkbox, components_radio, components_input, components_button, components_alert, components_tooltip];
...
['alert', 'confirm'].forEach(function (type) {
  MessageBox[type] = function (message, title, options) {
    ...
    if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isString(message)) {
      if (title) {
        opts.title = title;
      }
    } else {
    ...
    return MessageBox(assign_default()({}, opts, options));
  };
});
/**
 * 全局参数设置
...
function install(Vue, options) {
  ...
  AlertController = Vue.extend(components_alert);

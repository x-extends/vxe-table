  ...
  render: function render(h) {
    ...
    h('tfoot', footerData.map(function (list, $rowIndex) {
      return h('tr', {
        ...
        var columnIndex = getColumnIndex(column);
        var cellIndex = $table.tableColumn.indexOf(column);
        var params = {
          $table: $table,
          $rowIndex: $rowIndex,
          column: column,
...
var rowHeight = 24;
/* harmony default export */ var src_cells = ({
  cell: {
...
excel.install = function (Vue) {
  v_x_e_table.renderer.mixin(src_cells);
...
/* harmony default export */ var src_group = ({
  ...
  data: function data() {
    return {
      name: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.uniqueId('xgroup')
    };
  },
  render: function render(h) {
    return h('div', {

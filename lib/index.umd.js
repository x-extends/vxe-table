...
/* harmony default export */ var table = ({
  ...
  methods: {
        ...
        if (refull === true) {
          ...
          return this.$nextTick(function () {
            ...
            if (bodyWidth !== tableWidth) {
              _this2.autoCellWidth(headerElem, bodyElem, footerElem, bodyWidth);
            }
          });
        }
      }
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this6.triggerCheckRowEvent({}, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
      ...
      if (editConfig) {
        if (editConfig.trigger === 'click') {
          if (!actived.args || evnt.currentTarget !== actived.args.cell) {
            this.triggerValidate().then(function () {
              _this7.handleActived(params, evnt);
            }).catch(function (e) {
              return e;
            });
          }
    ...
    handleActived: function handleActived(params, evnt) {
      ...
      if (actived.row !== row || actived.column !== column) {
        ...
        if (!activeMethod || activeMethod(params)) {
          ...
          this.$nextTick(function () {
            _this9.handleFocus(params, evnt);
          });
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      return this.triggerValidate().then(function () {
        ...
        if (mouseConfig.checked) {
          ...
          _this10.handleChecked(select, select, evnt);
        }
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        var tableBody = _this11.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this11.$refs.tableFooter;
    ...
    validateRow: function validateRow(row, cb) {
      ...
      return new promise_default.a(function (resolve, reject) {
        _this12.validRowRules('all', row).then(function () {
          var valid = true;
          ...
          _this12.handleValidError(params);
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              validPromise = validPromise.then(function () {
                return new promise_default.a(function (resolve, reject) {
                  _this14.validCellRules('all', row, column).then(resolve).catch(function (rule) {
                    var rest = {
                      rule: rule,
                      rowIndex: rowIndex,
                      row: row,
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        _this16.$nextTick().then(function () {
        ...
        utils.emitEvent(_this16, 'valid-error', [params]);
      });
    },

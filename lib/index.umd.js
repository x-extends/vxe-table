...
/* harmony default export */ var table = ({
  ...
  created: function created() {
    ...
    if (!v_x_e_table._edit && this.editConfig) {
      throw new Error(xe_utils_amd_xe_utils_default.a.template(UtilTools.error('vxe.error.reqModule'), {
        name: 'Edit'
      }));
    }

    if (!v_x_e_table._valid && this.editRules) {
      throw new Error(xe_utils_amd_xe_utils_default.a.template(UtilTools.error('vxe.error.reqModule'), {
        name: 'Validator'
      }));
    }
      ...
      return h('tr', {
        ...
        return h('td', {
          class: ['vxe-footer--column', column.id, (_ref2 = {}, _defineProperty(_ref2, "col--".concat(footAlign), footAlign), _defineProperty(_ref2, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref2, 'col--ellipsis', hasEllipsis), _defineProperty(_ref2, 'filter--active', column.filters.some(function (item) {
            return item.checked;
          })), _ref2), footerCellClassName ? xe_utils_amd_xe_utils_default.a.isFunction(footerCellClassName) ? footerCellClassName({
            $table: $table,
            $rowIndex: $rowIndex,
            column: column,
            columnIndex: columnIndex,
    ...
    return this.scrollToRow(row, true).then(function () {
      if (row && field) {
        ...
        if (column && column.editRender) {
          var cell = DomTools.getCell(_this5, {
            row: row,
            column: column
          });

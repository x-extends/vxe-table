          ...
          case 'query':
            if (ajax.query) {
              ...
              return ajax.query({
                ...
                _this2.tableData = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(result, props.data || 'result');
            ...
            if (ajax.save) {
              return this.validate().then(function () {
                var body = assign_default()({
                  pendingRecords: _this2.pendingRecords
                }, _this2.getAllRecords());
    ...
    triggerPendingEvent: function triggerPendingEvent(evnt) {
      ...
      if (selectRecords.length) {
        ...
        selectRecords.forEach(function (data) {
          if (_this3.pendingRecords.some(function (item) {
            return data === item;
          })) {
            minus.push(data);
          } else {

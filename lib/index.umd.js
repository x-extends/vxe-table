...
function renderColumn(h, _vm, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  return h('td', {
    class: ['vxe-body--column', column.id, (_ref2 = {}, _defineProperty(_ref2, "col--".concat(align), align), _defineProperty(_ref2, 'col--edit', editRender), _defineProperty(_ref2, 'edit--selected', editRender && selected && selected.row === row && selected.column === column), _defineProperty(_ref2, 'edit--actived', editRender && actived && actived.row === row && actived.column === column), _defineProperty(_ref2, 'fixed--hidden', fixedHiddenColumn), _ref2), cellClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(cellClassName) ? cellClassName({
      row: row,
      rowIndex: rowIndex,
      column: column,
      columnIndex: columnIndex,
...
var UtilTools = {
  ...
  getColumnConfig: function getColumnConfig(_vm) {
    ...
    return {
      ...
      editRender: _vm.editRender ? assign_default()({}, _vm.editRender) : _vm.editRender,
      // 渲染属性
      visible: true,
      level: 1,
      rowSpan: 1,
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    triggerTooltipEvent: function triggerTooltipEvent(evnt, _ref) {
      ...
      var content = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, column.property);
      ...
      if (content && wrapperElem.scrollWidth > wrapperElem.clientWidth) {
        ...
        if (tooltipStore.column !== column || tooltipStore.row !== row || !tooltipStore.visible) {
          ...
          assign_default()(tooltipStore, {
            row: row,
            column: column,
            content: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, column.property),
            visible: true
          });
  ...
  methods: {
    ...
    renderDefaultEdit: function renderDefaultEdit(h, params) {
      ...
      return [h('input', {
        ...
        domProps: {
          value: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, column.property)
        },
        on: {
          input: function input(evnt) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(row, column.property, evnt.target.value);
          }
        }
      })];
    },

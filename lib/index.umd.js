...
var ResizeEvent = {
  ...
  handle: function handle() {
    if (resize_eventStore.length) {
      resize_eventStore.forEach(function (_ref) {
        var comp = _ref.comp,
            target = _ref.target,
            cb = _ref.cb,
            width = _ref.width,
...
var methods = {};
var funs = ['reload', 'insert', 'insertAt', 'revert', 'remove', 'getRecords', 'getColumns', 'clearSelectRow', 'setCurrentRow', 'clearSelection', 'toggleRowSelection', 'toggleAllSelection', 'clearSort', 'clearFilter', 'setActiveRow', 'setActiveCell', 'setSelectCell', 'recalculate', 'isScrollXLoad', 'isScrollYLoad', 'exportCsv'];

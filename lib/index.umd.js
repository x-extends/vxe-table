...
/* harmony default export */ var table = ({
  ...
  methods: {
     ...
     */
    handleSelectRow: function handleSelectRow(evnt, _ref2, value) {
      var row = _ref2.row;
    ...
    triggerCellClickEvent: function triggerCellClickEvent(evnt, params) {
      ...
      var $el = this.$el,
          ...
          editConfig = this.editConfig;
      var actived = editStore.actived;
      var column = params.column; // 如果是树形表格
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this31.validCellRules('all', row, column).then(resolve).catch(function (_ref8) {
                  var rule = _ref8.rule,
                      rules = _ref8.rules;
                  var rest = {
                    rule: rule,

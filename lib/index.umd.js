...
function renderColumn(h, _vm, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  var tableListeners = $table.$listeners,
      tableSourceData = $table.tableSourceData,
  ...
  return h('td', {
    class: ['vxe-body--column', column.id, (_ref2 = {}, _defineProperty(_ref2, "col--".concat(align), align), _defineProperty(_ref2, 'col--edit', editRender), _defineProperty(_ref2, 'col--checked', isMouseChecked && checked.rows.indexOf(row) > -1 && checked.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--checked-top', isMouseChecked && checked.rows.indexOf(row) === 0 && checked.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--checked-bottom', isMouseChecked && checked.rows.indexOf(row) === checked.rows.length - 1 && checked.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--checked-left', isMouseChecked && checked.rows.indexOf(row) > -1 && checked.columns.indexOf(column) === 0), _defineProperty(_ref2, 'col--checked-right', isMouseChecked && checked.rows.indexOf(row) > -1 && checked.columns.indexOf(column) === checked.columns.length - 1), _defineProperty(_ref2, 'col--selected', isMouseSelected && editRender && selected.row === row && selected.column === column), _defineProperty(_ref2, 'col--copyed', isKeyboardCut && copyed.rows.indexOf(row) > -1 && copyed.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--copyed-top', isKeyboardCut && copyed.rows.indexOf(row) === 0 && copyed.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--copyed-bottom', isKeyboardCut && copyed.rows.indexOf(row) === copyed.rows.length - 1 && copyed.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--copyed-left', isKeyboardCut && copyed.rows.indexOf(row) > -1 && copyed.columns.indexOf(column) === 0), _defineProperty(_ref2, 'col--copyed-right', isKeyboardCut && copyed.rows.indexOf(row) > -1 && copyed.columns.indexOf(column) === copyed.columns.length - 1), _defineProperty(_ref2, 'col--actived', editRender && actived.row === row && actived.column === column), _defineProperty(_ref2, 'col--dirty', isDirty), _defineProperty(_ref2, 'edit--visible', editRender && editRender.type === 'visible'), _defineProperty(_ref2, 'fixed--hidden', fixedHiddenColumn), _ref2), cellClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(cellClassName) ? cellClassName({
      $table: $table,
      row: row,
      rowIndex: rowIndex,
      column: column,
    ...
    attrs: {
      title: isShowTitle ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, column.property) : null
    },
    style: {
  ...
  }) : null, isMouseChecked ? h('span', {
    class: 'vxe-body--column-checked-rb'
  }) : null, isKeyboardCut ? h('span', {
...
// CONCATENATED MODULE: ./packages/table/src/footer.js
...
function renderFixed(h, $table, fixedType, footerData) {
  ...
  var style = {
    height: "".concat((customHeight ? customHeight - headerHeight - footerHeight : tableHeight) + headerHeight + footerHeight - scrollXHeight, "px"),
...
/* harmony default export */ var table = ({
  ...
  created: function created() {
    ...
    this.reload(this.data, true).then(function () {
  ...
  render: function render(h) {
    ...
    var leftList = columnStore.leftList,
        rightList = columnStore.rightList;
    var footerData = showFooter && footerMethod && tableColumn.length ? footerMethod({
      columns: tableColumn,
      data: getRecords()
    }) : ['-'];
    return h('div', {
  ...
  methods: {
    ...
    reload: function reload(data, init) {
     ...
     * 从指定行插入数据
     */
    insertAt: function insertAt(record, row) {
      ...
      if (arguments.length === 1) {
        ...
        if (row === -1) {
          ...
          var rowIndex = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findIndexOf(tableData, function (item) {
            return item === row;
          });
    ...
    revert: function revert(rows, prop) {
      ...
      if (arguments.length) {
        ...
        rows.forEach(function (row) {
          var rowIndex = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findIndexOf(tableFullData, function (item) {
            return item === row;
          });
    ...
    getTableData: function getTableData() {
      ...
      if (isAllSelected || isIndeterminate) {
        tableData = tableData.filter(function (row) {
          return visibleColumn.every(function (column) {
    ...
    refreshColumn: function refreshColumn() {
      ...
      var isGroup = this.isGroup,
          columnStore = this.columnStore;
      this.tableFullColumn.forEach(function (column, columnIndex) {
        if (column.visible) {
      ...
      var tableColumn = leftList.concat(centerList).concat(rightList);
      ...
      if (refull === true) {
        ...
        this.$nextTick(function () {
          ...
          if (bodyWidth !== tableWidth) {
            _this3.autoCellWidth(headerElem, bodyElem, footerElem, bodyWidth);
          }
        });
      }
    },
    ...
    handleKeydownEvent: function handleKeydownEvent(evnt) {
      var params;
      var selectEditMethod = this.selectEditMethod,
          isCtxMenu = this.isCtxMenu,
          ctxMenuStore = this.ctxMenuStore,
      ...
      if (isEsc) {
        ...
        if (actived.row || actived.column) {
          params = actived.args;
          this.closeActived(); // 如果配置了选中功能，则为选中状态
     ...
     * 触发 tooltip 事件
     */
    triggerTooltipEvent: function triggerTooltipEvent(evnt, _ref) {
      var _this5 = this;
      ...
      var content = utils.getCellValue(row, column.property);
      ...
      if (content && wrapperElem.scrollWidth > wrapperElem.clientWidth) {
        ...
        if (tooltipStore.column !== column || tooltipStore.row !== row || !tooltipStore.visible) {
          ...
          assign_default()(tooltipStore, {
            row: row,
            column: column,
            content: utils.getCellValue(row, column.property),
            visible: true
          });
          ...
          this.$nextTick().then(function () {
            ...
            tooltipStore.style = {
              ...
              left: "".concat(left - 6, "px")
            };

            if (tipWrapperElem.offsetWidth < cell.offsetWidth) {
              tooltipStore.style.left = "".concat(left + Math.floor((cell.offsetWidth - tipWrapperElem.offsetWidth) / 2) - 6, "px");
            }
            ...
            if (left + offsetWidth > scrollLeft + visibleWidth) {
              tooltipStore.style.left = "".concat(scrollLeft + visibleWidth - offsetWidth - 6, "px");
            }
          });
        }
      }
     ...
     * 多选，行选中事件
     */
    triggerCheckRowEvent: function triggerCheckRowEvent(evnt, value, _ref2) {
      var row = _ref2.row,
          column = _ref2.column;
     ...
     * 单选，行选中事件
     */
    triggerRowEvent: function triggerRowEvent(evnt, _ref3) {
      var row = _ref3.row;
      this.selectRow = row;
      utils.emitEvent(this, 'select-change', [{
        row: row
    ...
    triggerCellMousedownEvent: function triggerCellMousedownEvent(evnt, params) {
      ...
      if (isLeftBtn || isRightBtn) {
        if (editConfig && editConfig.trigger === 'dblclick') {
          if (actived.row === row && actived.column === column) {// 如果已经是激活状态
          } else {
            if (isLeftBtn) {
              evnt.preventDefault();
              evnt.stopPropagation();
     ...
     * 关闭编辑状态
     */
    closeActived: function closeActived() {
      var editStore = this.editStore;
      var actived = editStore.actived;
      actived.args = null;
      actived.row = null;
     ...
     * 展开行事件
     */
    triggerExpandRowEvent: function triggerExpandRowEvent(evnt, _ref5) {
      var _this7 = this;

      var row = _ref5.row;
      var expandeds = this.expandeds;
      var index = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findIndexOf(expandeds, function (item) {
        return item === row;
      });
...
/* harmony default export */ var src_column = ({
  ...
  methods: {
    ...
    renderHeader: function renderHeader(h, params) {
      ...
      return [h('span', utils.formatText(params.column.label))];
    },
    renderCell: function renderCell(h, params) {
      ...
      return [h('span', utils.formatText(cellValue))];
    },
    ...
    renderSortAndFilterHeader: function renderSortAndFilterHeader(h, params) {
      return [h('span', utils.formatText(params.column.label))].concat(this.renderSortIcon(h, params)).concat(this.renderFilterIcon(h, params));
    },
    ...
    renderSortHeader: function renderSortHeader(h, params) {
      return [h('span', utils.formatText(params.column.label))].concat(this.renderSortIcon(h, params));
    },
    ...
    renderFilterHeader: function renderFilterHeader(h, params) {
      return [h('span', utils.formatText(params.column.label))].concat(this.renderFilterIcon(h, params));
    },
    ...
    renderEditHeader: function renderEditHeader(h, params) {
      ...
      var $table = this.$table,
          sortable = this.sortable,
          filters = this.filters;
      var _$table$editConfig = $table.editConfig,
          editConfig = _$table$editConfig === void 0 ? {} : _$table$editConfig;
      return [editConfig.showIcon === false ? null : h('i', {
        class: iconMap.edit
      }), h('span', utils.formatText(params.column.label))].concat(sortable ? this.renderSortIcon(h, params) : []).concat(filters && filters.length ? this.renderFilterIcon(h, params) : []);
    },
    // 行格编辑模式
    ...
    renderCellEdit: function renderCellEdit(h, params) {
      ...
      return compConf && compConf.formatLabel ? compConf.formatLabel(utils.getCellValue(row, column.property), editRender) : this.renderCell(h, params);
    },
    renderCompEdit: function renderCompEdit(h, params, name) {
      return !name || name === 'input' || name === 'textarea' ? this.renderDefaultEdit(h, params) : this.renderCustomEdit(h, params);
    },
    renderDefaultEdit: function renderDefaultEdit(h, params) {
      var editRender = this.editRender;
      var row = params.row,
          column = params.column;
      var _editRender$name = editRender.name,
          name = _editRender$name === void 0 ? 'input' : _editRender$name,
          attrs = editRender.attrs;
    ...
    renderCustomEdit: function renderCustomEdit(h, params) {
      var $table = this.$table,
          editRender = this.editRender;
      var row = params.row,
          column = params.column;
      var props = editRender.props;
      var _GlobalConfig$renderM2 = conf.renderMap,
          renderMap = _GlobalConfig$renderM2 === void 0 ? {} : _GlobalConfig$renderM2;
      var compConf = renderMap[editRender.name];
      ...
      return [h(editRender.name, {
        ...
        model: {
          ...
          callback: function callback(value) {
            utils.setCellValue(row, column.property, value);
          }
        }
      })];
    }
...
var methods = {};
var funs = ['reload', 'insert', 'insertAt', 'revert', 'remove', 'getRecords', 'clearSelectRow', 'setCurrentRow', 'clearSelection', 'toggleRowSelection', 'toggleAllSelection', 'clearSort', 'clearFilter', 'setActiveRow', 'setActiveCell', 'setSelectCell', 'computeWidth', 'isScrollYLoad', 'exportCsv'];
...
// CONCATENATED MODULE: ./packages/table-config/index.js



src_config.install = function (Vue) {
  Vue.component(src_config.name, src_config);
};

/* harmony default export */ var table_config = (src_config);
// CONCATENATED MODULE: ./packages/table/src/excel.js
...
var components = [packages_table, table_column, table_config, packages_excel];

...
/* harmony default export */ var table = ({
  ...
  computed: {
     ...
     * 如果存在筛选条件，继续处理
     */
    afterFullData: function afterFullData() {
  ...
  methods: {
    ...
    getTableData: function getTableData() {
      ...
      var fullData = this.afterFullData;
      return {
        fullData: fullData,
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this8.triggerCheckRowEvent({}, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        var tableBody = _this13.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this13.$refs.tableFooter;
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this14.$refs,
            tableData = _this14.tableData,
            editRules = _this14.editRules;
        ...
        if (scope && $refs.tableBody && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
          ...
          if (cell) {
            return _this14.validCellRules('change', row, column).then(function () {
              return _this14.clearValidate();
            }).catch(function (rule) {
              return _this14.handleValidError({
                rule: rule,
                row: row,
                column: column,
                cell: cell
...
/* harmony default export */ var grid = ({
  ...
  methods: _objectSpread({}, methods, {
    buildColumn: function buildColumn() {
      var $table = this.$refs.xTable;
      $table.collectColumn = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.mapTree(this.columns, function (column) {
        return src_cell.createColumn($table, column);
      }, this.treeConfig);
    },

...
var CellMethods = {
  ...
  renderIndexCell: function renderIndexCell(h, params) {
    ...
    var seq = params.seq,
        level = params.level;
    return [utils.formatText(indexMethod ? indexMethod(params) : level ? "".concat(level, ".").concat(seq) : startIndex + seq)];
  },
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    // 更新数据真实的索引 Map
    updateCacheMap: function updateCacheMap(datas, key) {
      var indexMap = this["".concat(key, "IndexMap")];
      var keyMap = this["".concat(key, "KeyMap")];
    ...
    reloadCustoms: function reloadCustoms(customColumns) {
      ...
      return this.$nextTick().then(function () {
        _this6.mergeCustomColumn(customColumns);

        return _this6.refreshColumn().then(function () {
          return _this6.tableFullColumn;
        });
      });
    },
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            this.$nextTick(function () {
              var ctxElem = _this9.$refs.ctxWrapper.$el;
    ...
    ctxMenuLinkEvent: function ctxMenuLinkEvent(evnt, menu) {
      if (!menu.disabled && (!menu.children || !menu.children.length)) {
        utils.emitEvent(this, 'context-menu-click', [Object.assign({
          menu: menu
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this11.triggerCheckRowEvent({}, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
          ...
          if (!actived.args || evnt.currentTarget !== actived.args.cell) {
            ...
            if (editConfig.mode === 'row') {
              ...
              this.triggerValidate('blur').then(function () {}).catch(function (e) {
                ...
                _this12.handleActived(params, evnt).then(function () {
                  return _this12.triggerValidate('change');
                }).catch(function (e) {
                  return e;
                });
              }); // }
      ...
      if (editRender) {
        if (editConfig.mode === 'row' ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this13.handleFocus(params, evnt);
            });
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          _this14.clearChecked(evnt);

          _this14.clearActived(evnt);
        ...
        if (mouseConfig.checked) {
          ...
          _this14.handleChecked(select, select, evnt);
        }
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        var tableBody = _this15.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this15.$refs.tableFooter;
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this16.$refs,
            tableData = _this16.tableData,
            editRules = _this16.editRules;
        ...
        if (scope && $refs.tableBody && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
          ...
          if (_this16.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = dom.getCell(_this16, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
            ...
            if (cell) {
              return _this16.validCellRules(type, row, column).then(function () {
                return _this16.clearValidate();
              }).catch(function (rule) {
                return _this16.openValidTooltip({
                  rule: rule,
                  row: row,
                  column: column,
                  cell: cell
                  ...
                  if ((type === 'all' || !rule.trigger || type === rule.trigger) && (isRequired || value || rule.validator)) {
                    if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                      rule.validator(rule, value, function (e) {
                        ...
                        row: row,
                        column: column,
                        rowIndex: _this19.getRowMapIndex(row),
                        columnIndex: _this19.getColumnMapIndex(column)
                      });
                    } else {
                      var restVal;
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this20.openValidTooltip(params);
      });
    },
...
/* harmony default export */ var src_toolbar = ({
  ...
  computed: {
    ...
    isCustomStorage: function isCustomStorage() {
  ...
  created: function created() {
    ...
    var isCustomStorage = this.isCustomStorage,
        id = this.id,
  ...
  methods: {
    ...
    getStorageMap: function getStorageMap() {
      ...
      var rest = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toStringJSON(localStorage.getItem('VXE_TOOLBAR_CUSTOMS'));
      return rest && rest.version === version ? rest : {
        version: version
      };
    },
    saveStorageMap: function saveStorageMap() {
      var id = this.id,
          tableCustoms = this.tableCustoms,
          isCustomStorage = this.isCustomStorage;
      ...
      if (isCustomStorage) {
        ...
        localStorage.setItem('VXE_TOOLBAR_CUSTOMS', external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.toJSONString(customStorageMap));
      }
    },
...
var methods = {};
var propKeys = Object.keys(src_props);

...
function renderColumn(h, _vm, $table, seq, fixedType, rowLevel, row, rowIndex, column, columnIndex) {
  ...
  var fixedHiddenColumn = fixedType ? column.fixed !== fixedType : column.fixed;
...
/* harmony default export */ var body = ({
  ...
  render: function render(h) {
     ...
     * 内容
     */
    h('tbody', renderRows(h, this, $table, 0, fixedType, tableData, tableColumn))]), !loading && !tableData.length ? h('div', {
  ...
  methods: {
    ...
    checkSelectionStatus: function checkSelectionStatus() {
      var tableFullData = this.tableFullData,
          selection = this.selection,
          treeConfig = this.treeConfig;
      this.isAllSelected = selection.length && (treeConfig ? tableFullData.every(function (item) {
        return selection.indexOf(item) > -1;

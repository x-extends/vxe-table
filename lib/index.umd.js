...
var Tools = {
  ...
  getDocScrollLeft: function getDocScrollLeft() {
...
function renderColumn(h, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  return h('td', {
    class: ['vxe-body--column', (_ref = {}, _defineProperty(_ref, "col--".concat(align), align), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _ref)],
...
// EXTERNAL MODULE: ./packages/radio/index.js
var packages_radio = __webpack_require__("2bea");
var radio_default = /*#__PURE__*/__webpack_require__.n(packages_radio);
...
/* harmony default export */ var header = ({
  ...
  render: function render(h) {
     ...
     * 头部
     */
    h('thead', headerColumn.map(function (cols) {
      return h('tr', {
        ...
        return column.visible ? h('th', {
          class: ['vxe-header-column', (_ref = {}, _defineProperty(_ref, "col--".concat(column.headerAlign), column.headerAlign), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _ref)],
          attrs: {
...
window.addEventListener('click', GlobalEvent.trigger, false); // window.addEventListener(wheelName, GlobalEvent.trigger, false)
...
/* harmony default export */ var table = ({
  ...
  render: function render(h) {
    ...
    }, '全部')])].concat(filterStore.options.map(function (item, index) {
      return h('li', {
        class: ['vxe-table--filter-option'],
        key: index
      }, [h('vxe-checkbox', {
  ...
  methods: {
    ...
    handleGlobalClickEvent: function handleGlobalClickEvent(evnt) {
      if (this.hasEventTargetNode(evnt, this.$el, 'vxe-filter-wrapper')) {// 如果点击了筛选按钮
      } else if (this.hasEventTargetNode(evnt, this.$refs.filterWrapper)) {// 如果点击筛选容器
      } else {
        this.clostFilter();
      }
    },
     ...
     * 检查触发源是否属于目标节点
     */
    hasEventTargetNode: function hasEventTargetNode(evnt, container, cls) {
      var flag;
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.visible) {
        ...
        var top = evnt.clientY + tools.getDocScrollTop();
        var left = evnt.clientX + tools.getDocScrollLeft();
    ...
    confirmFilterEvent: function confirmFilterEvent(evnt) {
      var _this$filterStore = this.filterStore,
          ...
          column = _this$filterStore.column,
          options = _this$filterStore.options;
      ...
      if (isAllSelected || isIndeterminate) {
        if (isAllSelected) {
          ...
          if (column.filterMethod) {} else {
            this.tableData = this.tableFullData.filter(function (row) {
              return valueList.indexOf(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, property)) > -1;
            });
          }
        }
...
/* harmony default export */ var src_column = ({
  ...
  created: function created() {
    ...
    switch (this.type) {
      ...
      default:
        if (this.filters && this.filters.length && this.sortable) {} else if (this.sortable) {

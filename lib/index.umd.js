...
function () {
  function ColumnConfig($table, _vm) {
    ...
    Object.assign(this, {
      ...
      params: _vm.params,
      // 渲染属性
      visible: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isBoolean(_vm.visible) ? _vm.visible : true,
      checked: false,
      disabled: false,
      level: 1,
      rowSpan: 1,
...
function renderFixed(h, $table, fixedType) {
  ...
  var style = {
    ...
    }, isRightFixed ? scrollbarWidth : 0) - (border === true ? 1 : 0), "px")
  };
  return h('div', {
...
/* harmony default export */ var table = ({
    ...
    collectColumn: function collectColumn(value) {
      ...
      this.refreshColumn().then(function () {
        if (_this2.scrollXLoad) {
          _this2.updateVirtualScrollX(true);
        }
      });
  ...
  methods: {
    ...
    */
    ...
    getRangeResult: function getRangeResult(targetTrElem, moveRange) {
      var countHeight = 0;
      var rangeRows = [];
    ...
    handleCheckboxRangeEvent: function handleCheckboxRangeEvent(evnt, params) {
      ...
      if (['checkbox', 'selection'].indexOf(column.type) > -1) {
        ...
        document.onmousemove = function (evnt) {
          ...
          var rangeRows = _this35.getRangeResult(trEleme, evnt.clientY - absPos.top);
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    columnIndex: _this57.getColumnIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
                  ...
                  } else if (isNumber && isNaN(cellValue) || rule.pattern && !(rule.pattern.test ? rule.pattern : new RegExp(rule.pattern)).test(cellValue) || external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isNumber(rule.min) && (isNumber ? restVal < rule.min : len < rule.min) || external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isNumber(rule.max) && (isNumber ? restVal > rule.max : len > rule.max)) {
                    errorRules.push(new table_Rule(rule));
                  }
...
/* harmony default export */ var grid = ({
  ...
  watch: {
    ...
    pagerConfig: function pagerConfig(value) {
      this.initPages();
    }
  },
  created: function created() {
            ...
            if (_ajaxMethods) {
              ...
              this.remove(selectRecords).then(function () {
                ...
                if (removeRecords.length) {
                  ...
                  return (beforeDelete || _ajaxMethods).apply(_this4, [{
                    $grid: _this4,
                    code: code,
                    body: body,
                ...
                _this4.validate(body.insertRecords.concat(updateRecords), function (vaild) {
                  if (vaild) {
                    if (body.insertRecords.length || removeRecords.length || updateRecords.length || body.pendingRecords.length) {
                      _this4.tableLoading = true;
                      resolve((beforeSave || _ajaxMethods2).apply(_this4, [{
                        $grid: _this4,
                        code: code,
                        body: body,

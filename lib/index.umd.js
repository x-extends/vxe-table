  ...
  methods: {
    ...
    loadColumn: function loadColumn(columns) {
      ...
      this.collectColumn = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.mapTree(columns, function (column) {
        return packages_cell.createColumn(_this5, column);
      }, headerProps);
      return this.$nextTick();
    },
    ...
    isUpdateByRow: function isUpdateByRow(row, field) {
      ...
      if (treeConfig) {
        ...
        var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableSourceData, function (item) {
          return rowid === UtilTools.getRowid(_this13, item);
        }, treeConfig);
      ...
      if (editRules) {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            DomTools.toView(_this39.$el);

            if (treeConfig) {
              _this39.scrollToTreeRow(locatRow).then(finish);
            } else {
              _this39.scrollToRow(locatRow).then(finish);
            }
          });
        });
      } else {
    ...
    importData: function importData(callback) {
      var _this$$refs3 = this.$refs,
          impForm = _this$$refs3.impForm,
          impInput = _this$$refs3.impInput;
        ...
        if (getFileTypes().includes(type)) {
          this.preventEvent(evnt, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this43, e.target.result.trim(), options);
            };
...
/* harmony default export */ var src_toolbar = ({
  ...
  render: function render(h) {
    ...
    }))])]) : null]), v_x_e_table._export ? h('vxe-export-panel', {
      props: {
  ...
  if (bodyNodes.length) {
    ...
    if (tableNodes.length) {
      ...
      if (theadNodes.length) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(theadNodes[0].getElementsByTagName('tr'), function (rowNode) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(rowNode.getElementsByTagName('th'), function (cellNode) {
        ...
        if (tbodyNodes.length) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(tbodyNodes[0].getElementsByTagName('tr'), function (rowNode) {
            var item = {};
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(rowNode.getElementsByTagName('td'), function (cellNode, colIndex) {
...
function parseXML(columns, content) {
  ...
  if (sheetNodes.length) {
    ...
    if (tableNodes.length) {
      ...
      if (rowNodes.length) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(rowNodes[0].getElementsByTagName('Cell'), function (cellNode) {
          var field = cellNode.textContent;

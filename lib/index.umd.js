        ...
        switch (item.code) {
          ...
          case 'delete_rows':
            ...
            if (selectRecords.length) {
              $grid.openConfirm(conf.i18n('vxe.grid.removeSelectRecord')).then(function () {
                return $grid.removeSelecteds();
              }).catch(function (e) {
                return e;
              });
            } else {
              $grid.openAlert(conf.i18n('vxe.grid.selectOneRecord')).catch(function (e) {
                return e;
              });
            }
  ...
  render: function render(h) {
    ...
    if (proxyConfig) {
      ...
      if (proxyConfig.alert) {
        alertProps = assign_default()({}, proxyConfig.alert, {
    ...
    return h('div', {
      ...
      props: assign_default()({
        size: vSize
      }, proxyConfig ? tablePage : {}, pageConfig),
      on: {
        'current-change': this.currentChangeEvent,
        'size-change': this.sizeChangeEvent
      }
    }) : null, proxyConfig && proxyConfig.alert ? h('vxe-alert', {
      props: alertProps,
  ...
  methods: _objectSpread({}, methods, {
              ...
              if (ajax.delete) {
                ...
                return this.validate().then(function () {
                  ...
                  if (removeRecords.length) {
                    ...
                    _this3.openAlert(conf.i18n('vxe.grid.selectOneRecord')).catch(function (e) {
                      return e;
                    });
                  }
                });
              ...
              if (ajax.save) {
                return this.validate().then(function () {
                  ...
                  if (insertRecords.length || removeRecords.length || updateRecords.length || pendingRecords.length) {
                    ...
                    _this3.openAlert(conf.i18n('vxe.grid.dataUnchanged')).catch(function (e) {
                      return e;
                    });
                  }
                });
    ...
    triggerPendingEvent: function triggerPendingEvent(evnt) {
      ...
      if (selectRecords.length) {
        ...
        this.openAlert(conf.i18n('vxe.grid.selectOneRecord')).catch(function (e) {
          return e;
        });
      }
    },
    ...
    openAlert: function openAlert(message, type) {
      var _this4 = this;
    ...
    openConfirm: function openConfirm(message) {
      ...
      return h('li', {
        ...
        on: {
          click: function click() {
            return _this.sizeChangeEvent(num);
          }
        }

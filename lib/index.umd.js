...
function getFormEvents(renderOpts, params, context) {
  ...
  var on = _defineProperty({}, type, function (evnt) {
    external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(data, property, evnt.target.value);
...
var Cell = {
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    })].concat(labelField ? slots && slots.default ? slots.default(params, h) : [external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, labelField)] : []))];
  },
...
/* harmony default export */ var table = ({
  ...
  render: function render(h) {
    ...
    h('div', {
      ...
      $table: this
    }, h) : conf.i18n('vxe.table.emptyText'))]),
    /**
     * 边框线
     */
    h('div', {
  ...
  methods: {
    ...
    refreshData: function refreshData() {
      ...
      return this.$nextTick().then(function () {
        _this7.tableData = [];
        return _this7.$nextTick().then(function () {
          return _this7.loadTableData(_this7.tableFullData);
        });
      });
    },
    ...
    loadTableData: function loadTableData(datas) {
      ...
      return this.computeScrollLoad().then(function () {
        // 是否加载了数据
        _this8.isLoadData = true;

        _this8.computeRowHeight();

        _this8.handleReserveStatus();

        _this8.checkSelectionStatus();

        return _this8.$nextTick().then(_this8.recalculate).then(_this8.refreshScroll);
      });
    },
    ...
    reloadData: function reloadData(datas) {
      ...
      return this.clearAll().then(function () {
        _this9.inited = true;
        return _this9.loadTableData(datas);
    ...
    loadColumn: function loadColumn(columns) {
      ...
      this.collectColumn = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.mapTree(columns, function (column) {
        return packages_cell.createColumn(_this10, column);
      }, headerProps);
      return this.$nextTick();
    },
    ...
    updateCache: function updateCache(source) {
      ...
      var handleCache = function handleCache(row, index) {
        var rowid = UtilTools.getRowid(_this11, row);
    ...
    appendTreeCache: function appendTreeCache(row, childs) {
      ...
      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(childs, function (row, index) {
        var rowid = UtilTools.getRowid(_this12, row);
      ...
      if (tr) {
        ...
        if (treeConfig) {
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableFullData, function (row) {
            return UtilTools.getRowid(_this13, row) === rowid;
          }, treeOpts);
    ...
    */
    ...
    createData: function createData(records) {
      ...
      return this.$nextTick().then(function () {
        return records.map(_this15.defineField);
      });
    },
      ...
      if (keepSource) {
        ...
        if (treeConfig) {
          ...
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableSourceData, function (item) {
            return rowid === UtilTools.getRowid(_this19, item);
          }, treeOpts);
    ...
    reloadCustoms: function reloadCustoms(customColumns) {
      ...
      return this.$nextTick().then(function () {
        _this20.mergeCustomColumn(customColumns);

        return _this20.refreshColumn().then(function () {
          return _this20.tableFullColumn;
        });
      });
    },
    ...
    refreshScroll: function refreshScroll() {
      ...
      return this.$nextTick().then(function () {
        if (lastScrollLeft || lastScrollTop) {
          // 重置最后滚动状态
          _this22.lastScrollLeft = 0;
          _this22.lastScrollTop = 0; // 还原滚动状态

          return _this22.scrollTo(lastScrollLeft, lastScrollTop);
        }
      });
    },
      ...
      if (bodyElem) {
        ...
        if (refull === true) {
          ...
          return this.computeScrollLoad().then(function () {
            ...
            _this23.autoCellWidth(headerElem, bodyElem, footerElem, bodyWidth);

            _this23.computeScrollLoad();
          });
        }
      }
    ...
    preventEvent: function preventEvent(evnt, type, args, next, end) {
      ...
      if (!evntList.some(function (func) {
        return func(args, evnt, _this24) === false;
      })) {
        if (next) {
          rest = next();
        }
        ...
        if (!(editOpts.autoClear === false)) {
          if (validTip && DomTools.getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clearActived', actived.args, function () {
              ...
              !DomTools.getEventTargetNode(evnt, _this25.$el).flag) {
                // this.triggerValidate('blur').then(a => {
                // 保证 input 的 change 事件能先触发之后再清除
                setTimeout(function () {
                  return _this25.clearActived(evnt);
                }); // }).catch(e => e)
              }
            });
          }
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (this.isActivated) {
        this.preventEvent(evnt, 'event.keydown', {
          ...
          var params;
          var isCtxMenu = _this26.isCtxMenu,
              ctxMenuStore = _this26.ctxMenuStore,
              editStore = _this26.editStore,
              _this26$mouseConfig = _this26.mouseConfig,
              mouseConfig = _this26$mouseConfig === void 0 ? {} : _this26$mouseConfig,
              _this26$keyboardConfi = _this26.keyboardConfig,
              keyboardConfig = _this26$keyboardConfi === void 0 ? {} : _this26$keyboardConfi,
              treeConfig = _this26.treeConfig,
              treeOpts = _this26.treeOpts,
              highlightCurrentRow = _this26.highlightCurrentRow,
              currentRow = _this26.currentRow;
          ...
          if (isEsc) {
            ...
            _this26.closeFilter(); // 如果是激活编辑状态，则取消编辑


            if (actived.row) {
              params = actived.args;

              _this26.clearActived(evnt); // 如果配置了选中功能，则为选中状态


              if (mouseConfig.selected) {
                _this26.handleSelected(params, evnt);
              }
            }
            ...
            if (selected.column.type === 'checkbox' || selected.column.type === 'selection') {
              _this26.handleToggleCheckRowEvent(selected.args, evnt);
            } else {
              _this26.triggerRadioRowEvent(evnt, selected.args);
            }
          } else if (isEnter && keyboardConfig.isEnter && (selected.row || actived.row || treeConfig && highlightCurrentRow && currentRow)) {
            // 如果是激活状态，退则出到下一行
            if (selected.row || actived.row) {
              _this26.moveSelected(selected.row ? selected.args : actived.args, isLeftArrow, isUpArrow, isRightArrow, true, evnt);
              ...
              if (childrens && childrens.length) {
                ...
                _this26.setTreeExpansion(currentRow, true).then(function () {
                  return _this26.scrollToRow(targetRow);
                }).then(function () {
            ...
            if (ctxMenuStore.showChild && UtilTools.hasChildrenList(ctxMenuStore.selected)) {
              _this26.moveCtxMenu(evnt, keyCode, ctxMenuStore, 'selectChild', 37, false, ctxMenuStore.selected.children);
            } else {
              _this26.moveCtxMenu(evnt, keyCode, ctxMenuStore, 'selected', 39, true, _this26.ctxMenuList);
            }
          } else if (isF2) {
            // 如果按下了 F2 键
            if (selected.row && selected.column) {
              ...
              _this26.handleActived(selected.args, evnt);
            }
          } else if (operArrow && keyboardConfig.isArrow) {
            // 如果按下了方向键
            if (selected.row && selected.column) {
              _this26.moveSelected(selected.args, isLeftArrow, isUpArrow, isRightArrow, isDwArrow, evnt);
            } else if ((isUpArrow || isDwArrow) && highlightCurrentRow && currentRow) {
              // 当前行按键上下移动
              _this26.moveCurrentRow(isUpArrow, isDwArrow, evnt);
            }
          } else if (isTab && keyboardConfig.isTab) {
            // 如果按下了 Tab 键切换
            if (selected.row || selected.column) {
              _this26.moveTabSelected(selected.args, isShiftKey, evnt);
            } else if (actived.row || actived.column) {
              _this26.moveTabSelected(actived.args, isShiftKey, evnt);
            }
            ...
            if (keyboardConfig.isDel && (selected.row || selected.column)) {
              ...
              // 如果树形表格回退键关闭当前行返回父节点
              var _XEUtils$findTree = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(_this26.afterFullData, function (item) {
              ...
              if (parentRow) {
                ...
                _this26.setTreeExpansion(parentRow, false).then(function () {
                  return _this26.scrollToRow(parentRow);
                }).then(function () {
                  return _this26.triggerCurrentRowEvent(evnt, params);
                });
              }
            ...
            // 如果开启复制功能
            if (isX || isC) {
              _this26.handleCopyed(isX, evnt);
            } else {
              _this26.handlePaste(evnt);
            }
    ...
    moveCurrentRow: function moveCurrentRow(isUpArrow, isDwArrow, evnt) {
      ...
      if (targetRow) {
        ...
        this.scrollToRow(targetRow).then(function () {
          return _this27.triggerCurrentRowEvent(evnt, params);
        });
      }
    },
    // 处理方向键移动
          ...
          this.preventEvent(evnt, 'event.showMenu', params, null, function () {
            if (!visibleMethod || visibleMethod(params, evnt)) {
              ...
              _this28.$nextTick(function () {
                var ctxElem = _this28.$refs.ctxWrapper.$el;
    ...
    handleTargetLeaveEvent: function handleTargetLeaveEvent(evnt) {
      ...
      if (tooltipOpts.enterable) {
        this.tooltipTimeout = setTimeout(function () {
          if (!_this30.$refs.tooltip.isHover) {
            _this30.clostTooltip();
          }
        }, tooltipOpts.leaveDelay);
      } else {
        this.clostTooltip();
          ...
          if (value === -1) {
            ...
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree([row], function (item, $rowIndex) {
              if (row === item || !checkMethod || checkMethod({
                ...
                _this32.handleSelectReserveRow(row, value);
              }
            }, treeOpts);
        ...
        if (reserve) {
          if (value) {
            selectRows.forEach(function (row) {
              selectReserveRowMap[UtilTools.getRowid(_this33, row)] = row;
            });
          } else {
            afterFullData.forEach(function (row) {
              var rowid = UtilTools.getRowid(_this33, row);
    ...
    handleReserveByRowid: function handleReserveByRowid(list, rest) {
      ...
      list.forEach(function (row) {
        var rowid = UtilTools.getRowid(_this34, row);
    ...
    handleCheckboxRangeEvent: function handleCheckboxRangeEvent(evnt, params) {
      ...
      if (['checkbox', 'selection'].indexOf(column.type) > -1) {
        ...
        document.onmousemove = function (evnt) {
          ...
          var rangeRows = _this35.getCheckboxRangeResult(trEleme, evnt.clientY - absPos.top);
          ...
          checkboxRangeElem.style.zIndex = "".concat(_this35.tZindex); // 至少滑动 10px 才能有效匹配
          ...
          if (rangeHeight > 10 && rangeRows.length !== lastRangeRows.length) {
            ...
            if (evnt.ctrlKey) {
              rangeRows.forEach(function (row) {
                _this35.handleSelectRow({
                  row: row
                }, selectRecords.indexOf(row) === -1);
              });
            } else {
              _this35.clearCheckboxRow();

              _this35.setCheckboxRow(rangeRows, true);
            }
          }
        };
      ...
      if (editRender && cell) {
        if (mode === 'row' ? actived.row !== row : actived.row !== row || actived.column !== column) {
          ...
          if (!activeMethod || activeMethod(params)) {
            ...
            this.$nextTick(function () {
              _this38.handleFocus(params, evnt);
            });
          }
      ...
      var selectMethod = function selectMethod() {
        if ((isMouseSelected || isMouseChecked) && (selected.row !== row || selected.column !== column)) {
          if (actived.row !== row || (editOpts.mode === 'cell' ? actived.column !== column : false)) {
            _this39.clearChecked(evnt);

            _this39.clearActived(evnt);
            ...
            if (isMouseChecked) {
              ...
              _this39.handleChecked(select, select, evnt);
            }
          }
        }

        return _this39.$nextTick();
    ...
    setActiveCell: function setActiveCell(row, field) {
      ...
      return this.scrollToRow(row).then(function () {
        if (row && field) {
          var column = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.find(_this40.visibleColumn, function (column) {
            return column.property === field;
          });
          ...
          if (column && column.editRender) {
            ...
            if (cell) {
              _this40.handleActived({
                row: row,
                rowIndex: _this40.getRowIndex(row),
                column: column,
                columnIndex: _this40.getColumnIndex(column),
                cell: cell,
                $table: _this40
              });

              _this40.lastCallTime = Date.now();
            }
          }
        }
    ...
    reloadExpandContent: function reloadExpandContent(row) {
      ...
      if (lazy && expandLazyLoadeds.indexOf(row) === -1) {
        this.clearRowExpandLoaded(row).then(function () {
          return _this41.handleAsyncRowExpand(row);
        });
      }
    ...
    handleAsyncRowExpand: function handleAsyncRowExpand(row) {
      ...
      return new Promise(function (resolve) {
        _this42.expandLazyLoadeds.push(row);

        _this42.expandOpts.loadMethod({
          $table: _this42,
          row: row
        }).catch(function (e) {
          return e;
          ...
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.remove(_this42.expandLazyLoadeds, function (item) {
            return item === row;
          });

          _this42.rowExpandeds.push(row);

          resolve(_this42.$nextTick().then(_this42.recalculate));
        });
      });
    },
        ...
        if (expanded) {
          rows.forEach(function (row) {
            if (rowExpandeds.indexOf(row) === -1) {
              ...
              if (isLoad) {
                result.push(_this43.handleAsyncRowExpand(row));
              } else {
    ...
    clearRowExpand: function clearRowExpand() {
      ...
      this.rowExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this44.recalculate() : 0;
      });
    },
    ...
    reloadTreeChilds: function reloadTreeChilds(row) {
      ...
      if (lazy && row[hasChild] && treeLazyLoadeds.indexOf(row) === -1) {
        this.clearTreeExpandLoaded(row).then(function () {
          return _this45.handleAsyncTreeExpandChilds(row);
        });
      }
      ...
      return new Promise(function (resolve) {
        ...
        loadMethod({
          ...
          if (childs) {
            ...
            _this46.appendTreeCache(row, childs);
            ...
            if (_this46.isCheckedByCheckboxRow(row)) {
              _this46.setCheckboxRow(childs, true);
            }
          }
      ...
      if (expanded) {
        if (lazy) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, function (row) {
            _this47.setTreeExpansion(row, true);
          }, treeOpts);
        } else {
          var treeExpandeds = [];
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableFullData, function (row) {
          ...
          if (expanded) {
            rows.forEach(function (row) {
              if (treeExpandeds.indexOf(row) === -1) {
                ...
                if (isLoad) {
                  result.push(_this48.handleAsyncTreeExpandChilds(row));
                } else {
    ...
    clearTreeExpand: function clearTreeExpand() {
      ...
      this.treeExpandeds = [];
      return this.$nextTick().then(function () {
        return isExists ? _this49.recalculate() : 0;
      });
    },
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var vSize = _this50.vSize,
            scrollXLoad = _this50.scrollXLoad,
            scrollYLoad = _this50.scrollYLoad,
            scrollYStore = _this50.scrollYStore,
            scrollXStore = _this50.scrollXStore,
            visibleColumn = _this50.visibleColumn,
            optimizeOpts = _this50.optimizeOpts,
            rowHeightMaps = _this50.rowHeightMaps;
        var scrollX = optimizeOpts.scrollX,
            scrollY = optimizeOpts.scrollY;
        var tableBody = _this50.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableHeader = _this50.$refs.tableHeader;
        ...
        if (tableBodyElem) {
          ...
          if (scrollXLoad) {
            ...
            _this50.updateScrollXData();
          } else {
            _this50.updateScrollXSpace();
          } // 计算 Y 逻辑
          ...
          if (scrollYLoad) {
            ...
            _this50.updateScrollYData();
          } else {
            _this50.updateScrollYSpace();
          }
        }

        return _this50.$nextTick();
      });
    },
      ...
      if (treeConfig) {
        ...
        if (matchObj) {
          ...
          nodes.forEach(function (row, index) {
            if (index < nodes.length - 1 && !_this52.hasTreeExpand(row)) {
              _this52.setTreeExpansion(row, true);
            }
          });
        }
      }
    ...
    clearScroll: function clearScroll() {
      ...
      return this.$nextTick().then(function () {
        ...
        return new Promise(function (resolve) {
          return setTimeout(function () {
            return resolve(_this53.$nextTick());
          });
        });
      });
    },
    ...
    updateStatus: function updateStatus(scope, cellValue) {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this54.$refs,
            tableData = _this54.tableData,
            editRules = _this54.editRules,
            validStore = _this54.validStore;
        ...
        if (scope && $refs.tableBody && editRules) {
          ...
          if (_this54.hasCellRules(type, row, column)) {
            var rowIndex = tableData.indexOf(row);
            var cell = DomTools.getCell(_this54, {
              row: row,
              rowIndex: rowIndex,
              column: column
            });
            ...
            if (cell) {
              return _this54.validCellRules(type, row, column, cellValue).then(function () {
                if (customVal && validStore.visible) {
                  UtilTools.setCellValue(row, column, cellValue);
                }

                _this54.clearValidate();
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this56.validCellRules('all', row, column).then(resolve).catch(function (_ref7) {
                  var rule = _ref7.rule,
                      rules = _ref7.rules;
                  var rest = {
                    rule: rule,
                    rules: rules,
                    rowIndex: _this56.getRowIndex(row),
                    row: row,
                    columnIndex: columnIndex,
                    column: column,
                    $table: _this56
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var posAndFinish = function posAndFinish() {
              params.cell = DomTools.getCell(_this56, params);

              _this56.handleValidError(params);
            ...
            DomTools.toView(_this56.$el);

            if (_this56.validOpts.autoPos === false) {
              finish();
            } else {
              if (treeConfig) {
                _this56.scrollToTreeRow(locatRow).then(posAndFinish);
              } else {
                _this56.scrollToRow(locatRow).then(posAndFinish);
              }
            }
          });
        });
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  ...
                  rule.validator(rule, cellValue, function (e) {
                    ...
                    row: row,
                    column: column
                  }, _defineProperty(_rule$validator, "".concat(treeConfig ? '$' : '', "rowIndex"), _this57.getRowIndex(row)), _defineProperty(_rule$validator, "columnIndex", _this57.getColumnIndex(column)), _rule$validator));
                } else {
    ...
    handleValidError: function handleValidError(params) {
      ...
      if (this.validOpts.autoPos === false) {
        ...
        this.handleActived(params, {
          ...
          return _this58.showValidTooltip(params);
        });
      }
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        Object.assign(_this59.validStore, {
          row: row,
          column: column,
          rule: rule,
          content: content,
        ...
        UtilTools.emitEvent(_this59, 'valid-error', [params]);
      });
    },
        ...
        if (types.indexOf(type) > -1) {
          this.preventEvent(null, 'event.import', {
            ...
            reader.onload = function (e) {
              ExportTools.handleImport(_this60, e.target.result.trim(), options);
            };
    ...
    importData: function importData(options) {
      ...
      var rest = new Promise(function (resolve, reject) {
        _this61._importResolve = resolve;
        _this61._importReject = reject;
      });
      this.readFile(opts).then(function (evnt) {
        return _this61.importByFile(evnt.target.files[0], opts);
      }).catch(function (evnt) {
        _this61._importReject(evnt);

        _this61._importReject = null;
      });
      return rest;
    },
    readFile: function readFile() {
      ...
      fileInput.onchange = function (evnt) {
        ...
        if (types.indexOf(type) > -1) {
          ...
          _this62._fileReject(evnt);
        }

        _this62._fileResolve = null;
      };

      fileForm.reset();
      fileInput.click();
      return new Promise(function (resolve, reject) {
        _this62._fileResolve = resolve;
        _this62._fileReject = reject;
      });
    },
  ...
  methods: {
    renderOptions: function renderOptions(h, filterRender, compConf) {
      ...
      if (slots && slots.filter) {
        ...
        }, slots.filter.call($table, Object.assign({
          $table: $table,
          context: this
        }, args), h))];
...
function renderFormContent(h, _vm) {
  ...
  var compConf = formRender ? v_x_e_table.renderer.get(formRender.name) : null;

  if (compConf && compConf.renderForm) {
    return compConf.renderForm.call(_vm, h, formRender, {
...
function renderBtn(h, _vm, compConf) {
  ...
  if (compConf && compConf.renderButtons) {
    return compConf.renderButtons.call(_vm, h, rConfig, {
      data: data
    }, {
      $grid: $grid,
      $table: $table
...
function renderRightTool(h, _vm, compConf) {
  ...
  if (compConf && compConf.renderTools) {
    return compConf.renderTools.call(_vm, h, rConfig, comp ? comp.params : null, {
      $grid: $grid,
      $table: $table
    });
  }
...
/* harmony default export */ var src_toolbar = ({
  ...
  render: function render(h) {
    ...
    var compConf = rConfig ? v_x_e_table.renderer.get(rConfig.name) : null;
...
/* harmony default export */ var src_form = ({
  ...
  methods: {
    loadForm: function loadForm() {
      if (this.data) {
        this.sourceData = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.clone(this.data, true);
      }
    },
    ...
    resetEvent: function resetEvent(evnt) {
      ...
      if (data) {
        this.$children.forEach(function (_ref2) {
          ...
          if (field) {
            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(data, field, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(sourceData, field, null));
          }
        });
      }
...
/* harmony default export */ var form_item = ({
  ...
  render: function render(h) {
    ...
    }, UtilTools.getFuncText(title)) : null, h('div', {
...
var components = [packages_table, packages_column, packages_header, packages_body, packages_footer, packages_filter, packages_loading, packages_grid, packages_excel, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_button, packages_modal, packages_tooltip, packages_form, packages_export, packages_resize]; // 默认安装

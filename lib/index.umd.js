...
function renderBtn(h, _vm, compConf) {
  ...
  if (compConf && compConf.renderButtons) {
    return compConf.renderButtons.call(_vm, h, extraSlots, comp ? comp.params : null, {
      $grid: $grid,
      $table: $table
    });
  }
...
function renderRightTool(h, _vm, compConf) {
  ...
  if (compConf && compConf.renderTools) {
    return compConf.renderTools.call(_vm, h, extraSlots, comp ? comp.params : null, {
      $grid: $grid,
      $table: $table
    });
  }
...
/* harmony default export */ var create = (function (compName) {
  ...
  return {
    ...
    render: function render(h) {
      ...
      return h('div', {
        class: ["vxe-".concat(compName), (_ref3 = {}, _defineProperty(_ref3, "size--".concat(vSize), vSize), _defineProperty(_ref3, 'is--disabled', this.disabled), _ref3)]
      }, [h(compName, {

...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    triggerCellDBLClickEvent: function triggerCellDBLClickEvent(evnt, params) {
      ...
      if (editConfig) {
        if (editConfig.trigger === 'dblclick') {
          if (!actived.args || evnt.currentTarget !== actived.args.cell) {
            this.triggerValidate().then(function () {
              _this12.handleActived(params, evnt);
            }).catch(function (e) {
              return e;
            });
          }
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      return editRules ? this.triggerValidate().then(selectMethod).catch(function (e) {
        return e;
      }) : selectMethod();
    },
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        ...
        if (scope && $refs.tableBody && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
          ...
          if (cell) {
            return _this16.validCellRules('change', row, column).then(function () {
              return _this16.clearValidate();
            }).catch(function (rule) {
              return _this16.handleValidError({
                rule: rule,
                row: row,
                column: column,
                cell: cell
    ...
    validateRow: function validateRow(row, cb) {
      ...
      return new promise_default.a(function (resolve, reject) {
        _this17.validRowRules('all', row).then(function () {
          var valid = true;
      ...
      if (!external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(editRules)) {
        this.getColumns().forEach(function (column, columnIndex) {
          if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
            validPromise = validPromise.then(function () {
              return new promise_default.a(function (resolve, reject) {
                _this20.validCellRules('all', row, column).then(resolve).catch(function (rule) {
                  var rest = {
                    rule: rule,
                    row: row,
                    column: column,
                    cell: dom.getCell(_this20, {
                      row: row,
                      rowIndex: rowIndex,
                      column: column
                    })
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        _this22.$nextTick().then(function () {
        ...
        utils.emitEvent(_this22, 'valid-error', [params]);
      });
    },
...
/* harmony default export */ var grid = ({
  ...
  render: function render(h) {
    ...
    var toolbarProps = assign_default()({
      ...
      optimized: assign_default()({}, conf.optimized, optimized)
    }, toolbar);
...
function use(Plugin, options) {
  if (Plugin && Plugin.install) {
    if (installedPlugins.indexOf(Plugin) === -1) {
      Plugin.install(conf, interceptor, options);

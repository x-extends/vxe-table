...
var UtilTools = {
  ...
  getCellLabel: function getCellLabel(row, column, params) {
    ...
    if (params && formatter) {
      ...
      if (cacheFormat) {
        var formatData = $table.fullAllDataRowMap.get(row).formatData;
      ...
      if (cacheFormat) {
        $table.fullAllDataRowMap.get(row).formatData = {
          value: cellValue,
          label: cellLabel
        };
      }
...
var DomTools = {
  ...
  rowToVisible: function rowToVisible($table, row) {
    ...
    if (trElem) {
      ...
      var trOffsetTop = trElem.offsetTop;
  ...
  colToVisible: function colToVisible($table, column) {
    ...
    if (tdElem) {
      ...
      var trOffsetLeft = tdElem.offsetLeft;
      var trWidth = tdElem.clientWidth;
...
var Cell = {
  ...
  renderCell: function renderCell(h, params) {
    ...
    var editRender = _vm.editRender || column.editRender || _vm.cellRender || column.cellRender;
    ...
    if (editRender) {
      ...
      if (compConf && compConf.renderCell) {
        return compConf.renderCell.call($table, h, editRender, params, {
          $excel: $table.$parent,
          $table: $table,
          $column: column
        });
  ...
  runRenderer: function runRenderer(h, params, _vm, isEdit) {
    ...
    var editRender = _vm && _vm.editRender ? _vm.editRender : column.editRender;
    var compConf = Renderer.get(editRender.name);
  ...
  methods: {
    ...
    createRow: function createRow(record) {
      ...
      if (rowkey && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(recordItem, rowkey)) {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(recordItem, rowkey, getRowUniqueId());
      }
    ...
    handleGlobalKeydownEvent: function handleGlobalKeydownEvent(evnt) {
      ...
      if (isEsc) {
        ...
        if (selected.row || actived.row) {
          ...
          if (childrens && childrens.length) {
            this.setTreeExpansion(currentRow, true).then(function () {
              return _this16.setCurrentRow(childrens[0]);
            }).then(function () {
              return _this16.scrollToRow(childrens[0]);
            });
          }
        }
      } else if (operCtxMenu) {
        ...
        if (keyboardConfig.isDel && (selected.row || selected.column)) {
          ...
          // 如果树形表格回退键关闭当前行返回父节点
          var _XEUtils$findTree = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(this.getTableData().visibleData, function (item) {
          ...
          if (parentRow) {
            this.setTreeExpansion(parentRow, false).then(function () {
              return _this16.setCurrentRow(parentRow);
            }).then(function () {
    ...
    moveCurrentRow: function moveCurrentRow(isUpArrow, isDwArrow, evnt) {
      ...
      var currentRow = this.currentRow,
          treeConfig = this.treeConfig;
      var visibleData = this.getTableData().visibleData;
      var targetRow;
      evnt.preventDefault();

      if (treeConfig) {
        var _XEUtils$findTree2 = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(visibleData, function (item) {
          return item === currentRow;
        }, treeConfig),
        ...
        var rowIndex = visibleData.indexOf(currentRow);
      ...
      if (targetRow) {
        this.setCurrentRow(targetRow).then(function () {
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            this.$nextTick(function () {
              var ctxElem = _this18.$refs.ctxWrapper.$el;
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this19.handleSelectRow(null, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
    ...
    handleSelected: function handleSelected(params, evnt) {
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          _this23.clearChecked(evnt);

          _this23.clearActived(evnt);
        ...
        if (mouseConfig.checked) {
          ...
          _this23.handleChecked(select, select, evnt);
        }
    ...
    updateScrollYSpace: function updateScrollYSpace() {
      ...
      var _this$getTableData = this.getTableData(),
          visibleData = _this$getTableData.visibleData,
          ...
          columns.forEach(function (column, columnIndex) {
            if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
              colVailds.push(new Promise(function (resolve, reject) {
                _this29.validCellRules('all', row, column).then(resolve).catch(function (_ref10) {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (scrollYLoad) {
              ...
              var rowIndex = _this29.getRowIndex(params.row);
              ...
              if (type === 'all' || !rule.trigger || type === rule.trigger) {
                if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rule.validator)) {
                  rule.validator(rule, value, function (e) {
                    ...
                    columnIndex: _this30.getColumnMapIndex(column)
                  });
                } else {
                  var len;
                  var restVal = value;
...
function renderColumn(h, _vm, $table, $seq, seq, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex) {
  ...
  }, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(validStore.content) ? validStore.content.call($table, h) : UtilTools.getFuncText(validStore.content))]) : _e() : null, isMouseChecked && !fixedType ? h('span', {
...
/* harmony default export */ var src_tooltip = ({
  ...
  render: function render(h) {
    ...
    }, this.$slots.content || (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(message) ? message.call(this, h) : UtilTools.getFuncText(message))), h('div', {

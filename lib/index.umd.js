...
/* harmony default export */ var header = ({
  ...
  render: function render(h) {
    ...
    var resizable = $table.resizable,
        ...
        scrollYWidth = $table.scrollYWidth; // 如果是使用优化模式
...
function renderColumn(h, _vm, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  return h('td', {
    class: ['vxe-body--column', column.id, (_ref2 = {}, _defineProperty(_ref2, "col--".concat(align), align), _defineProperty(_ref2, 'col--edit', editRender), _defineProperty(_ref2, 'col--checked', isMouseChecked && !fixedType && checked.rows.indexOf(row) > -1 && checked.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--checked-top', isMouseChecked && !fixedType && checked.rows.indexOf(row) === 0 && checked.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--checked-bottom', isMouseChecked && !fixedType && checked.rows.indexOf(row) === checked.rows.length - 1 && checked.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--checked-left', isMouseChecked && !fixedType && checked.rows.indexOf(row) > -1 && checked.columns.indexOf(column) === 0), _defineProperty(_ref2, 'col--checked-right', isMouseChecked && !fixedType && checked.rows.indexOf(row) > -1 && checked.columns.indexOf(column) === checked.columns.length - 1), _defineProperty(_ref2, 'col--selected', isMouseSelected && editRender && selected.row === row && selected.column === column), _defineProperty(_ref2, 'col--copyed', isKeyboardCut && !fixedType && copyed.rows.indexOf(row) > -1 && copyed.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--copyed-top', isKeyboardCut && !fixedType && copyed.rows.indexOf(row) === 0 && copyed.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--copyed-bottom', isKeyboardCut && !fixedType && copyed.rows.indexOf(row) === copyed.rows.length - 1 && copyed.columns.indexOf(column) > -1), _defineProperty(_ref2, 'col--copyed-left', isKeyboardCut && !fixedType && copyed.rows.indexOf(row) > -1 && copyed.columns.indexOf(column) === 0), _defineProperty(_ref2, 'col--copyed-right', isKeyboardCut && !fixedType && copyed.rows.indexOf(row) > -1 && copyed.columns.indexOf(column) === copyed.columns.length - 1), _defineProperty(_ref2, 'col--actived', editRender && actived.row === row && actived.column === column), _defineProperty(_ref2, 'col--dirty', isDirty), _defineProperty(_ref2, 'edit--visible', editRender && editRender.type === 'visible'), _defineProperty(_ref2, 'fixed--hidden', fixedHiddenColumn), _ref2), cellClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(cellClassName) ? cellClassName({
      $table: $table,
      row: row,
      rowIndex: rowIndex,
      column: column,
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      var tableHeader = this.$refs.tableHeader; // 计算 X 逻辑
...
var methods = {};
var funs = ['reload', 'insert', 'insertAt', 'revert', 'remove', 'getRecords', 'getColumns', 'clearSelectRow', 'setCurrentRow', 'clearSelection', 'toggleRowSelection', 'toggleAllSelection', 'clearSort', 'clearFilter', 'setActiveRow', 'setActiveCell', 'setSelectCell', 'computeWidth', 'isScrollXLoad', 'isScrollYLoad', 'exportCsv'];

...
var components = [components_table, table_column, table_toolbar, components_grid, components_excel, components_pagination, components_checkbox];
/**
 * 全局参数设置
 */

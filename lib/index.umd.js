...
function renderColumn(h, _vm, $table, fixedType, row, rowIndex, column, columnIndex) {
  ...
  var allOverflow = optimizeConfig.allOverflow;
  ...
  var isShowTitle = showTitle || allOverflow === 'title';
  var isShowTooltip = showTooltip || allOverflow === 'tooltip';
  var isEllipsis = ellipsis || allOverflow === 'ellipsis';
  var isDirty;
  var attrs = null;
  var tdOns = {};
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    insertAt: function insertAt(record, row) {
      ...
      var newRecord = defineProperty(record);
    ...
    handleGlobalClickEvent: function handleGlobalClickEvent(evnt) {
      ...
      if (actived.row) {
        if (!(editConfig.autoClear === false)) {
          ...
          if (!this.lastActivedTime || this.lastActivedTime + 50 < now_default()()) {
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this6.setCheckRowEvent(null, {
          row: row,
          column: column
        }, !!value);
      });
     ...
     * 多选，行选中事件
     */
    setCheckRowEvent: function setCheckRowEvent(evnt, _ref2, value) {
      var row = _ref2.row,
          column = _ref2.column;
    ...
    setActiveRow: function setActiveRow(row) {
      ...
      if (row && editConfig.mode === 'row') {
        ...
        if (rowIndex > -1) {
          ...
          this.lastActivedTime = now_default()();
        }
      }
...
// CONCATENATED MODULE: ./src/components/table/src/config.js
...
// CONCATENATED MODULE: ./src/components/table-config/index.js
...
var components = [components_table, table_column, table_config, components_excel];

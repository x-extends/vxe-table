...
function excel_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { excel_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { excel_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var export_fileForm = document.createElement('form');
var export_fileInput = document.createElement('input');
export_fileForm.className = 'vxe-table--file-form';
export_fileInput.name = 'file';
export_fileInput.type = 'file';
export_fileForm.appendChild(export_fileInput);
...
function getFooterCellValue($xetable, opts, items, column) {
  ...
  if (editRender && editRender.name) {
    ...
    if (_compConf) {
      exportMethod = _compConf.footerCellExportMethod;
    }
  }
        ...
        default:
          if (opts.original) {
            ...
            if (editRender && editRender.name) {
              ...
              if (_compConf3) {
                exportMethod = _compConf3.cellExportMethod;
              }
            }

...
function renderRows(h, _vm, $table, rowLevel, fixedType, tableData, tableColumn) {
  ...
  tableData.forEach(function (row, rowIndex) {
    ...
    // 优化事件绑定
    var on = null;
    var seq = (scrollYLoad ? scrollYStore.startIndex + 1 : 1) + rowIndex;
    ...
    rows.push(h('tr', {
      class: ['vxe-body--row', "row--".concat(id, "_").concat(rowIndex), (_ref3 = {}, _defineProperty(_ref3, "row--level-".concat(rowLevel), treeConfig), _defineProperty(_ref3, 'row--selected', row === selectRow), _defineProperty(_ref3, 'row--hover', row === hoverRow), _ref3), rowClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rowClassName) ? rowClassName({
        $table: $table,
        seq: seq,
        row: row,
        rowIndex: rowIndex
      }) : rowClassName : ''],
      key: rowKey || treeConfig ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row, rowKey || treeConfig.key) : rowIndex,
      on: on
...
/* harmony default export */ var body = ({
  ...
  render: function render(h) {
     ...
     * 内容
     */
    h('tbody', renderRows(h, this, $table, 0, fixedType, tableData, tableColumn))]), scrollYLoad ? h('div', {
    ...
    scrollEvent: function scrollEvent(evnt) {
      ...
      if (fixedType === 'left') {
        ...
        if (leftElem || rightElem) {
          ...
          updateLeftScrollingTimeput = setTimeout($table.checkScrolling, dom.browse.msie ? 200 : 10);
        }
...
/* harmony default export */ var table = ({
  ...
  created: function created() {
    ...
    this.load(this.data, true).then(function () {
      if (_this2.treeConfig && !(_this2.rowKey || _this2.treeConfig.key)) {
  ...
  methods: {
        ...
        if (!(editConfig.autoClear === false)) {
          ...
          if (!this.lastCallTime || this.lastCallTime + 50 < now_default()()) {
            if (!interceptor.clearActiveds.some(function (func) {
              ...
              if ( // 如果点击了非编辑列
              !dom.getEventTargetNode(evnt, this.$el, 'col--edit').flag || // 如果点击了当前表格之外
    ...
    setSelection: function setSelection(rows, value) {
      ...
      rows.forEach(function (row) {
        return _this7.triggerCheckRowEvent({}, {
          row: row
        }, !!value);
      });
      return this.$nextTick();
    ...
    triggerCheckRowEvent: function triggerCheckRowEvent(evnt, _ref4, value) {
      ...
      if (treeConfig) {
        ...
        var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(tableData, function (item) {
          return item === row;
        }, treeConfig);
    ...
    setAllSelection: function setAllSelection(value) {
      ...
      if (value) {
        if (treeConfig) {
          external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(tableData, function (item) {
            return selection.push(item);
          }, treeConfig);
        } else {
    ...
    setTreeExpansion: function setTreeExpansion(rows, expanded) {
      var treeExpandeds = this.treeExpandeds;
      var isToggle = arguments.length === 1;
    ...
    clearScroll: function clearScroll() {
      ...
      this.$nextTick(function () {
        var tableBody = _this12.$refs.tableBody;
        var tableBodyElem = tableBody ? tableBody.$el : null;
        var tableFooter = _this12.$refs.tableFooter;
...
/* harmony default export */ var src_column = ({
  ...
  created: function created() {
    ...
    var isTreeNode = treeConfig && this.treeNode;
    var opts = {
  ...
  methods: {
    ...
    renderTreeIcon: function renderTreeIcon(h, params) {
      ...
      return [h('span', {
        ...
        style: {
          width: "".concat(level * (treeConfig.indent || 16), "px")
        }
      }), h('span', {
    ...
    renderIndexCell: function renderIndexCell(h, params) {
      ...
      return [utils.formatText(indexMethod ? indexMethod(params) : params.seq)];
    },
...
/* harmony default export */ var grid = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      on: $listeners,
      ref: 'xTable'
    }, buildColumns(h, columns)), pages ? h('vxe-pagination', {
...
/* harmony default export */ var src_radio = ({
  ...
  render: function render(h) {
    ...
    return h('label', {
      class: ['vxe-radio', this.size ? "size--".concat(this.size) : '', {
        'is--disabled': this.disabled
      }]
    }, [h('input', {
      attrs: {
...
/* harmony default export */ var src_input = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-input--wrapper', _defineProperty({}, "size--".concat(size), size)]
    }, [h('input', {
      class: "vxe-input",
      domProps: {
        value: value
...
var components = [components_table, table_column, components_grid, components_excel, components_pagination, components_checkbox, components_radio, components_input];

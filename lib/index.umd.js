  ...
  methods: {
    ...
    cacheDataMap: function cacheDataMap() {
      ...
      var handleData = function handleData(row, index) {
        ...
        fullDataRowIdMap.set('' + rowid, rest);
    ...
    hasRowChange: function hasRowChange(row, field) {
      ...
      if (rowkey) {
        ...
        if (treeConfig) {
          ...
          var oRowIndex = this.fullDataRowIdMap.get(rowid).index;
        ...
        if (disabled) {
          ...
          if (!visibleMethod || visibleMethod(params, evnt)) {
            ...
            if (flag) {
              ...
              if (type === 'body') {
                var row = rowid ? fullDataRowIdMap.get(rowid).row : tableData[rowIndex];
                args.row = row;
      ...
      var selectMethod = function selectMethod() {
        if (selected.row !== row || selected.column !== column) {
          ...
          if (mouseConfig.selected) {
            ...
            var rowid = UtilTools.getRowid(_this20, row);

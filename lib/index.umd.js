  ...
  methods: {
          ...
          if (!actived.args || evnt.currentTarget !== actived.args.cell) {
            ...
            if (editConfig.mode === 'row') {
              ...
              this.triggerValidate('blur').then(function () {}).catch(function (e) {
                ...
                _this10.handleActived(params, evnt).then(function () {
                  return _this10.triggerValidate('change');
                }).catch(function (e) {
                  return e;
                });
              }); // }
    ...
    setActiveCell: function setActiveCell(row, prop) {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          var tableData = _this13.tableData,
              visibleColumn = _this13.visibleColumn,
              handleActived = _this13.handleActived;
          ...
          if (row && prop) {
            ...
            if (rowIndex > -1) {
              ...
              var cell = DomTools.getCell(_this13, {
                row: row,
                rowIndex: rowIndex,
                column: column
              });
              ...
              _this13.lastCallTime = Date.now();
            }
          }

          resolve(_this13.$nextTick());
        });
      });
    },
          ...
          if (_this15.hasCellRules(type, row, column)) {
            ...
            if (cell) {
              return _this15.validCellRules(type, row, column).then(function () {
                ...
                return _this15.showValidTooltip({
                  rule: rule,
                  row: row,
                  column: column,
                  cell: cell
    ...
    handleValidError: function handleValidError(params) {
      ...
      this.handleActived(params, {
        ...
        return _this19.showValidTooltip(params);
      });
    },
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      var rule = params.rule,
          ...
          cell = params.cell;
      this.$nextTick(function () {
        Object.assign(_this20.validStore, {
          row: row,
          column: column,
          rule: rule,
      ...
      if (target) {
        ...
        return this.$nextTick().then(function () {
          ...
          if (wrapperElem) {
            ...
            tipStore.style = {
              zIndex: zIndex,
              width: "".concat(wrapperElem.offsetWidth + 2, "px"),

                ...
                result.push(new Promise(function (resolve) {
                  ...
                  loadMethod({
                    ...
                    if (childs) {
                      ...
                      _this31.appendTreeCache(childs);
                      ...
                      if (_this31.isCheckedByRow(row)) {
                        _this31.setSelection(childs, true);
                      }
                    }
...
function renderColumn(h, _vm, $table, $seq, seq, rowid, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex, items) {
  ...
  var params = {
    ...
    level: rowLevel,
    data: tableData,
    items: items // 在 v3.0 中废弃 selectConfig
  ...
  if (highlightCurrentRow || tableListeners['cell-click'] || mouseConfig.checked || editRender && editConfig || expandOpts.trigger === 'row' || expandOpts.trigger === 'cell' || radioConfig.trigger === 'row' || column.type === 'radio' && radioConfig.trigger === 'cell' || // 在 v3.0 中废弃 type=selection

...
var Cell = {
  ...
  renderExpandCell: function renderExpandCell(h, params) {
    ...
    })]), slots.content && slots.default ? slots.default.call($table, params, h) : labelField ? xe_utils_amd_xe_utils_default.a.get(row, labelField) : null];
  },

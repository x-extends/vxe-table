...
function renderColumn(h, _vm, $table, $seq, seq, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex) {
  ...
  }, _xeUtils.default.isFunction(validStore.content) ? validStore.content.call($table, h) : _tools.UtilTools.getFuncText(validStore.content))]) : _e() : null, isMouseChecked && !fixedType ? h('span', {

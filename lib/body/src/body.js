...
var _default = {
  ...
  render: function render(h) {
    ...
    if (height) {
      customHeight = height === 'auto' ? parentHeight : (_tools.DomTools.isScale(height) ? Math.floor(parseInt(height) / 100 * parentHeight) : _xeUtils.default.toNumber(height)) - $table.getExcludeHeight();

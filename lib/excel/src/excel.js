...
var _default = {
  ...
  methods: _objectSpread({}, methods, {
    cellClickEvent: function cellClickEvent(_ref, evnt) {
      var row = _ref.row,
    ...
    headerCellClickEvent: function headerCellClickEvent(_ref2, evnt) {
    ...
    contextMenuClickEvent: function contextMenuClickEvent(_ref3, evnt) {
      var menu = _ref3.menu,
          row = _ref3.row,
          column = _ref3.column;
      var $table = this.$refs.xTable;

  ...
  if (bodyNodes.length) {
    ...
    if (tableNodes.length) {
      ...
      if (theadNodes.length) {
        xe_utils_amd_xe_utils_default.a.arrayEach(theadNodes[0].getElementsByTagName('tr'), function (rowNode) {
          xe_utils_amd_xe_utils_default.a.arrayEach(rowNode.getElementsByTagName('th'), function (cellNode) {
        ...
        if (tbodyNodes.length) {
          xe_utils_amd_xe_utils_default.a.arrayEach(tbodyNodes[0].getElementsByTagName('tr'), function (rowNode) {
            var item = {};
            xe_utils_amd_xe_utils_default.a.arrayEach(rowNode.getElementsByTagName('td'), function (cellNode, colIndex) {
...
function parseXML(columns, content) {
  ...
  if (sheetNodes.length) {
    ...
    if (tableNodes.length) {
      ...
      if (rowNodes.length) {
        xe_utils_amd_xe_utils_default.a.arrayEach(rowNodes[0].getElementsByTagName('Cell'), function (cellNode) {
          var field = cellNode.textContent;

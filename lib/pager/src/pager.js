  ...
  methods: {
    ...
    renderPrevPage: function renderPrevPage(h) {
      ...
      return h('span', {
        ...
        class: ['vxe-icon--page-icon', _conf.default.iconMap.prevPage]
      })]);
    },
    // prevJump
    renderPrevJump: function renderPrevJump(h, tagName) {
      ...
      return h(tagName || 'span', {
        ...
        class: ['vxe-pager--jump-icon', _conf.default.iconMap.jumpPrev]
      })]);
    },
    // number
    ...
    renderNextJump: function renderNextJump(h, tagName) {
      ...
      return h(tagName || 'span', {
        ...
        class: ['vxe-pager--jump-icon', _conf.default.iconMap.jumpNext]
      })]);
    },
    // nextPage
    renderNextPage: function renderNextPage(h) {
      ...
      return h('span', {
        ...
        class: ['vxe-icon--page-icon', _conf.default.iconMap.nextPage]
      })]);
    },
    // sizes
    ...
    jumpPageEvent: function jumpPageEvent(currentPage) {
      if (currentPage !== this.currentPage) {
        ...
        _tools.UtilTools.emitEvent(this, 'current-change', [currentPage]);
      }
    },
    sizeChangeEvent: function sizeChangeEvent(pageSize) {
      if (pageSize !== this.pageSize) {
        ...
        _tools.UtilTools.emitEvent(this, 'size-change', [pageSize]);
      }
    ...
    showSizePanel: function showSizePanel() {
      ...
      var _DomTools$getOffsetPo = _tools.DomTools.getOffsetPos(sizeBtnElem),

  ...
  methods: {
    ...
    renderPrevPage: function renderPrevPage(h) {
      ...
      return h('span', {
        ...
        class: ['vxe-pager--btn-icon', iconPrevPage || _conf.default.icon.prevPage]
      })]);
    },
    // 向上翻页
    ...
    renderNextJump: function renderNextJump(h, tagName) {
      ...
      return h(tagName || 'span', {
        ...
        class: ['vxe-pager--jump-icon', iconJumpNext || _conf.default.icon.jumpNext]
      })]);
    },
    // 下一页
    renderNextPage: function renderNextPage(h) {
      ...
      return h('span', {
        ...
        class: ['vxe-pager--btn-icon', iconNextPage || _conf.default.icon.nextPage]
      })]);
    },
    // sizes

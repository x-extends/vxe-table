...
var Cell = {
  ...
  renderHeader: function renderHeader(h, params) {
    ...
    return [_tools.UtilTools.formatText(params.column.origin.label, 1)];
  },
  ...
  renderIndexCell: function renderIndexCell(h, params) {
    ...
    var seq = params.seq,
        level = params.level;
    return [_tools.UtilTools.formatText(indexMethod ? indexMethod(params) : level ? "".concat(level, ".").concat(seq) : startIndex + seq, 1)];
  },

...
var Cell = {
  ...
  renderCell: function renderCell(h, params) {
    ...
    var cellValue = _tools.UtilTools.getCellLabel(row, column, params);
  ...
  renderIndexHeader: function renderIndexHeader(h, params) {
    ...
    return [_tools.UtilTools.formatText(_tools.UtilTools.getFuncText(own.title || own.label || _conf.default.i18n('vxe.column.indexTitle')), 1)];
  },

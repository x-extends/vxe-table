...
var Cell = {
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    })].concat(labelField ? slots && slots.default ? slots.default(params, h) : [_xeUtils.default.get(row, labelField)] : []))];
  },
  ...
  renderSelectionHeader: function renderSelectionHeader(h, params) {
    ...
    })].concat(headerTitle ? slots && slots.header ? slots.header(params, h) : [_tools.UtilTools.getFuncText(headerTitle)] : []))];
  },

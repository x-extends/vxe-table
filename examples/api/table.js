    ...
    list: [
      ...
      },
      {
        ...
        list: [
          ...
          {
            name: 'filterMethod',
            desc: '全局筛选方法，当触发筛选时会调用该函数 Function({options, values, row, column}) 返回是否有效',
            version: '2.9.10',
            type: 'Function',
            enum: '',
            defVal: '',
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        name: '$getColumnIndex(column)',
        disabled: true,
        desc: '即将废弃，请使用 getVMColumnIndex',
        version: '2.7',
        type: 'Number',
        enum: '',
        defVal: 'column',
      ...
      },
      {
        ...
        disabled: true,
        desc: '即将废弃，请使用 getVTColumnIndex',
        version: '2.9.3',
        type: 'Number',
        enum: '',
        defVal: 'column',
      ...
      {
        name: 'setCellAreas(areaConfigs)',
        desc: '如果功能被支持，用于 mouse-config.area，选择指定区域的单元格',
        version: 'pro',
        type: 'Promise',
        enum: '',
        defVal: 'areaConfigs: CellAreaConfig[]',
        list: []
      },
      {

...
function mockChildData (size, hasChild) {
  ...
  for (let index = 0; index < size; index++) {
    ...
    const item = {
      ...
      role: index % 4 === 0 ? '前端' : index % 3 === 0 ? 'test abc' : '后端'
    }
    if (hasChild) {
  ...
  for (; index < size; index++) {
    ...
    if (hasChild) {
      item = {
        ...
        content: index % 2 === 0 ? 'test abc' + index : 'Content' + index,
        checked: false,
        flag: index % 2 === 0,
        date: date,
        date1: date,
        ...
        address: 'test abc test abc test abc' + index,
        address2: 'test abc' + index,
        img: 'static/other/img' + (index % 3 ? '1' : '2') + '.gif',
        img1: index % 4 === 0 ? 'static/other/img' + (index % 3 ? '1' : '2') + '.gif' : '',
        html1: index % 3 === 0 ? '<span style="color:red;">我是一段Html代码</span><br><span style="color:blue;">test abc' + index + '</span><br><span style="color:green;">绿到你发慌！</span>' : '',
        html2: index % 3 === 0 ? '<span style="color:red;">我是一段Html代码</span><span style="color:blue;">test abc' + index + '</span><span style="color:green;">绿到你发慌！</span>' : '',
        html3: index + ' -> <span style="color:red;">我是一段Html代码</span><span style="color:blue;">test abc' + index + '</span><span style="color:green;">绿到你发慌！</span><br><span style="color:green;">绿到你发慌！</span><br><span style="color:green;">我是一段Html代码,我是一段Html代码，我是一段Html代码，绿到你发慌！</span><br><span style="color:red;">我是一段Html代码,我是一段Html代码，我是一段Html代码</span><br><span style="color:red;">我是一段Html代码,我是一段Html代码，我是一段Html代码</span><br><span style="color:green;">我是一段Html代码,我是一段Html代码，我是一段Html代码</span>',
      ...
      item = {
        ...
        key: 'home.label.key' + Math.max(0, index % 2 === 0 ? index - 1 : index),
        language: index % 2 === 0 ? 'zh_CN' : 'en_US',
        content: index % 2 === 0 ? 'vxe-table test abc' + index : 'Content' + index,
        checked: false,
        flag: index % 2 === 0,
        date: date,
        date1: date,

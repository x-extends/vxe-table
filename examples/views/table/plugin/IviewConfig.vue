<template>
  <div>
    <p class="tip">具体兼容请查看 <a class="link" href="https://github.com/xuliangzhan/vxe-table-plugin-iview" target="_blank">vxe-table-plugin-iview</a> 插件的 API</p>
  ...
  data () {
    ...
    return {
      ...
      tableColumn: [
        ...
        { field: 'sex1', title: 'Select（不建议放在单元格中）', width: 260, editRender: { name: 'Select', options: [], props: { multiple: true, clearable: true } } },

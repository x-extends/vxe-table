<template>
  <div>
    <p class="tip">具体兼容请查看 <a class="link" href="https://github.com/xuliangzhan/vxe-table-plugin-shortcut-key" target="_blank">vxe-table-plugin-shortcut-key</a> 插件的 API</p>

<template>
  <div>
    <p class="tip">具体兼容请查看 <a class="link" href="https://github.com/xuliangzhan/vxe-table-plugin-element" target="_blank">vxe-table-plugin-element</a> 插件的 API</p>
  ...
  data () {
    return {
      ...
      tableColumn: [
        ...
        { field: 'sex1', title: 'ElSelect（不建议放在单元格中）', width: 260, editRender: { name: 'ElSelect', options: [], props: { multiple: true, clearable: true } } },

<template>
  <div>
    <p class="tip">具体兼容请查看 <a class="link" href="https://github.com/xuliangzhan/vxe-table-plugin-antd" target="_blank">vxe-table-plugin-antd</a> 插件的 API</p>
  ...
  data () {
    return {
      ...
      tableColumn: [
        ...
        { field: 'sex1', title: 'ASelect（不建议放在单元格中）', width: 260, editRender: { name: 'ASelect', options: [], props: { mode: 'multiple' } } },

<template>
  <div>
    <p class="tip">
      ...
      1.每次切换 Tab 页显示之后手动调用 <table-api-link prop="recalculate"/> 重新计算宽度 2.使用 <table-api-link prop="sync-resize"/> 绑定可视的变量实现自动更新宽度 3.使用 <table-api-link prop="auto-resize"/> 自动监听响应式更新宽度
    </p>

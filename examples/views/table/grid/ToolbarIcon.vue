<template>
  <div>
    <p class="tip">自定义工具栏按钮图标，例如：<a class="link" href="https://github.com/FortAwesome/Font-Awesome" target="_blank">font-awesome</a>，可以局部替换也可以 <router-link :to="{name: 'StartIcons'}">全部替换</router-link></p>

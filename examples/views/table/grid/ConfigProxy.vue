<template>
  <div>
    <p class="tip">
      进阶封装实现，只需要一个 json 数据就可以非常简单的渲染一个支持 CRUD 功能完整的表格 <a class="link" href="https://github.com/xuliangzhan/vxe-table-demo/tree/master/vxe-table-by-vue-grid-proxy">查看简单的实现示例</a><br>

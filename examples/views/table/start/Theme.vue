<template>
  <div>
    ...
    <p class="tip">Case 1.使用默认的主题样式（<a class="link" href="https://github.com/xuliangzhan/vxe-table/blob/master/styles/variable.scss" target="_blank">查看所有变量</a>）<br><a class="link" href="https://github.com/xuliangzhan/vxe-table-demo/tree/master/vxe-table-by-theme" target="_blank">项目示例</a></p>
    <pre>
      <code class="scss">

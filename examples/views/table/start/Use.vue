<template>
  <div>
    ...
    <p class="tip">
      ...
      （注：深入 <a class="link" href="https://www.npmjs.com/package/vxe-table">vxe-table</a> 门槛较高，需要熟悉 <a class="link" href="https://cn.vuejs.org/">vue</a>、<a class="link" href="https://github.com/vuejs/jsx">jsx</a> 相关用法，初学者谨慎使用）
    </p>
    <pre>
      <code class="shell">

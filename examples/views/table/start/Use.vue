<template>
  <div>
    ...
    <p class="tip">
      ...
      依赖库： <a class="link" href="https://www.npmjs.com/package/xe-utils">xe-utils2.4+</a>&nbsp;&nbsp;<a class="link" href="https://cn.vuejs.org/v2/guide/components-slots.html#%E5%8A%A8%E6%80%81%E6%8F%92%E6%A7%BD%E5%90%8D" style="font-size: 30px;font-weight: 700;">vue2.6+</a><br>
      （注：使用 <a class="link" href="https://www.npmjs.com/package/vxe-table">vxe-table</a> 之前必须熟悉 <a href="https://cn.vuejs.org/">vue</a> 相关用法，否则不建议使用）
    </p>
    <pre>
      <code class="shell">

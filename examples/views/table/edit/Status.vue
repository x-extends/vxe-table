<template>
  <div>
    <p class="tip">
      设置 <table-api-link prop="keep-source"/> 开启保持原始值状态和 <table-api-link prop="edit-config"/>={showStatus} 开启编辑状态显示功能，还可以通过 icon 自定义编辑状态的图标，例如：<a class="link" href="https://github.com/FortAwesome/Font-Awesome" target="_blank">font-awesome</a><br>

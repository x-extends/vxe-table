<template>
  <div>
    <p class="tip">
      ...
      renderEdit (h, renderOpts, { row, rowIndex, $rowIndex, column, columnIndex, $columnIndex }, context) 编辑的渲染函数<br>
      renderCell (h, renderOpts, { row, rowIndex, $rowIndex, column, columnIndex, $columnIndex }, context) 显示的渲染函数<br>

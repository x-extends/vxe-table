<template>
  <div>
    <p class="tip">
      ...
      <span class="red">注：不处理好兼容性的情况下是大部分组件是无法选中值的，建议使用 <router-link class="link" :to="{name: 'TablePluginElementConfig'}">vxe-table-plugin-element</router-link> 适配插件，当然你也可以自行处理兼容性</span>
    </p>

<template>
  <div>
    ...
    <vxe-table
      ...
      <vxe-table-column field="name" title="app.api.title.prop" min-width="280" :cell-render="{name: 'html'}" :filters="nameFilters" tree-node></vxe-table-column>
      <vxe-table-column field="desc" title="app.api.title.desc" min-width="200" :cell-render="{name: 'html'}"></vxe-table-column>
      <vxe-table-column field="type" title="app.api.title.type" min-width="140" :cell-render="{name: 'html'}"></vxe-table-column>
      <vxe-table-column field="enum" :title="$t('app.api.title.enum')" min-width="150" :cell-render="{name: 'html'}"></vxe-table-column>
      <vxe-table-column field="defVal" :title="$t('app.api.title.defVal')" min-width="160" :cell-render="{name: 'html'}"></vxe-table-column>

...
export default Vue.extend({
      ...
      gridOptions: {
        ...
        proxyConfig: {
          ...
          ajax: {
            ...
            delete: ({ body }) => {
              return this.postMock('https://api.vxetable.cn/demo/api/pub/save', body)
            },
            save: ({ body }) => this.postMock('https://api.vxetable.cn/demo/api/pub/save', body)
          }
        },
        columns: [
        ...
        importConfig: {
          ...
          // 自定义服务端导入
          importMethod: ({ file }) => {
            const $grid = this.$refs.xGrid as VxeGridInstance
            const formBody = new FormData()
            formBody.append('file', file)
            return this.postMock('https://api.vxetable.cn/demo/api/pub/import', formBody).then((data: any) => {
        ...
        exportConfig: {
          ...
          exportMethod: ({ options }) => {
            ...
            // 开始服务端导出
            return this.postMock('https://api.vxetable.cn/demo/api/pub/export', body).then((data: any) => {
              if (data.id) {
  ...
  methods: {
    postMock (url:string, body: any): Promise<any> {

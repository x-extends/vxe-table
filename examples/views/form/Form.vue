<template>
  <div>
    ...
    <vxe-form ref="xForm3" :collapseStatus.sync="collapseStatus3" :data="formData3" :rules="formRules3" title-align="right" title-width="100" prevent-submit title-colon custom-layout>
      ...
      <div style="border: 1px dashed green;padding: 10px;">
        ...
        <div>
          <vxe-checkbox v-model="collapseStatus3" content="查看更多" :checked-value="false" :unchecked-value="true"></vxe-checkbox>
        </div>

...
function mockData () {
  ...
  for (var index = 0; index < len; index++) {
    ...
    list.push({
      ...
      img: `https://xuliangzhan.github.io/vxe-table/other/img${index % 3 ? '1' : '2'}.gif?raw=true`,
      img1: index % 4 === 0 ? `https://xuliangzhan.github.io/vxe-table/other/img${index % 3 ? '1' : '2'}.gif?raw=true` : '',

  ...
  app: {
    ...
    body: {
      ...
      other: {
        ...
        releases: '更新日誌',
        donation: '捐贈',
        donationTitle: '捐贈管道<span class="red">（如果有無法解决的問題需要支持可以留言或者提 <a class="link" href="https://github.com/xuliangzhan/vxe-table/issues/390" target="_blank">Issues</a>）</span>：',
        issuesTitle: '如何迴響問題？  ',

    ...
    api: {
      ...
      table: {
        desc: {
          ...
          rowId: 'Specify the unique primary key field name for the row data (this must be set when some advanced features are enabled, such as tree tables, editable tables...)',

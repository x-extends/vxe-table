  ...
  app: {
    aside: {
      nav: {
        ...
        bigData: '虚拟滚动',
        scrollRows: '10 万行',
        scrollFullRows: '10 万行 + 复杂渲染',
        scrollCols: '1 万列 10 万行',
        scrollFullCols: '1 万列 10 万行 + 复杂渲染',
    ...
    body: {
      ...
      other: {
        ...
        releases: '更新日志',
        donation: '捐赠',
        donationTitle: '捐赠方式<span class="red">（如果有无法解决的问题需要支持可以留言或者提 <a class="link" href="https://github.com/xuliangzhan/vxe-table/issues/390" target="_blank">Issues</a>）</span>：',
        issuesTitle: '如何反馈问题？  ',

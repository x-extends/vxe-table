module.exports = {
  app: {
    header: {
      desc: '一个完整 Vue 表格，支持绝大部分对 Table 的一切需求，与任意组件库完美兼容'
    },
    aside: {
      nav: {
        start: '开发指南',
    ...
    api: {
      ...
      table: {
        desc: {
          ...
          headerCellClassName: '给表头的单元格附加 className，也可以是函数 Function({rowIndex, column, columnIndex})',
          footerRowClassName: '给表尾的行附加 className，也可以是函数 Function({rowIndex})',
          footerCellClassName: '给表尾的单元格附加 className，也可以是函数 Function({rowIndex, column, columnIndex})',
          showFooter: '是否显示表尾合计',

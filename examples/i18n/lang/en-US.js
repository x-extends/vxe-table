    ...
    api: {
      ...
      table: {
        desc: {
          ...
          cellMenu: 'This is only valid for context-menu configuration, and is triggered when the cell is context menu',
          ...
          headerCellMenu: 'This is only valid for context-menu configuration, and is triggered when the header cell is context menu',
          ...
          footerCellMenu: 'This is only valid for context-menu configuration, and is triggered when the footer cell is context menu',
          ...
          menuClick: 'This event is only valid for context-menu configuration and is triggered when the shortcut menu is clicked',

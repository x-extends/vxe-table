    ...
    api: {
      ...
      table: {
        desc: {
          ...
          cellStyle: 'Append styles to cells, which can also be function, Function({row, rowIndex, $rowIndex, column, columnIndex, $columnIndex})',
          ...
          rowStyle: 'Attach styles to rows, which can also be function, Function({row, rowIndex, $rowIndex})',
          ...
          spanMethod: 'User defined merge function. The method function ({row, rowindex, $rowindex, column, columnindex, $columnindex, data}) returns the calculated value，不能用于树形结构、展开行、固定列',
          footerSpanMethod: 'Footer merge rows or columns, Function({$rowIndex, column, columnIndex, $columnIndex, data}) returns the calculated value，不能用于树形结构、展开行、固定列',
